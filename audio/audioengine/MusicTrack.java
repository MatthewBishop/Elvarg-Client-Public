...
public class MusicTrack extends _Node {
	
	_NodeHashTable table;
	byte[] midi;
	
	MusicTrack(_Buffer var1) {
		...
		_Buffer var51 = new _Buffer(this.midi); // L: 158
	...
	void method5466() {
		if (this.table == null) { // L: 274
			this.table = new _NodeHashTable(16); // L: 275
	...
	public static MusicTrack readTrack(ICacheArchive var0, int var1, int var2) {
		byte[] var3 = var0.takeFile(var1, var2); // L: 16
		return var3 == null ? null : new MusicTrack(new _Buffer(var3)); // L: 17
	}
}
