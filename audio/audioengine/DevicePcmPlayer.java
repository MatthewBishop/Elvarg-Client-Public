...
public class DevicePcmPlayer extends PcmPlayer {
	...
	public void init() {
		this.format = new AudioFormat((float) StaticSound.field287, 16, StaticSound.PcmPlayer_stereo ? 2 : 1, true, false); // L:
																																	// 22
	...
	public void open(int var1) throws LineUnavailableException {
		try {
			Info var2 = new Info(SourceDataLine.class, this.format, var1 << (StaticSound.PcmPlayer_stereo ? 2 : 1)); // L:
																																// 29
