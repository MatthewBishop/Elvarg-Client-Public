...
public class VorbisSample extends _Node {
	...
	void read(byte[] var1) {
		_Buffer var2 = new _Buffer(var1); // L: 89
	...
	private static boolean method970(ICacheArchive var0) {
		if (!field377) { // L: 381
	...
	static VorbisSample readMusicSample(ICacheArchive var0, int var1, int var2) {
