...
public class MidiPcmStream extends PcmStream {
	...
	public MidiPcmStream() {
		...
		this.musicPatches = new _NodeHashTable(128); // L: 45
	...
	public synchronized boolean loadMusicTrack(MusicTrack var1, ICacheArchive var2, SoundCache var3, int var4) {
	...
	protected synchronized void fill(int[] var1, int var2, int var3) {
		if (this.midiFile.isReady()) { // L: 481
			int var4 = this.midiFile.division * this.field3205 / StaticSound.field287; // L:
																						// 482
			do {
	...
	protected synchronized void skip(int var1) {
		if (this.midiFile.isReady()) { // L: 502
			int var2 = this.midiFile.division * this.field3205 / StaticSound.field287; // L:
																						// 503
			do {
		...
		for (MusicPatchNode var2 = (MusicPatchNode) this.patchStream.queue.last(); var2 != null; var2 = (MusicPatchNode) this.patchStream.queue.previous()) { // L:
			...
			if (var1 < 0 || var2.field3284 == var1) { // L: 237
				if (var2.stream != null) { // L: 238
					var2.stream.method802(StaticSound.field287 / 100); // L: 239
	...
	int method5278(MusicPatchNode var1) {
		...
		var4 = (int) ((double) (var1.rawSound.sampleRate * 256) * Math.pow(2.0D, 3.255208333333333E-4D * (double) var2) / (double) StaticSound.field287 + 0.5D); // L:
																																								// 426
	...
	boolean method5317(MusicPatchNode var1, int[] var2, int var3, int var4) {
		var1.field3283 = StaticSound.field287 / 100; // L: 568
