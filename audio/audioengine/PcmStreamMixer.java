...
public class PcmStreamMixer extends PcmStream {
	...
	_NodeDeque subStreams;
	
	_NodeDeque field249;
	int field251;
	int field252;
	public PcmStreamMixer() {
		this.subStreams = new _NodeDeque(); // L: 9
		this.field249 = new _NodeDeque(); // L: 10
	...
	void method584(_Node var1, PcmStreamMixerListener var2) {
		while (this.field249.sentinel != var1 && ((PcmStreamMixerListener) var1).field395 <= var2.field395) { // L:
																												// 33
			var1 = var1.previous;
		}
		_NodeDeque.NodeDeque_addBefore(var2, var1); // L: 34
	...
	void method580(PcmStreamMixerListener var1) {
		var1.remove(); // L: 39
		var1.remove2(); // L: 40
		_Node var2 = this.field249.sentinel.previous; // L: 41
