...
public class SoundCache {
	...
	ICacheArchive soundEffectIndex;
	
	ICacheArchive musicSampleIndex;
	
	_NodeHashTable musicSamples;
	
	_NodeHashTable rawSounds;
	
	public SoundCache(ICacheArchive var1, ICacheArchive var2) {
		this.musicSamples = new _NodeHashTable(256); // L: 9
		this.rawSounds = new _NodeHashTable(256); // L: 10
