...
public class MusicPatchPcmStream extends PcmStream {
	...
	MusicPatchPcmStream(MidiPcmStream var1) {
		this.queue = new _NodeDeque(); // L: 11
	...
	void method5439(MusicPatchNode var1, int[] var2, int var3, int var4, int var5) {
		if ((this.superStream.field3210[var1.field3284] & 4) != 0 && var1.field3278 < 0) { // L:
																							// 73
			int var6 = this.superStream.field3207[var1.field3284] / StaticSound.field287; // L:
																						// 74
			while (true) {
				...
				int var8 = StaticSound.field287 / 100; // L: 82
	...
	void method5440(MusicPatchNode var1, int var2) {
		if ((this.superStream.field3210[var1.field3284] & 4) != 0 && var1.field3278 < 0) { // L:
																							// 105
			int var3 = this.superStream.field3207[var1.field3284] / StaticSound.field287; // L:
																						// 106
