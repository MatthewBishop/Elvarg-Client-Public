...
public class SoundEffect {
	...
	public static SoundEffect readSoundEffect(ICacheArchive var0, int var1, int var2) {
		byte[] var3 = var0.takeFile(var1, var2); // L: 15
		return var3 == null ? null : new SoundEffect(new _Buffer(var3)); // L: 16
	}
}
