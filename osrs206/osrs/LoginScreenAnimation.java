...
public class LoginScreenAnimation {
	...
	final void method2207(int var1) {
		...
		for (int var5 = 0; var5 < var4; ++var5) { // L: 98
			var6 = this.field1225[var3 + var2] - this.field1233[var2 + this.field1229 & this.field1233.length - 1] * var1 / 6; // L:
																																// 99
			if (var6 < 0) { // L: 100
				var6 = 0;
			}
		...
		for (var7 = 256 - var1; var7 < 256; ++var7) { // L: 121
			this.field1234[var7] = (int) (Math.sin((double) this.field1218 / 14.0D) * 16.0D + Math.sin((double) this.field1218 / 15.0D) * 14.0D + Math.sin((double) this.field1218 / 16.0D) * 12.0D); // L:
																																																		// 122
		...
		if (var7 > 0) { // L: 127
			...
			for (var11 = 0; var11 < this.field1226 * 100; ++var11) { // L: 131
				var12 = (int) (Math.random() * (double) var10) + var17; // L:
																		// 132
				var13 = (int) (Math.random() * (double) var16) + var16; // L:
																		// 133
	...
	final int method2212(int var1, int var2, int var3) {
		...
		return (var3 * (var2 & 65280) + var4 * (var1 & 65280) & 16711680) + (var4 * (var1 & 16711935) + var3 * (var2 & 16711935) & -16711936) >> 8; // L:
																																					// 160
	}
	...
	final void method2224(int var1, int[] var2) {
		...
		for (int var4 = 0; var4 < var3; ++var4) { // L: 179
			if (var1 > 768) { // L: 180
				...
				this.field1219[var4] = this.method2212(var2[var4], this.field1220[var4], 256 - var1); // L:
																										// 182
			}
		}
	} // L: 184
	...
	final void method2214(int var1) {
		...
		for (int var3 = 1; var3 < 255; ++var3) { // L: 188
			...
			int var8 = var5 + (var3 + 8) * Message.rasterProvider.width; // L:
																			// 200
			var2 += var6; // L: 201
			for (int var9 = var6; var9 < var7; ++var9) { // L: 202
				...
				if (var10 != 0 && var11 >= Rasterizer2D.Rasterizer2D_xClipStart && var11 < Rasterizer2D.Rasterizer2D_xClipEnd) { // L:
																																	// 205
					...
					Message.rasterProvider.pixels[var8++] = -16777216 | (var12 * (var10 & 65280) + var13 * (var14 & 65280) & 16711680) + ((var10 & 16711935) * var12 + (var14 & 16711935) * var13 & -16711936) >> 8; // L:
					// 210
				} else {
					++var8; // L: 212
				}
		...
		for (var2 = 0; var2 < 20; ++var2) { // L: 224
			for (var3 = 1; var3 < 255; ++var3) { // L: 225
				for (var4 = 1; var4 < 127; ++var4) { // L: 226
					...
					this.field1230[var5] = (this.field1233[var5 + 128] + this.field1233[var5 - 128] + this.field1233[var5 + 1] + this.field1233[var5 - 1]) / 4; // L:
																																								// 228
				}
			}
	...
	static final IterableNodeHashTable readStringIntParameters(Buffer var0, IterableNodeHashTable var1) {
		...
		int var3;
		if (var1 == null) {
			var3 = Equations.farthestBitValue(var2);
