...
public class TextureProvider implements TextureLoader {
	...
	public int[] getTexturePixels(int var1) {
		...
		if (var2 != null) { // L: 66
			...
			boolean var3 = var2.load(this.brightness, this.textureSize, this.archive); // L:
																						// 72
			if (var3) { // L: 73
	...
	public int getAverageTextureRGB(int var1) {
		return this.textures[var1] != null ? this.textures[var1].averageRGB : 0; // L:
																					// 88
																					// 89
	}
	...
	public void animate(int var1) {
		for (int var2 = 0; var2 < this.textures.length; ++var2) { // L: 109
			...
			if (var3 != null && var3.animationDirection != 0 && var3.isLoaded) { // L:
																					// 111
		...
		if (var5 != null) { // L: 9596
			...
			if (var11) { // L: 9607
				...
				if (var7) { // L: 9614
					...
					if (var0 == 1) { // L: 9617
						var10 = EnumComposition.getPacketBufferNode(ClientPacket.field2934, Client.packetWriter.isaacCipher); // L:
																																// 9619
					...
					if (var0 == 2) { // L: 9625
						var10 = EnumComposition.getPacketBufferNode(ClientPacket.field2983, Client.packetWriter.isaacCipher); // L:
																																// 9627
					...
					if (var0 == 3) { // L: 9633
						var10 = EnumComposition.getPacketBufferNode(ClientPacket.field2930, Client.packetWriter.isaacCipher); // L:
																																// 9635
					...
					if (var0 == 4) { // L: 9641
						var10 = EnumComposition.getPacketBufferNode(ClientPacket.field2915, Client.packetWriter.isaacCipher); // L:
																																// 9643
					...
					if (var0 == 5) { // L: 9649
						var10 = EnumComposition.getPacketBufferNode(ClientPacket.field2905, Client.packetWriter.isaacCipher); // L:
																																// 9651
					...
					if (var0 == 6) { // L: 9657
						var10 = EnumComposition.getPacketBufferNode(ClientPacket.field2954, Client.packetWriter.isaacCipher); // L:
																																// 9659
					...
					if (var0 == 7) { // L: 9665
						var10 = EnumComposition.getPacketBufferNode(ClientPacket.field2963, Client.packetWriter.isaacCipher); // L:
																																// 9667
					...
					if (var0 == 8) { // L: 9673
						var10 = EnumComposition.getPacketBufferNode(ClientPacket.field2996, Client.packetWriter.isaacCipher); // L:
																																// 9675
					...
					if (var0 == 9) { // L: 9681
						var10 = EnumComposition.getPacketBufferNode(ClientPacket.field2974, Client.packetWriter.isaacCipher); // L:
																																// 9683
					...
					if (var0 == 10) { // L: 9689
						var10 = EnumComposition.getPacketBufferNode(ClientPacket.field2952, Client.packetWriter.isaacCipher); // L:
																																// 9691
