...
public class class346 implements Iterator {
	...
	public Object next() {
		if (this.field4163.field4169 != this.field4164) { // L: 192
			...
			Object var1 = this.field4163.field4166[this.field4162].field4159; // L:
																				// 194
	...
	public static final SpritePixels getItemSprite(int var0, int var1, int var2, int var3, int var4, boolean var5) {
		...
		long var6 = ((long) var4 << 40) + ((long) var2 << 38) + (long) var0 + ((long) var1 << 16) + ((long) var3 << 42); // L:
		// 367
		SpritePixels var8;
		if (!var5) { // L: 369
			var8 = (SpritePixels) ItemComposition.ItemDefinition_cachedSprites.get(var6); // L:
																							// 370
			if (var8 != null) { // L: 371
				return var8;
			}
		}
		ItemComposition var9 = EnumComposition.ItemDefinition_get(var0); // L:
																			// 373
		if (var1 > 1 && var9.countobj != null) { // L: 374
			int var10 = -1; // L: 375
			for (int var11 = 0; var11 < 10; ++var11) { // L: 376
				if (var1 >= var9.countco[var11] && var9.countco[var11] != 0) { // L:
																				// 377
		...
		if (var19 == null) { // L: 382
			...
			if (var9.noteTemplate != -1) { // L: 384
				...
				var20 = getItemSprite(var9.unnotedId, var1, var2, var3, 0, false); // L:
																					// 389
				if (var20 == null) { // L: 390
					return null;
				}
			} else if (var9.placeholderTemplate != -1) { // L: 392
				var20 = getItemSprite(var9.placeholder, var1, 0, 0, 0, false); // L:
																				// 393
				if (var20 == null) { // L: 394
					return null;
				}
			...
			int var17 = var16 * Rasterizer3D.Rasterizer3D_sine[var9.xan2d] >> 16; // L:
																					// 411
			int var18 = var16 * Rasterizer3D.Rasterizer3D_cosine[var9.xan2d] >> 16; // L:
																					// 412
			var19.calculateBoundsCylinder(); // L: 413
			var19.method4442(0, var9.yan2d, var9.zan2d, var9.xan2d, var9.offsetX2d, var19.height / 2 + var17 + var9.offsetY2d, var18 + var9.offsetY2d); // L:
																																						// 414
			...
			if (var4 == 1 || var4 == 2 && var9.isStackable == 1) { // L: 421
				ItemComposition.ItemDefinition_fontPlain11.draw(HitSplatDefinition.method3632(var1), 0, 9, 16776960, 1); // L:
				// 422
			}
			if (!var5) { // L: 424
