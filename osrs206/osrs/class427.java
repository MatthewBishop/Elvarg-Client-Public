...
public class class427 extends class392 implements class251 {
	...
	public class427(StudioGame var1, int var2, Language var3, AbstractArchive var4) {
		super(var1, var3, var4 != null ? var4.getGroupFileCount(var2) : 0); // L:
																			// 19
	...
	static final int method7523() {
		if (class19.clientPreferences.method2245()) { // L: 4886
			...
			if (ViewportMouse.cameraPitch < 310) { // L: 4888
				...
				if (var1 < 0 || var2 < 0 || var1 >= 104 || var2 >= 104) { // L:
																			// 4902
					return PacketWriter.Client_plane;
				}
				if ((Tiles.Tiles_renderFlags[PacketWriter.Client_plane][var3][var4] & 4) != 0) { // L:
																									// 4903
			...
			if (class101.localPlayer.x >= 0 && class101.localPlayer.y >= 0 && class101.localPlayer.x < 13312 && class101.localPlayer.y < 13312) { // L:
																																					// 4943
				if ((Tiles.Tiles_renderFlags[PacketWriter.Client_plane][class101.localPlayer.x >> 7][class101.localPlayer.y >> 7] & 4) != 0) { // L:
																																				// 4944
					var0 = PacketWriter.Client_plane;
				}
				return var0; // L: 4945
