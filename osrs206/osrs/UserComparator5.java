...
public class UserComparator5 extends AbstractUserComparator {
	...
	public static String method2580(CharSequence var0, LoginType var1) {
		if (var0 == null) { // L: 20
			...
			int var2 = 0; // L: 21
			int var3;
			for (var3 = var0.length(); var2 < var3 && class154.method3163(var0.charAt(var2)); ++var2) { // L:
																										// 22
																										// 23
			}
			while (var3 > var2 && class154.method3163(var0.charAt(var3 - 1))) { // L:
																				// 24
				--var3;
			}
				...
				if (var4 <= var6) { // L: 44
					...
					for (int var14 = var2; var14 < var3; ++var14) { // L: 49
						...
						if (Character.isISOControl(var7)) { // L: 53
							var8 = false; // L: 54
						} else if (FloorOverlayDefinition.isAlphaNumeric(var7)) { // L:
																					// 57
							var8 = true; // L: 58
						} else {
						...
						if (var8) { // L: 83
							char var13 = PacketBufferNode.method5203(var7); // L:
																			// 84
							if (var13 != 0) { // L: 85
	...
	static final void Clan_leaveChat() {
		PacketBufferNode var0 = EnumComposition.getPacketBufferNode(ClientPacket.field2942, Client.packetWriter.isaacCipher); // L:
																																// 12243
