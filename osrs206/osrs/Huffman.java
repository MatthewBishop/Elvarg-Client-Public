...
public class Huffman {
			...
			if (var6 != 0) { // L: 17
				...
				for (var11 = 0; var11 < var6; ++var11) { // L: 43
					...
					if (var10 >= this.keys.length) { // L: 50
						...
						for (int var14 = 0; var14 < this.keys.length; ++var14) { // L:
																					// 52
				...
				if (var11 < var13) { // L: 82
					...
					if (var11 < var13) { // L: 86
						...
						if (var11 < var13) { // L: 90
							++var11; // L: 91
							var12 -= 8; // L: 92
							var4[var11] = (byte) (var6 = var9 << -var12); // L:
																			// 93
						}
					}
				}
	...
	static Script method5480(int var0, int var1) {
		Script var2 = (Script) Script.Script_cached.get((long) (var0 << 16)); // L:
																				// 60
		if (var2 != null) { // L: 61
			return var2; // L: 62
		} else {
			...
			if (var4 == -1) { // L: 66
				...
				if (var5 != null) { // L: 70
					...
					if (var2 != null) { // L: 75
						Script.Script_cached.put(var2, (long) (var0 << 16)); // L:
																				// 76
						return var2; // L: 77
					}
				}
	...
	static int method5474(int var0, int var1, int var2) {
		if ((Tiles.Tiles_renderFlags[var0][var1][var2] & 8) != 0) { // L: 867
			...
			return var0 > 0 && (Tiles.Tiles_renderFlags[1][var1][var2] & 2) != 0 ? var0 - 1 : var0; // L:
																									// 868
		}
	}
}
