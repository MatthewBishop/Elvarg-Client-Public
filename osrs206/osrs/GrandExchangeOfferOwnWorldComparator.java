...
public class GrandExchangeOfferOwnWorldComparator implements Comparator {
	...
	public static String method1097(CharSequence var0) {
		...
		for (int var3 = 0; var3 < var1; ++var3) { // L: 13
			...
			if ((var4 < 'a' || var4 > 'z') && (var4 < 'A' || var4 > 'Z') && (var4 < '0' || var4 > '9') && var4 != '.' && var4 != '-' && var4 != '*' && var4 != '_') { // L:
																																										// 15
				if (var4 == ' ') { // L: 16
					var2.append('+');
				} else {
	...
	public static void method1096(boolean var0) {
		if (var0 != _Junk.ItemDefinition_inMembersWorld) { // L:
																				// 573
			_Junk.method1702(); // L: 574
			_Junk.ItemDefinition_inMembersWorld = var0; // L:
																			// 575
		}
	} // L: 577
}
