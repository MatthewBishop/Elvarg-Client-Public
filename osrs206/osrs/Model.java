...
public class Model extends Renderable {
	...
	static Anim_class387 field2542;
	
	static Anim_class387 field2510;
	
	static Anim_class387 field2511;
	...
	static {
		...
		field2542 = new Anim_class387(); // L: 15
		field2510 = new Anim_class387(); // L: 16
		field2511 = new Anim_class387(); // L: 17
		...
		for (var7 = 0; var7 < var2; ++var7) { // L: 139
			...
			if (var8 != null) { // L: 141
				...
				for (var9 = 0; var9 < var8.indicesCount; ++var9) { // L: 142
					this.indices1[this.indicesCount] = this.verticesCount + var8.indices1[var9]; // L:
																									// 143
					this.indices2[this.indicesCount] = this.verticesCount + var8.indices2[var9]; // L:
																									// 144
					this.indices3[this.indicesCount] = this.verticesCount + var8.indices3[var9]; // L:
																									// 145
					this.faceColors1[this.indicesCount] = var8.faceColors1[var9]; // L:
																					// 146
					this.faceColors2[this.indicesCount] = var8.faceColors2[var9]; // L:
																					// 147
					this.faceColors3[this.indicesCount] = var8.faceColors3[var9]; // L:
																					// 148
					if (var3) { // L: 149
						if (var8.faceRenderPriorities != null) { // L: 150
							this.faceRenderPriorities[this.indicesCount] = var8.faceRenderPriorities[var9];
						} else {
							this.faceRenderPriorities[this.indicesCount] = var8.field2527; // L:
																							// 151
						}
					}
					...
					if (var6) { // L: 160
						if (var8.field2525 != null && var8.field2525[var9] != -1) { // L:
																					// 161
				...
				for (var9 = 0; var9 < var8.field2528; ++var9) { // L: 166
					this.field2529[this.field2528] = this.verticesCount + var8.field2529[var9]; // L:
																								// 167
					this.field2522[this.field2528] = this.verticesCount + var8.field2522[var9]; // L:
																								// 168
					this.field2531[this.field2528] = this.verticesCount + var8.field2531[var9]; // L:
																								// 169
					++this.field2528; // L: 170
				}
				for (var9 = 0; var9 < var8.verticesCount; ++var9) { // L: 172
					this.verticesX[this.verticesCount] = var8.verticesX[var9]; // L:
																				// 173
					this.verticesY[this.verticesCount] = var8.verticesY[var9]; // L:
																				// 174
					this.verticesZ[this.verticesCount] = var8.verticesZ[var9]; // L:
																				// 175
	...
	public Model contourGround(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
		...
		if (var7 >= 0 && var8 + 128 >> 7 < var1.length && var9 >= 0 && var10 + 128 >> 7 < var1[0].length) { // L:
																											// 188
			var7 >>= 7; // L: 189
			var8 = var8 + 127 >> 7; // L: 190
			var9 >>= 7; // L: 191
			var10 = var10 + 127 >> 7; // L: 192
			if (var3 == var1[var7][var9] && var3 == var1[var8][var9] && var3 == var1[var7][var10] && var3 == var1[var8][var10]) { // L:
																																	// 193
				return this;
			} else {
				Model var11;
				if (var5) { // L: 195
					...
					var11.faceRenderPriorities = this.faceRenderPriorities; // L:
																			// 208
				...
				int var21;
				if (var6 == 0) { // L: 224
					for (var12 = 0; var12 < var11.verticesCount; ++var12) { // L:
																			// 225
						...
						var17 = var13 >> 7; // L: 230
						var18 = var14 >> 7; // L: 231
						var19 = var1[var17][var18] * (128 - var15) + var1[var17 + 1][var18] * var15 >> 7; // L:
																											// 232
						var20 = var1[var17][var18 + 1] * (128 - var15) + var15 * var1[var17 + 1][var18 + 1] >> 7; // L:
						// 233
						var21 = var19 * (128 - var16) + var20 * var16 >> 7; // L:
																			// 234
						var11.verticesY[var12] = var21 + this.verticesY[var12] - var3; // L:
																						// 235
					}
				} else {
					for (var12 = 0; var12 < var11.verticesCount; ++var12) { // L:
																			// 239
						var13 = (-this.verticesY[var12] << 16) / super.height; // L:
																				// 240
						if (var13 < var6) { // L: 241
							...
							var18 = var14 >> 7; // L: 246
							var19 = var15 >> 7; // L: 247
							var20 = var1[var18][var19] * (128 - var16) + var1[var18 + 1][var19] * var16 >> 7; // L:
																												// 248
							var21 = var1[var18][var19 + 1] * (128 - var16) + var16 * var1[var18 + 1][var19 + 1] >> 7; // L:
							// 249
							int var22 = var20 * (128 - var17) + var21 * var17 >> 7; // L:
																					// 250
							var11.verticesY[var12] = (var6 - var13) * (var22 - var3) / var6 + this.verticesY[var12]; // L:
							// 251
						}
					}
				}
	...
	public Model toSharedSequenceModel(boolean var1) {
		if (!var1 && Model_sharedSequenceModelFaceAlphas.length < this.indicesCount) { // L:
																						// 260
			Model_sharedSequenceModelFaceAlphas = new byte[this.indicesCount + 100];
		}
		return this.buildSharedModel(var1, Model_sharedSequenceModel, Model_sharedSequenceModelFaceAlphas); // L:
																											// 261
	}
	
	public Model toSharedSpotAnimationModel(boolean var1) {
		if (!var1 && Model_sharedSpotAnimationModelFaceAlphas.length < this.indicesCount) { // L:
																							// 265
			Model_sharedSpotAnimationModelFaceAlphas = new byte[this.indicesCount + 100];
		}
		return this.buildSharedModel(var1, Model_sharedSpotAnimationModel, Model_sharedSpotAnimationModelFaceAlphas); // L:
		// 266
	}
	...
	Model buildSharedModel(boolean var1, Model var2, byte[] var3) {
		...
		if (var2.verticesX == null || var2.verticesX.length < this.verticesCount) { // L:
																					// 273
	...
	void calculateBoundingBox(int var1) {
		if (this.xMidOffset == -1) { // L: 317
			...
			for (int var10 = 0; var10 < this.verticesCount; ++var10) { // L: 326
				int var11 = Rasterizer3D.method4052(this.verticesX[var10], this.verticesZ[var10], var8, var9); // L:
																												// 327
				int var12 = this.verticesY[var10]; // L: 328
				int var13 = Rasterizer3D.method4072(this.verticesX[var10], this.verticesZ[var10], var8, var9); // L:
																												// 329
				if (var11 < var2) { // L: 330
					var2 = var11;
				}
	...
	public void calculateBoundsCylinder() {
		if (this.boundsType != 1) { // L: 354
			...
			this.xzRadius = (int) (Math.sqrt((double) this.xzRadius) + 0.99D); // L:
																				// 368
			this.radius = (int) (Math.sqrt((double) (this.xzRadius * this.xzRadius + super.height * super.height)) + 0.99D); // L:
																																// 369
			this.diameter = this.radius + (int) (Math.sqrt((double) (this.xzRadius * this.xzRadius + this.bottomY * this.bottomY)) + 0.99D); // L:
			// 370
		}
	} // L: 371
	void method4391() {
	...
	public void animate(Anim_Frames var1, int var2) {
		if (this.vertexLabels != null) { // L: 400
			if (var2 != -1) { // L: 401
				Anim_Animation var3 = var1.frames[var2]; // L: 402
				Anim_Skeleton var4 = var3.skeleton; // L: 403
				Model_transformTempX = 0; // L: 404
				Model_transformTempY = 0; // L: 405
				Model_transformTempZ = 0; // L: 406
				for (int var5 = 0; var5 < var3.transformCount; ++var5) { // L:
																			// 407
					int var6 = var3.transformSkeletonLabels[var5]; // L: 408
					this.transform(var4.transformTypes[var6], var4.labels[var6], var3.transformXs[var5], var3.transformYs[var5], var3.transformZs[var5]); // L:
																																							// 409
				}
	...
	public void method4404(Anim_class122 var1, int var2) {
		Anim_Skeleton var3 = var1.field1523; // L: 415
		Anim_class201 var4 = var3.method4150(); // L: 416
		if (var4 != null) { // L: 417
	...
	void method4396(Anim_class122 var1, int var2) {
		Anim_Skeleton var3 = var1.field1523; // L: 428
		for (int var4 = 0; var4 < var3.count; ++var4) { // L: 429
			int var5 = var3.transformTypes[var4]; // L: 430
			if (var5 == 5 && var1.field1518 != null && var1.field1518[var4] != null && var1.field1518[var4][0] != null && this.faceLabelsAlpha != null && this.faceAlphas != null) { // L:
																																														// 431
																																														// 432
				Anim_class117 var6 = var1.field1518[var4][0]; // L: 433
				...
				for (int var9 = 0; var9 < var8; ++var9) { // L: 436
					...
					if (var10 < this.faceLabelsAlpha.length) { // L: 438
						...
						for (int var12 = 0; var12 < var11.length; ++var12) { // L:
																				// 440
							int var13 = var11[var12]; // L: 441
							int var14 = (int) ((float) (this.faceAlphas[var13] & 255) + var6.method2701(var2) * 255.0F); // L:
							// 442
							if (var14 < 0) { // L: 443
								var14 = 0;
	...
	void method4403(Anim_class201 var1, int var2) {
		this.method4424(var1, var2); // L: 456
	} // L: 458
	
	public void animate2(Anim_Frames var1, int var2, Anim_Frames var3, int var4, int[] var5) {
		if (var2 != -1) { // L: 461
			if (var5 != null && var4 != -1) { // L: 462
				Anim_Animation var6 = var1.frames[var2]; // L: 466
				Anim_Animation var7 = var3.frames[var4]; // L: 467
				Anim_Skeleton var8 = var6.skeleton; // L: 468
				...
				int var11;
				int var12;
				for (var11 = 0; var11 < var6.transformCount; ++var11) { // L:
																		// 474
					for (var12 = var6.transformSkeletonLabels[var11]; var12 > var10; var10 = var5[var13++]) { // L:
																												// 475
						// 476
					}
					if (var12 != var10 || var8.transformTypes[var12] == 0) { // L:
																				// 477
				...
				var13 = var9 + 1; // L: 483
				var10 = var5[var9];
				for (var11 = 0; var11 < var7.transformCount; ++var11) { // L:
																		// 484
					for (var12 = var7.transformSkeletonLabels[var11]; var12 > var10; var10 = var5[var13++]) { // L:
																												// 485
						// 486
					}
					if (var12 == var10 || var8.transformTypes[var12] == 0) { // L:
	...
	public void method4399(Anim_class122 var1, int var2, boolean[] var3, boolean var4) {
		Anim_Skeleton var5 = var1.field1523; // L: 493
		Anim_class201 var6 = var5.method4150(); // L: 494
		if (var6 != null) { // L: 495
	...
	public void method4398(Anim_Frames var1, int var2, int[] var3, boolean var4) {
		if (var3 == null) { // L: 505
			this.animate(var1, var2); // L: 506
		} else {
			Anim_Animation var5 = var1.frames[var2]; // L: 509
			Anim_Skeleton var6 = var5.skeleton; // L: 510
			byte var7 = 0; // L: 511
			...
			for (int var9 = 0; var9 < var5.transformCount; ++var9) { // L: 516
				int var10;
				for (var10 = var5.transformSkeletonLabels[var9]; var10 > var8; var8 = var3[var11++]) { // L:
																										// 517
																										// 518
				}
				if (var4) { // L: 519
					if (var10 == var8 || var6.transformTypes[var10] == 0) { // L:
																			// 520
						this.transform(var6.transformTypes[var10], var6.labels[var10], var5.transformXs[var9], var5.transformYs[var9], var5.transformZs[var9]);
					}
				} else if (var10 != var8 || var6.transformTypes[var10] == 0) {
					this.transform(var6.transformTypes[var10], var6.labels[var10], var5.transformXs[var9], var5.transformYs[var9], var5.transformZs[var9]); // L:
																																							// 523
				}
			}
		}
	...
	void transform(int var1, int[] var2, int var3, int var4, int var5) {
		...
		if (var1 == 0) { // L: 530
			...
			if (var7 > 0) { // L: 548
				Model_transformTempX = var3 + Model_transformTempX / var7; // L:
																			// 549
				Model_transformTempY = var4 + Model_transformTempY / var7; // L:
																			// 550
				Model_transformTempZ = var5 + Model_transformTempZ / var7; // L:
																			// 551
			} else {
			...
			if (var1 == 1) { // L: 560
				for (var7 = 0; var7 < var6; ++var7) { // L: 561
					...
					if (var8 < this.vertexLabels.length) { // L: 563
						...
						for (var10 = 0; var10 < var9.length; ++var10) { // L:
																		// 565
					...
					if (var8 < this.vertexLabels.length) { // L: 578
						...
						for (var10 = 0; var10 < var9.length; ++var10) { // L:
							...
							if (var14 != 0) { // L: 588
								...
								var17 = var15 * this.verticesY[var11] + var16 * this.verticesX[var11] >> 16; // L:
																												// 591
								this.verticesY[var11] = var16 * this.verticesY[var11] - var15 * this.verticesX[var11] >> 16; // L:
																																// 592
							...
							if (var12 != 0) { // L: 595
								...
								var17 = var16 * this.verticesY[var11] - var15 * this.verticesZ[var11] >> 16; // L:
																												// 598
								this.verticesZ[var11] = var15 * this.verticesY[var11] + var16 * this.verticesZ[var11] >> 16; // L:
																																// 599
							...
							if (var13 != 0) { // L: 602
								...
								var17 = var15 * this.verticesZ[var11] + var16 * this.verticesX[var11] >> 16; // L:
																												// 605
								this.verticesZ[var11] = var16 * this.verticesZ[var11] - var15 * this.verticesX[var11] >> 16; // L:
																																// 606
				...
				for (var7 = 0; var7 < var6; ++var7) { // L: 618
					...
					if (var8 < this.vertexLabels.length) { // L: 620
						...
						for (var10 = 0; var10 < var9.length; ++var10) { // L:
							...
							var10000[var11] -= Model_transformTempZ;
							this.verticesX[var11] = var3 * this.verticesX[var11] / 128; // L:
																						// 627
							this.verticesY[var11] = var4 * this.verticesY[var11] / 128; // L:
																						// 628
							this.verticesZ[var11] = var5 * this.verticesZ[var11] / 128; // L:
																						// 629
				...
				if (this.faceLabelsAlpha != null && this.faceAlphas != null) { // L:
																				// 639
					for (var7 = 0; var7 < var6; ++var7) { // L: 640
						...
						if (var8 < this.faceLabelsAlpha.length) { // L: 642
							...
							for (var10 = 0; var10 < var9.length; ++var10) { // L:
								...
								var12 = (this.faceAlphas[var11] & 255) + var3 * 8; // L:
																					// 646
								if (var12 < 0) { // L: 647
									var12 = 0;
	...
	public void rotateZ(int var1) {
		...
		for (int var4 = 0; var4 < this.verticesCount; ++var4) { // L: 687
			int var5 = var3 * this.verticesY[var4] - var2 * this.verticesZ[var4] >> 16; // L:
																						// 688
			this.verticesZ[var4] = var2 * this.verticesY[var4] + var3 * this.verticesZ[var4] >> 16; // L:
																									// 689
	...
	public final void method4442(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		...
		for (int var19 = 0; var19 < this.verticesCount; ++var19) { // L: 727
			...
			modelViewportXs[var19] = var20 * Rasterizer3D.Rasterizer3D_zoom / var22 + var8; // L:
																							// 753
			modelViewportYs[var19] = var23 * Rasterizer3D.Rasterizer3D_zoom / var22 + var9; // L:
																							// 754
	...
	public final void method4462(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		...
		for (int var20 = 0; var20 < this.verticesCount; ++var20) { // L: 781
			...
			modelViewportXs[var20] = var9 + var21 * Rasterizer3D.Rasterizer3D_zoom / var8; // L:
																							// 807
			modelViewportYs[var20] = var10 + var24 * Rasterizer3D.Rasterizer3D_zoom / var8; // L:
																							// 808
		...
		if (this.diameter < 1600) { // L: 1017
			...
			for (var7 = 0; var7 < this.indicesCount; ++var7) { // L: 1020
				if (this.faceColors3[var7] != -2) { // L: 1021
					...
					int var29;
					if (!var1 || var11 != -5000 && var12 != -5000 && var28 != -5000) { // L:
																						// 1028
						if (var2 && class101.method2549(modelViewportYs[var8], modelViewportYs[var9], modelViewportYs[var10], var11, var12, var28, var6)) { // L:
																																							// 1054
							class249.method5123(var4); // L: 1055
							var2 = false; // L: 1056
						}
						if ((var11 - var12) * (modelViewportYs[var10] - modelViewportYs[var9]) - (var28 - var12) * (modelViewportYs[var8] - modelViewportYs[var9]) > 0) { // L:
																																											// 1058
							field2550[var7] = false; // L: 1059
							if (var11 >= 0 && var12 >= 0 && var28 >= 0 && var11 <= Rasterizer3D.Rasterizer3D_clipWidth && var12 <= Rasterizer3D.Rasterizer3D_clipWidth && var28 <= Rasterizer3D.Rasterizer3D_clipWidth) { // L:
																																																							// 1060
								field2549[var7] = false; // L: 1061
							} else {
								field2549[var7] = true;
							}
							var29 = (field2553[var8] + field2553[var9] + field2553[var10]) / 3 + this.radius; // L:
																												// 1062
							field2509[var29][field2558[var29]++] = var7; // L:
																			// 1063
						}
					} else {
						...
						if (var15 * var23 + var18 * var24 + var21 * var25 > 0) { // L:
																					// 1047
							field2550[var7] = true; // L: 1048
							int var26 = (field2553[var8] + field2553[var9] + field2553[var10]) / 3 + this.radius; // L:
							// 1049
							field2509[var26][field2558[var26]++] = var7; // L:
																			// 1050
						}
					}
				}
			...
			if (this.faceRenderPriorities == null) { // L: 1067
				...
				for (var7 = this.diameter - 1; var7 >= 0; --var7) { // L: 1081
					...
					if (var8 > 0) { // L: 1083
						...
						for (var10 = 0; var10 < var8; ++var10) { // L: 1085
							...
							byte var31 = this.faceRenderPriorities[var11]; // L:
																			// 1087
				...
				for (var15 = 0; var15 < 10; ++var15) { // L: 1115
					while (var15 == 0 && var10 > var7) { // L: 1116
						...
						if (var11 == var12 && var13 != field2532[11]) { // L:
																		// 1118
							var11 = 0; // L: 1119
	...
	final void drawFace(int var1) {
		if (field2550[var1]) { // L: 1169
			...
			if (this.faceAlphas == null) { // L: 1177
				...
				Rasterizer3D.Rasterizer3D_alpha = this.faceAlphas[var1] & 255; // L:
																				// 1181
			}
			this.method4413(var1, modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4], modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4], this.faceColors1[var1], this.faceColors2[var1], this.faceColors3[var1]); // L:
																																																														// 1183
		}
	} // L: 1171 1184
	final void method4413(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
		if (this.faceTextures != null && this.faceTextures[var1] != -1) { // L:
																			// 1187
			int var11;
			int var12;
			int var13;
			if (this.field2525 != null && this.field2525[var1] != -1) { // L:
																		// 1205
			...
			if (this.faceColors3[var1] == -1) { // L: 1216
				Rasterizer3D.method4070(var2, var3, var4, var5, var6, var7, var8, var8, var8, field2520[var11], field2520[var12], field2520[var13], field2555[var11], field2555[var12], field2555[var13], field2559[var11], field2559[var12], field2559[var13], this.faceTextures[var1]); // L:
																																																																							// 1217
			} else {
				Rasterizer3D.method4070(var2, var3, var4, var5, var6, var7, var8, var9, var10, field2520[var11], field2520[var12], field2520[var13], field2555[var11], field2555[var12], field2555[var13], field2559[var11], field2559[var12], field2559[var13], this.faceTextures[var1]); // L:
																																																																							// 1220
			}
		} else if (this.faceColors3[var1] == -1 && this.overrideAmount > 0) { // L:
																				// 1188
			Rasterizer3D.method4035(var2, var3, var4, var5, var6, var7, Model_colorPalette[this.faceColors1[var1]], this.overrideHue, this.overrideSaturation, this.overrideLuminance, this.overrideAmount); // L:
																																																				// 1189
		} else if (this.faceColors3[var1] == -1) { // L: 1191
			Rasterizer3D.method4116(var2, var3, var4, var5, var6, var7, Model_colorPalette[this.faceColors1[var1]]); // L:
			// 1192
		} else if (this.overrideAmount > 0) { // L: 1194
			Rasterizer3D.method4032(var2, var3, var4, var5, var6, var7, var8, var9, var10, this.overrideHue, this.overrideSaturation, this.overrideLuminance, this.overrideAmount); // L:
																																													// 1195
		} else {
			Rasterizer3D.method4096(var2, var3, var4, var5, var6, var7, var8, var9, var10); // L:
																							// 1198
		}
	} // L: 1223
	final void method4453(int var1) {
		...
		if (var8 >= 50) { // L: 1237
			...
			if (var10 >= 50) { // L: 1246
				...
				field2505[var4] = var2 + Rasterizer3D.Rasterizer3D_zoom * (var11 + ((field2520[var7] - var11) * var14 >> 16)) / 50; // L:
				// 1248
				field2566[var4] = var3 + Rasterizer3D.Rasterizer3D_zoom * (var12 + ((field2555[var7] - var12) * var14 >> 16)) / 50; // L:
				// 1249
				field2567[var4++] = var13 + ((this.faceColors3[var1] - var13) * var14 >> 16); // L:
																								// 1250
			}
			if (var9 >= 50) { // L: 1252
				var14 = field2547[var9 - var8] * (50 - var8); // L: 1253
				field2505[var4] = var2 + Rasterizer3D.Rasterizer3D_zoom * (var11 + ((field2520[var6] - var11) * var14 >> 16)) / 50; // L:
				// 1254
				field2566[var4] = var3 + Rasterizer3D.Rasterizer3D_zoom * (var12 + ((field2555[var6] - var12) * var14 >> 16)) / 50; // L:
				// 1255
				field2567[var4++] = var13 + ((this.faceColors2[var1] - var13) * var14 >> 16); // L:
																								// 1256
			}
		}
		if (var9 >= 50) { // L: 1259
			...
			if (var8 >= 50) { // L: 1268
				...
				field2505[var4] = var2 + Rasterizer3D.Rasterizer3D_zoom * (var11 + ((field2520[var5] - var11) * var14 >> 16)) / 50; // L:
				// 1270
				field2566[var4] = var3 + Rasterizer3D.Rasterizer3D_zoom * (var12 + ((field2555[var5] - var12) * var14 >> 16)) / 50; // L:
				// 1271
				field2567[var4++] = var13 + ((this.faceColors1[var1] - var13) * var14 >> 16); // L:
																								// 1272
			}
			if (var10 >= 50) { // L: 1274
		...
		if (var4 == 3) { // L: 1310
			...
			this.method4413(var1, var14, var15, var16, var11, var12, var13, field2567[0], field2567[1], field2567[2]); // L:
			// 1312
		}
		if (var4 == 4) { // L: 1314
			if (var11 < 0 || var12 < 0 || var13 < 0 || var11 > Rasterizer3D.Rasterizer3D_clipWidth || var12 > Rasterizer3D.Rasterizer3D_clipWidth || var13 > Rasterizer3D.Rasterizer3D_clipWidth || field2505[3] < 0 || field2505[3] > Rasterizer3D.Rasterizer3D_clipWidth) { // L:
																																																																				// 1315
				Rasterizer3D.field2345 = true;
			}
			int var17;
			if (this.faceTextures != null && this.faceTextures[var1] != -1) { // L:
				...
				if (this.faceColors3[var1] == -1) { // L: 1352
					Rasterizer3D.method4070(var14, var15, var16, var11, var12, var13, this.faceColors1[var1], this.faceColors1[var1], this.faceColors1[var1], field2520[var17], field2520[var18], field2520[var19], field2555[var17], field2555[var18], field2555[var19], field2559[var17], field2559[var18], field2559[var19], var21); // L:
																																																																																		// 1353
					Rasterizer3D.method4070(var14, var16, field2566[3], var11, var13, field2505[3], this.faceColors1[var1], this.faceColors1[var1], this.faceColors1[var1], field2520[var17], field2520[var18], field2520[var19], field2555[var17], field2555[var18], field2555[var19], field2559[var17], field2559[var18], field2559[var19], var21); // L:
																																																																																						// 1354
				} else {
					Rasterizer3D.method4070(var14, var15, var16, var11, var12, var13, field2567[0], field2567[1], field2567[2], field2520[var17], field2520[var18], field2520[var19], field2555[var17], field2555[var18], field2555[var19], field2559[var17], field2559[var18], field2559[var19], var21); // L:
																																																																											// 1357
					Rasterizer3D.method4070(var14, var16, field2566[3], var11, var13, field2505[3], field2567[0], field2567[2], field2567[3], field2520[var17], field2520[var18], field2520[var19], field2555[var17], field2555[var18], field2555[var19], field2559[var17], field2559[var18], field2559[var19], var21); // L:
																																																																														// 1358
				}
			} else if (this.faceColors3[var1] == -1 && this.overrideAmount > 0) { // L:
																					// 1317
				var17 = Model_colorPalette[this.faceColors1[var1]]; // L: 1318
				Rasterizer3D.method4035(var14, var15, var16, var11, var12, var13, var17, this.overrideHue, this.overrideSaturation, this.overrideLuminance, this.overrideAmount); // L:
																																													// 1319
				Rasterizer3D.method4035(var14, var16, field2566[3], var11, var13, field2505[3], var17, this.overrideHue, this.overrideSaturation, this.overrideLuminance, this.overrideAmount); // L:
																																																// 1320
			} else if (this.faceColors3[var1] == -1) { // L: 1322
				var17 = Model_colorPalette[this.faceColors1[var1]]; // L: 1323
				Rasterizer3D.method4116(var14, var15, var16, var11, var12, var13, var17); // L:
																							// 1324
				Rasterizer3D.method4116(var14, var16, field2566[3], var11, var13, field2505[3], var17); // L:
																										// 1325
			} else if (this.overrideAmount > 0) { // L: 1327
				Rasterizer3D.method4032(var14, var15, var16, var11, var12, var13, field2567[0], field2567[1], field2567[2], this.overrideHue, this.overrideLuminance, this.overrideSaturation, this.overrideAmount); // L:
																																																						// 1328
				Rasterizer3D.method4032(var14, var16, field2566[3], var11, var13, field2505[3], field2567[0], field2567[2], field2567[3], this.overrideHue, this.overrideLuminance, this.overrideSaturation, this.overrideAmount); // L:
																																																									// 1329
			} else {
				Rasterizer3D.method4096(var14, var15, var16, var11, var12, var13, field2567[0], field2567[1], field2567[2]); // L:
																																// 1332
				Rasterizer3D.method4096(var14, var16, field2566[3], var11, var13, field2505[3], field2567[0], field2567[2], field2567[3]); // L:
																																			// 1333
			}
		}
	} // L: 1362
	
	void method4415(int var1, Anim_class387 var2) {
		...
		this.verticesX[var1] = (int) (var2.field4394[0] * var3 + var2.field4394[4] * var4 + var2.field4394[8] * var5 + var2.field4394[12] * var6); // L:
																																					// 1369
		this.verticesY[var1] = -((int) (var2.field4394[1] * var3 + var2.field4394[5] * var4 + var2.field4394[9] * var5 + var2.field4394[13] * var6)); // L:
																																						// 1370
		this.verticesZ[var1] = -((int) (var2.field4394[2] * var3 + var2.field4394[6] * var4 + var2.field4394[10] * var5 + var2.field4394[14] * var6)); // L:
																																						// 1371
	} // L: 1372
	
	void method4424(Anim_class201 var1, int var2) {
			...
			for (int var3 = 0; var3 < this.verticesCount; ++var3) { // L: 1376
				...
				if (var4 != null && var4.length != 0) { // L: 1378
					...
					for (int var6 = 0; var6 < var4.length; ++var6) { // L: 1381
						...
						Anim_class115 var8 = var1.method4123(var7); // L: 1383
						if (var8 != null) { // L: 1384
							field2510.method6963((float) var5[var6] / 255.0F); // L:
																				// 1385
							field2511.method6973(var8.method2651(var2)); // L:
																			// 1386
	...
	void draw(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, long var9) {
		...
		if (var14 > 50 && var12 < 3500) { // L: 829
			...
			int var16 = (var15 - this.xzRadius) * Rasterizer3D.Rasterizer3D_zoom; // L:
																					// 831
			if (var16 / var14 < Rasterizer3D.Rasterizer3D_clipMidX2) { // L: 832
				int var17 = (var15 + this.xzRadius) * Rasterizer3D.Rasterizer3D_zoom; // L:
																						// 833
				if (var17 / var14 > Rasterizer3D.Rasterizer3D_clipNegativeMidX) { // L:
																					// 834
					int var18 = var3 * var7 - var11 * var2 >> 16; // L: 835
					int var19 = var2 * this.xzRadius >> 16; // L: 836
					int var20 = (var3 * this.bottomY >> 16) + var19; // L: 837
					int var21 = (var18 + var20) * Rasterizer3D.Rasterizer3D_zoom; // L:
																					// 838
					if (var21 / var14 > Rasterizer3D.Rasterizer3D_clipNegativeMidY) { // L:
																						// 839
						int var22 = (var3 * super.height >> 16) + var19; // L:
																			// 840
						int var23 = (var18 - var22) * Rasterizer3D.Rasterizer3D_zoom; // L:
																						// 841
						if (var23 / var14 < Rasterizer3D.Rasterizer3D_clipMidY2) { // L:
																					// 842
							int var24 = var13 + (var2 * super.height >> 16); // L:
																				// 843
							...
							boolean var27 = var26 || this.field2528 > 0; // L:
																			// 847
							...
							if (var32 && var31) { // L: 857
								...
								if (field2524) { // L: 859
									...
									if (!class174.method3458()) { // L: 863
										...
										int var44;
										int var45;
										if (!ViewportMouse.ViewportMouse_false0) { // L:
																					// 868
											var37 = Scene.Scene_cameraPitchSine; // L:
																					// 869
											var38 = Scene.Scene_cameraPitchCosine; // L:
																					// 870
											var39 = Scene.Scene_cameraYawSine; // L:
																				// 871
											var40 = Scene.Scene_cameraYawCosine; // L:
																					// 872
											byte var41 = 50; // L: 873
											short var42 = 3500; // L: 874
											var43 = (ViewportMouse.ViewportMouse_x - Rasterizer3D.Rasterizer3D_clipMidX) * var41 / Rasterizer3D.Rasterizer3D_zoom; // L:
																																									// 875
											var44 = (ViewportMouse.ViewportMouse_y - Rasterizer3D.Rasterizer3D_clipMidY) * var41 / Rasterizer3D.Rasterizer3D_zoom; // L:
																																									// 876
											var45 = (ViewportMouse.ViewportMouse_x - Rasterizer3D.Rasterizer3D_clipMidX) * var42 / Rasterizer3D.Rasterizer3D_zoom; // L:
																																									// 877
											int var46 = (ViewportMouse.ViewportMouse_y - Rasterizer3D.Rasterizer3D_clipMidY) * var42 / Rasterizer3D.Rasterizer3D_zoom; // L:
																																										// 878
											int var47 = Rasterizer3D.method4045(var44, var41, var38, var37); // L:
																												// 880
											var53 = Rasterizer3D.method4046(var44, var41, var38, var37); // L:
																											// 881
											var44 = var47; // L: 882
											var47 = Rasterizer3D.method4045(var46, var42, var38, var37); // L:
																											// 883
											var54 = Rasterizer3D.method4046(var46, var42, var38, var37); // L:
																											// 884
											var46 = var47; // L: 885
											var47 = Rasterizer3D.method4025(var43, var53, var40, var39); // L:
																											// 886
											var53 = Rasterizer3D.method4044(var43, var53, var40, var39); // L:
																											// 887
											var43 = var47; // L: 888
											var47 = Rasterizer3D.method4025(var45, var54, var40, var39); // L:
																											// 889
											var54 = Rasterizer3D.method4044(var45, var54, var40, var39); // L:
																											// 890
											ViewportMouse.field2588 = (var43 + var47) / 2; // L:
																							// 892
											GZipDecompressor.field4821 = (var46 + var44) / 2; // L:
																								// 893
											class340.field4138 = (var54 + var53) / 2; // L:
																						// 894
											ViewportMouse.field2589 = (var47 - var43) / 2; // L:
																							// 895
											ItemComposition.field2148 = (var46 - var44) / 2; // L:
																								// 896
											User.field4308 = (var54 - var53) / 2; // L:
																					// 897
											class421.field4607 = Math.abs(ViewportMouse.field2589); // L:
																									// 898
											ViewportMouse.field2590 = Math.abs(ItemComposition.field2148); // L:
																											// 899
											class136.field1612 = Math.abs(User.field4308); // L:
																							// 900
										}
										...
										var43 = ViewportMouse.field2588 - var37; // L:
																					// 908
										var44 = GZipDecompressor.field4821 - var38; // L:
																					// 909
										var45 = class340.field4138 - var39; // L:
																			// 910
										if (Math.abs(var43) > var40 + class421.field4607) { // L:
																							// 911
											var35 = false; // L: 912
										} else if (Math.abs(var44) > var53 + ViewportMouse.field2590) { // L:
																										// 915
											var35 = false; // L: 916
										} else if (Math.abs(var45) > var54 + class136.field1612) { // L:
																									// 919
											var35 = false; // L: 920
										} else if (Math.abs(var45 * ItemComposition.field2148 - var44 * User.field4308) > var53 * class136.field1612 + var54 * ViewportMouse.field2590) { // L:
											// 923
											var35 = false; // L: 924
										} else if (Math.abs(var43 * User.field4308 - var45 * ViewportMouse.field2589) > var54 * class421.field4607 + var40 * class136.field1612) { // L:
																																													// 927
											var35 = false; // L: 928
										} else if (Math.abs(var44 * ViewportMouse.field2589 - var43 * ItemComposition.field2148) > var40 * ViewportMouse.field2590 + var53 * class421.field4607) { // L:
																																																	// 931
											var35 = false; // L: 932
										} else {
											var35 = true; // L: 935
									...
									var48 = var28 - Rasterizer3D.Rasterizer3D_clipMidX; // L:
																						// 958
									var37 = var29 - Rasterizer3D.Rasterizer3D_clipMidY; // L:
																						// 959
									if (var48 > var16 && var48 < var17 && var37 > var23 && var37 < var21) { // L:
																											// 960
										var34 = true; // L: 961
									}
								}
							...
							int var51 = Rasterizer3D.Rasterizer3D_clipMidX; // L:
																			// 969
							var52 = Rasterizer3D.Rasterizer3D_clipMidY; // L:
																		// 970
							var48 = 0; // L: 971
							var37 = 0; // L: 972
							if (var1 != 0) { // L: 973
							...
							for (var38 = 0; var38 < this.verticesCount; ++var38) { // L:
																					// 977
								var39 = this.verticesX[var38]; // L: 978
								var40 = this.verticesY[var38]; // L: 979
								var53 = this.verticesZ[var38]; // L: 980
								if (var1 != 0) { // L: 981
									var54 = var53 * var48 + var39 * var37 >> 16; // L:
																					// 982
									var53 = var53 * var37 - var39 * var48 >> 16; // L:
																					// 983
									var39 = var54; // L: 984
								}
								var39 += var6; // L: 986
								var40 += var7; // L: 987
								var53 += var8; // L: 988
								var54 = var53 * var4 + var5 * var39 >> 16; // L:
																			// 989
								var53 = var5 * var53 - var39 * var4 >> 16; // L:
																			// 990
								var39 = var54; // L: 991
								var54 = var3 * var40 - var53 * var2 >> 16; // L:
																			// 992
								var53 = var40 * var2 + var3 * var53 >> 16; // L:
																			// 993
								field2553[var38] = var53 - var12; // L: 995
								if (var53 >= 50) { // L: 996
									modelViewportXs[var38] = var39 * Rasterizer3D.Rasterizer3D_zoom / var53 + var51; // L:
									// 997
									modelViewportYs[var38] = var54 * Rasterizer3D.Rasterizer3D_zoom / var53 + var52; // L:
									// 998
								} else {
							...
							try {
								this.draw0(var25, var33, this.isSingleTile, var9); // L:
																					// 1011
