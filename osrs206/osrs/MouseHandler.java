...
public class MouseHandler implements MouseListener, MouseMotionListener, FocusListener {
	...
	final int getButton(MouseEvent mouseEvent) {
		int button = mouseEvent.getButton(); // L: 49
		if (!mouseEvent.isAltDown() && button != MouseEvent.BUTTON2) { // L: 50
			return !mouseEvent.isMetaDown() && button != MouseEvent.BUTTON3 ? MouseEvent.BUTTON1 : MouseEvent.BUTTON2; // L: 51 52
		} else {
			return 4;
		}
	}
	...
	public final synchronized void mousePressed(MouseEvent var1) {
		if (MouseHandler_instance != null) { // L: 56
			...
			MouseHandler_lastPressedTimeMillisVolatile = Equations.getCurrentTime(); // L:
																				// 60
	...
	static int method547(int var0, Script var1, boolean var2) {
		...
		if (var0 != 7500 && var0 != 7508) { // L: 4732
			if (var0 != 7501) { // L: 4754
				...
				if (var0 == 7502) { // L: 4763
					...
					var3 = Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize]; // L:
																								// 4765
					var19 = Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize + 1]; // L:
																										// 4766
					...
					class437 var26 = FriendLoginUpdate.method6631(var3); // L:
																			// 4771
					class435 var27 = UserComparator6.method2626(var20); // L:
																		// 4772
					...
					if (var21 >= 0) { // L: 4776
						if (var21 >= var13) { // L: 4777
							throw new RuntimeException("Tuple index out-of-bounds. Requested: " + var21 + ", Max: " + var13); // L:
																																// 4778
						}
						var12 = var21; // L: 4780
					...
					if (var14 == null && var27.field4669 != null) { // L: 4784
																	// 4785
					...
					if (var14 == null) { // L: 4787
						for (var15 = var12; var15 < var13; ++var15) { // L: 4788
							...
							class432 var22 = _Junk.method5472(var16); // L:
																				// 4790
							if (var22 == class432.field4657) { // L: 4791
								Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = "";
							} else {
								Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = ArchiveLoader.method2075(var16); // L:
																																				// 4792
							}
						}
						return 1; // L: 4794
						...
						if (var5 >= 0 && var5 < var15) { // L: 4797
							for (var16 = var12; var16 < var13; ++var16) { // L:
																			// 4800
								int var17 = var16 + var28.length * var5; // L:
																			// 4801
								class432 var18 = _Junk.method5472(var28[var16]); // L:
																							// 4802
								if (var18 == class432.field4657) { // L: 4803
									...
									Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = (Integer) var14[var17]; // L:
																																		// 4804
								}
							}
							return 1; // L: 4806
					...
					class437 var25 = FriendLoginUpdate.method6631(var3); // L:
																			// 4815
					class435 var9 = UserComparator6.method2626(var20); // L:
																		// 4816
					int[] var10 = var9.field4668[var7]; // L: 4817
					Object[] var11 = var25.method7625(var7); // L: 4818
					if (var11 == null && var9.field4669 != null) { // L: 4819
																	// 4820
					...
					if (var0 == 7505) { // L: 4845
						var3 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]; // L:
																										// 4846
						class437 var24 = FriendLoginUpdate.method6631(var3); // L:
																				// 4847
						Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = var24.field4678; // L:
						// 4848
						return 1; // L: 4849
						...
						var3 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]; // L:
																										// 4852
						var19 = -1; // L: 4853
						if (UrlRequest.field1373 != null && var3 >= 0 && var3 < UrlRequest.field1373.size()) { // L:
							// 4854
							var19 = (Integer) UrlRequest.field1373.get(var3); // L:
																				// 4855
						}
						Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = var19; // L:
																											// 4857
						return 1; // L: 4858
						...
						var5 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]; // L:
																										// 4863
						var6 = Static.method2813(var5); // L: 4864
						if (var6 == null) { // L: 4865
							throw new RuntimeException(); // L: 4866
						} else if (class285.method5516(var5) != Client.field588) { // L:
																					// 4868
							throw new RuntimeException(); // L: 4869
						} else if (UrlRequest.field1373 == null && UrlRequest.field1373.isEmpty()) { // L:
																										// 4871
							throw new RuntimeException(); // L: 4872
						} else {
							var7 = class141.method3048(var5); // L: 4874
							List var8 = var6.method7619(var4, var7); // L: 4875
							UrlRequest.field1373 = new LinkedList(UrlRequest.field1373); // L:
																							// 4876
							if (var8 != null) { // L: 4877
							...
							_Junk.field312 = UrlRequest.field1373.iterator(); // L:
																					// 4883
							if (var0 == 7507) { // L: 4884
					...
					var3 = Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize]; // L:
																								// 4830
					class436 var23 = WorldMapRectangle.method4988(var3); // L:
																			// 4831
					if (var23 == null) { // L: 4832
						throw new RuntimeException(); // L: 4833
					} else {
						UrlRequest.field1373 = var23.method7619(0, 0); // L:
																		// 4835
						var5 = 0; // L: 4836
				...
				if (_Junk.field312 != null && _Junk.field312.hasNext()) { // L:
																						// 4755
					Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = (Integer) _Junk.field312.next(); // L:
																																		// 4756
				} else {
			...
			var5 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]; // L:
																							// 4735
			var6 = Static.method2813(var5); // L: 4736
			if (var6 == null) { // L: 4737
