...
public class UserComparator4 implements Comparator {
	...
	static final void updateNpcs(boolean var0, PacketBuffer var1) {
		...
		int var2;
		while (var1.bitsRemaining(Client.packetWriter.serverPacketLength) >= 27) { // L:
																					// 7900
			...
			if (class101.field1366) { // L: 7914
				...
				var4.definition = BuddyRankComparator.getNpcDefinition(var1.readBits(14)); // L:
																							// 7940
			} else {
				int var12 = Client.defaultRotations[var1.readBits(3)]; // L:
																		// 7943
				if (var3) { // L: 7944
			...
			var4.walkRightSequence = var4.definition.walkRightSequence; // L:
																		// 7976
			var4.idleSequence = var4.definition.idleSequence; // L: 7977
			var4.turnLeftSequence = var4.definition.turnLeftSequence; // L: 7978
			var4.turnRightSequence = var4.definition.turnRightSequence; // L:
																		// 7979
			...
			var4.method2362(class101.localPlayer.pathX[0] + var6, class101.localPlayer.pathY[0] + var7, var5 == 1); // L:
			// 7988
		}
		var1.exportIndex(); // L: 7990
		_Junk.method765(var1); // L: 7992
		...
		if (var1.offset != Client.packetWriter.serverPacketLength) { // L: 8000
			...
			for (var2 = 0; var2 < Client.npcCount; ++var2) { // L: 8001
				if (Client.npcs[Client.npcIndices[var2]] == null) { // L: 8002
					throw new RuntimeException(var2 + "," + Client.npcCount); // L:
																				// 8003
				}
			}
		}
