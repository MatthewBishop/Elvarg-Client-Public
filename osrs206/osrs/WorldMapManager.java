...
public final class WorldMapManager {
	...
	public void load(AbstractArchive var1, String var2, boolean var3) {
		if (!this.loadStarted) { // L: 41
			...
			int var4 = var1.getGroupId(WorldMapCacheName.field2867.name); // L:
																			// 47
			int var5 = var1.getFileId(var4, var2); // L: 48
			Buffer var6 = new Buffer(var1.takeFileByNames(WorldMapCacheName.field2867.name, var2)); // L:
																									// 49
			Buffer var7 = new Buffer(var1.takeFileByNames(WorldMapCacheName.field2865.name, var2)); // L:
																									// 50
			...
			this.tileWidth = (this.mapAreaData.getRegionHighX() - this.mapAreaData.getRegionLowX() + 1) * 64; // L:
																												// 65
			this.tileHeight = (this.mapAreaData.getRegionHighY() - this.mapAreaData.getRegionLowY() + 1) * 64; // L:
																												// 66
			int var16 = this.mapAreaData.getRegionHighX() - this.mapAreaData.getRegionLowX() + 1; // L:
																									// 67
			int var9 = this.mapAreaData.getRegionHighY() - this.mapAreaData.getRegionLowY() + 1; // L:
																									// 68
			...
			Iterator var10 = this.mapAreaData.worldMapData0Set.iterator(); // L:
																			// 75
			while (var10.hasNext()) {
				...
				this.regions[var14][var15] = new WorldMapRegion(var12, var13, this.mapAreaData.getBackGroundColor(), this.fonts); // L:
																																	// 82
				this.regions[var14][var15].initWorldMapData0(var11, this.mapAreaData.iconList); // L:
																								// 83
			}
			for (int var17 = 0; var17 < var16; ++var17) { // L: 86
				for (int var18 = 0; var18 < var9; ++var18) { // L: 87
					if (this.regions[var17][var18] == null) { // L: 88
						this.regions[var17][var18] = new WorldMapRegion(this.mapAreaData.getRegionLowX() + var17, this.mapAreaData.getRegionLowY() + var18, this.mapAreaData.getBackGroundColor(), this.fonts); // L:
																																																				// 89
						this.regions[var17][var18].initWorldMapData1(this.mapAreaData.worldMapData1Set, this.mapAreaData.iconList); // L:
																																	// 90
					}
				}
			}
			...
			if (var1.isValidFileName(WorldMapCacheName.field2866.name, var2)) { // L:
																				// 96
				byte[] var20 = var1.takeFileByNames(WorldMapCacheName.field2866.name, var2); // L:
																								// 97
				this.compositeTextureSprite = ItemLayer.method3920(var20); // L:
																			// 98
			}
	...
	public final void drawTiles(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		...
		WorldMapRectangle var13 = this.createWorldMapRectangle(var1, var2, var3, var4); // L:
																						// 116
		...
		if (!this.scaleHandlers.containsKey(var15)) { // L: 120
			WorldMapScaleHandler var16 = new WorldMapScaleHandler(var15); // L:
																			// 121
			var16.init(); // L: 122
		...
		for (var18 = var13.x; var18 <= var23; ++var18) { // L: 127
			for (var19 = var13.y; var19 <= var17; ++var19) { // L: 128
				this.regions[var18][var19].drawTile(var15, (WorldMapScaleHandler) this.scaleHandlers.get(var15), this.mapSceneSprites, this.geographyArchive, this.groundArchive); // L:
																																													// 129
			}
		}
		...
		for (int var21 = var13.x; var21 < var13.width + var13.x; ++var21) { // L:
																			// 137
			for (int var22 = var13.y; var22 < var13.y + var13.height; ++var22) { // L:
																					// 138
				this.regions[var21][var22].method4694(var5 + (this.regions[var21][var22].regionX * 64 - var19) * var18 / 64, var8 - (this.regions[var21][var22].regionY * 64 - var20 + 64) * var18 / 64, var18); // L:
																																																					// 139
			}
		}
	} // L: 142
	...
	public final void drawElements(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, HashSet var9, HashSet var10, int var11, int var12, boolean var13) {
		WorldMapRectangle var14 = this.createWorldMapRectangle(var1, var2, var3, var4); // L:
																						// 145
		...
		int var19;
		int var20;
		for (var19 = var14.x; var19 < var14.width + var14.x; ++var19) { // L:
																		// 150
			for (var20 = var14.y; var20 < var14.height + var14.y; ++var20) { // L:
																				// 151
				if (var13) { // L: 152
					this.regions[var19][var20].initWorldMapIcon1s(); // L: 153
				}
				this.regions[var19][var20].method4738(var5 + (this.regions[var19][var20].regionX * 64 - var17) * var16 / 64, var8 - (this.regions[var19][var20].regionY * 64 - var18 + 64) * var16 / 64, var16, var9); // L:
				// 155
			}
		}
		if (var10 != null && var11 > 0) { // L: 158
			for (var19 = var14.x; var19 < var14.width + var14.x; ++var19) { // L:
				...
				for (var20 = var14.y; var20 < var14.height + var14.y; ++var20) { // L:
																					// 160
					this.regions[var19][var20].flashElements(var10, var11, var12); // L:
																					// 161
				}
			}
		}
	...
	public void drawOverview(int var1, int var2, int var3, int var4, HashSet var5, int var6, int var7) {
		if (this.compositeTextureSprite != null) { // L: 168
			this.compositeTextureSprite.drawScaledAt(var1, var2, var3, var4); // L:
																				// 171
			if (var6 > 0 && var6 % var7 < var7 / 2) { // L: 172
				...
				while (true) {
					...
					while (var11.hasNext()) { // L: 185
						AbstractWorldMapIcon var12 = (AbstractWorldMapIcon) var11.next(); // L:
																							// 186
						int var13 = var3 * (var12.coord2.x - this.tileX) / this.tileWidth; // L:
																							// 188
						int var14 = var4 - (var12.coord2.y - this.tileY) * var4 / this.tileHeight; // L:
																									// 189
						Rasterizer2D.Rasterizer2D_drawCircleAlpha(var13 + var1, var14 + var2, 2, 16776960, 256); // L:
						// 190
					}
				}
			}
	...
	public List method4819(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
		...
		if (!this.loaded) { // L: 199
			...
			WorldMapRectangle var12 = this.createWorldMapRectangle(var1, var2, var3, var4); // L:
																							// 202
			...
			for (int var17 = var12.x; var17 < var12.width + var12.x; ++var17) { // L:
																				// 207
				for (int var18 = var12.y; var18 < var12.height + var12.y; ++var18) { // L:
																						// 208
					List var19 = this.regions[var17][var18].method4802(var5 + (this.regions[var17][var18].regionX * 64 - var15) * var14 / 64, var8 + var6 - (this.regions[var17][var18].regionY * 64 - var16 + 64) * var14 / 64, var14, var9, var10); // L:
																																																														// 209
	...
	void buildIcons0() {
		...
		for (int var1 = 0; var1 < this.regions.length; ++var1) { // L: 265
			for (int var2 = 0; var2 < this.regions[var1].length; ++var2) { // L:
																			// 266
	...
	float getPixelsPerTile(int var1, int var2) {
		...
		if (var3 > 8.0F) { // L: 290
			...
			return Math.abs((float) var4 - var3) < 0.05F ? (float) var4 : var3; // L:
																				// 293
																				// 294
		}
	}
