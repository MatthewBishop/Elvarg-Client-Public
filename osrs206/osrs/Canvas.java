...
public final class Canvas extends java.awt.Canvas {
		...
		for (var10 = 0; var10 < 4; ++var10) { // L: 117
			for (int var11 = 0; var11 < 64; ++var11) { // L: 118
				for (int var12 = 0; var12 < 64; ++var12) { // L: 119
					if (var10 == var4 && var11 >= var5 && var11 < var5 + 8 && var12 >= var6 && var12 < var6 + 8) { // L:
						// 120
						Players.loadTerrain(var13, var1, var2 + Static.method2763(var11 & 7, var12 & 7, var7), var3 + FloorOverlayDefinition.method3818(var11 & 7, var12 & 7, var7), 0, 0, var7); // L:
						// 121
					} else {
						Players.loadTerrain(var13, 0, -1, -1, 0, 0, 0); // L:
																		// 123
					}
				}
			}
	...
	static void getLoginError(int var0) {
		...
		if (var0 == -3) { // L: 2791
			...
			class101.setLoginResponseString("Your account has not logged out from its last", "session or the server is too busy right now.", "Please try again in a few minutes."); // L:
																																													// 2806
			...
			if (var0 == 7) { // L: 2811
				...
				if (var0 == 56) { // L: 2842
					class101.setLoginResponseString("Enter the 6-digit code generated by your", "authenticator app.", ""); // L:
																															// 2843
					HealthBarUpdate.updateGameState(11); // L: 2844
					return; // L: 2845
				}
				if (var0 == 57) { // L: 2847
					class101.setLoginResponseString("The code you entered was incorrect.", "Please try again.", ""); // L:
					// 2848
					HealthBarUpdate.updateGameState(11); // L: 2849
					return; // L: 2850
				}
				if (var0 == 61) { // L: 2852
					class101.setLoginResponseString("", "Please enter your date of birth (DD/MM/YYYY)", ""); // L:
																												// 2853
					...
					if (var0 == 62) { // L: 2856
						...
						class101.setLoginResponseString("Login attempt timed out.", "Please try again.", ""); // L:
																												// 2859
						return; // L: 2860
					}
					if (var0 == 63) { // L: 2862
						...
						class101.setLoginResponseString("You were signed out.", "Please sign in again.", ""); // L:
																												// 2865
						return; // L: 2866
					}
					if (var0 == 65 || var0 == 67) { // L: 2868
						...
						class101.setLoginResponseString("Failed to login.", "Please try again.", ""); // L:
																										// 2871
						return; // L: 2872
					}
					if (var0 == 71) { // L: 2874
						...
						class101.setLoginResponseString("There was a problem updating your DOB.", "Please try again later. If the problem ", "persists, please contact Jagex Support."); // L:
						// 2877
					} else if (var0 == 73) { // L: 2879
						HealthBarUpdate.updateGameState(10); // L: 2880
						WorldMapData_1.method4872(6); // L: 2881
						class101.setLoginResponseString("Your date of birth information is waiting", "to be reviewed by our staff.", "It will be processed shortly."); // L:
																																										// 2882
					} else if (var0 == 72) { // L: 2884
						HealthBarUpdate.updateGameState(10); // L: 2885
						WorldMapData_1.method4872(26); // L: 2886
					} else {
						class101.setLoginResponseString("Unexpected server response", "Please try using a different world.", ""); // L:
																																	// 2888
					}
				}
			}
		} else {
			class101.setLoginResponseString("RuneScape has been updated!", "Please reload this page.", ""); // L:
																											// 2809
		}
	...
	static final void updatePendingSpawn(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		...
		for (PendingSpawn var10 = (PendingSpawn) Client.pendingSpawns.last(); var10 != null; var10 = (PendingSpawn) Client.pendingSpawns.previous()) { // L:
																																						// 7758
																																						// 7759
																																						// 7764
			if (var0 == var10.plane && var10.x == var1 && var2 == var10.y && var3 == var10.type) { // L:
																									// 7760
				var9 = var10; // L: 7761
				break;
			}
	...
	static final int method319(Widget var0, int var1) {
		if (var0.cs1Instructions != null && var1 < var0.cs1Instructions.length) { // L:
																					// 10788
			try {
				...
				while (true) {
					...
					if (var6 == 4) { // L: 10802
						...
						if (var11 != -1 && (!EnumComposition.ItemDefinition_get(var11).isMembersOnly || Client.isMembersWorld)) { // L:
																																	// 10807
							for (var12 = 0; var12 < var10.itemIds.length; ++var12) { // L:
																						// 10808
								if (var11 + 1 == var10.itemIds[var12]) { // L:
																			// 10809
					...
					if (var6 == 14) { // L: 10843
						...
						var7 = Static.getVarbit(var9); // L: 10845
					}
					if (var6 == 15) { // L: 10847
						var8 = 1;
					}
