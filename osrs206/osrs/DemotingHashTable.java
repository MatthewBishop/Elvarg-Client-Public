...
public final class DemotingHashTable {
	...
	public DemotingHashTable(int var1, int var2) {
		...
		int var3;
		for (var3 = 1; var3 + var3 < var1 && var3 < var2; var3 += var3) { // L:
																			// 21
																			// 22
		}
	...
	public Object get(long var1) {
		...
		if (var3 == null) { // L: 28
			...
			if (var4 == null) { // L: 30
				...
				if (var3.isSoft()) { // L: 36
					DirectWrapper var5 = new DirectWrapper(var4, var3.size); // L:
																				// 37
	...
	public void demote(int var1) {
		for (Wrapper var2 = (Wrapper) this.queue.last(); var2 != null; var2 = (Wrapper) this.queue.previous()) { // L:
			// 90
			if (var2.isSoft()) { // L: 91
				...
				SoftWrapper var3 = new SoftWrapper(var2.get(), var2.size); // L:
																			// 101
				this.hashTable.put(var3, var2.key); // L: 102
				IterableDualNodeQueue.DualNodeDeque_addBefore(var3, var2); // L:
																			// 103
				var2.remove(); // L: 104
