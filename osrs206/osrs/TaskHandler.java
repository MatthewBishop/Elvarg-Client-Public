...
public class TaskHandler implements Runnable {
	...
	public final void run() {
		while (true) {
			...
			try {
				...
				if (var5 == 1) { // L: 65
					var1.result = new Socket(InetAddress.getByName((String) var1.objectArgument), var1.intArgument); // L:
					// 66
				} else if (var5 == 2) { // L: 68
					Thread var3 = new Thread((Runnable) var1.objectArgument); // L:
																				// 69
					...
					var1.result = new DataInputStream(((URL) var1.objectArgument).openStream()); // L:
																									// 76
				}
				var1.status = 1; // L: 78
	...
	public static String method3240(CharSequence var0) {
		String var1 = class229.base37DecodeLong(class339.method6244(var0)); // L:
																			// 57
		if (var1 == null) { // L: 58
			var1 = "";
		}
	...
	public static long calculateTag(int var0, int var1, int var2, boolean var3, int var4) {
		long var5 = (long) ((var0 & 127) << 0 | (var1 & 127) << 7 | (var2 & 3) << 14) | ((long) var4 & 4294967295L) << 17; // L:
																															// 89
		if (var3) { // L: 90
			var5 |= 65536L;
		}
			...
			if (var3 != null) { // L: 11588
				...
				if (var1 == 1 && var3.onSubChange != null) { // L: 11600
					if (var3.childIndex >= 0) { // L: 11601
						...
						if (var6 == null || var6.children == null || var3.childIndex >= var6.children.length || var3 != var6.children[var3.childIndex]) { // L:
																																							// 11603
							continue;
						}
					}
