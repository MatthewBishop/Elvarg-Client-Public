...
public class UserComparator3 extends AbstractUserComparator {
	...
	int compareBuddy(Buddy var1, Buddy var2) {
		if (var2.world != var1.world) { // L: 14
			return this.reversed ? var1.world - var2.world : var2.world - var1.world; // L:
																						// 15
		} else {
			...
			try {
				...
				if (var4 != 0 && var4 != 1 && var4 != 2) { // L: 145
					if (var4 == 3 || var4 == 4) { // L: 155
						...
						String var20 = var0.readStringCp1252NullTerminated(); // L:
																				// 161
						byte[][] var10 = new byte[var7][]; // L: 162
						int var12;
						if (var4 == 3) { // L: 163
							for (int var11 = 0; var11 < var7; ++var11) { // L:
																			// 164
								var12 = var0.readInt(); // L: 165
								var10[var11] = new byte[var12]; // L: 166
								var0.readBytes(var10[var11], 0, var12); // L:
																		// 167
							}
						}
						...
						Class var22 = WorldMapRectangle.loadClassFromDescriptor(var20); // L:
																						// 173
						if (WorldMapRectangle.loadClassFromDescriptor(var5).getClassLoader() == null) { // L:
																										// 174
							throw new SecurityException();
						}
						Method[] var13 = WorldMapRectangle.loadClassFromDescriptor(var5).getDeclaredMethods(); // L:
																												// 175
						Method[] var14 = var13; // L: 177
						for (int var15 = 0; var15 < var14.length; ++var15) { // L:
																				// 178
							Method var16 = var14[var15]; // L: 179
/*							if (Reflection.getMethodName(var16).equals(var6)) { // L:
																				// 181
								Class[] var17 = Reflection.getParameterTypes(var16); // L:
																						// 182
								if (var17.length == var21.length) { // L: 183
									boolean var18 = true; // L: 184
									for (int var19 = 0; var19 < var21.length; ++var19) { // L:
																							// 185
										if (var21[var19] != var17[var19]) { // L:
																			// 186
											var18 = false; // L: 187
											break; // L: 188
										}
									}
									if (var18 && var22 == var16.getReturnType()) { // L:
																					// 191
				...
				//	var2.fields[var3] = Reflection.findField(WorldMapRectangle.loadClassFromDescriptor(var5), var6); // L:
					// 153
				}
	...
	static int method2592(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.APPEND_NUM) { // L: 3277
			var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize]; // L:
																									// 3278
			var9 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]; // L:
																							// 3279
			Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = var3 + var9; // L:
																												// 3280
			return 1; // L: 3281
		} else {
			String var4;
			if (var0 == ScriptOpcodes.APPEND) { // L: 3283
				...
				var3 = Interpreter.Interpreter_stringStack[Interpreter.Interpreter_stringStackSize]; // L:
																										// 3285
				var4 = Interpreter.Interpreter_stringStack[Interpreter.Interpreter_stringStackSize + 1]; // L:
																											// 3286
				Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = var3 + var4; // L:
				// 3287
				return 1; // L: 3288
				...
				var9 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]; // L:
																								// 3292
				Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = var3 + Tile.intToString(var9, true); // L:
																																			// 3293
				return 1; // L: 3294
			} else if (var0 == ScriptOpcodes.LOWERCASE) { // L: 3296
				var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize]; // L:
																										// 3297
				Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = var3.toLowerCase(); // L:
				// 3298
				return 1; // L: 3299
			} else {
				int var6;
				...
				if (var0 == ScriptOpcodes.FROMDATE) { // L: 3301
					...
					Interpreter.Interpreter_calendar.setTime(new Date(var13)); // L:
																				// 3304
					var6 = Interpreter.Interpreter_calendar.get(5); // L: 3305
					int var17 = Interpreter.Interpreter_calendar.get(2); // L:
																			// 3306
					int var8 = Interpreter.Interpreter_calendar.get(1); // L:
																		// 3307
					Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = var6 + "-" + Interpreter.Interpreter_MONTHS[var17] + "-" + var8; // L:
																																											// 3308
					return 1; // L: 3309
					...
					if (var0 == ScriptOpcodes.TOSTRING) { // L: 3319
						var10 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]; // L:
																										// 3320
						Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = Integer.toString(var10); // L:
																																		// 3321
						return 1; // L: 3322
					} else if (var0 == ScriptOpcodes.COMPARE) { // L: 3324
						Interpreter.Interpreter_stringStackSize -= 2; // L: 3325
						Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = Tile.method4019(WorldMapSection0.compareStrings(Interpreter.Interpreter_stringStack[Interpreter.Interpreter_stringStackSize], Interpreter.Interpreter_stringStack[Interpreter.Interpreter_stringStackSize + 1], class134.clientLanguage)); // L:
																																																																																				// 3326
						return 1; // L: 3327
					} else {
						int var5;
						...
						if (var0 == ScriptOpcodes.PARAHEIGHT) { // L: 3329
							...
							var9 = Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize]; // L:
																										// 3332
							var5 = Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize + 1]; // L:
																											// 3333
							var11 = AbstractByteArrayCopier.archive13.takeFile(var5, 0); // L:
																							// 3334
							var12 = new Font(var11); // L: 3335
							Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = var12.lineCount(var3, var9); // L:
																																		// 3336
							return 1; // L: 3337
							...
							Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = var12.lineWidth(var3, var9); // L:
																																		// 3346
							return 1; // L: 3347
						} else if (var0 == ScriptOpcodes.TEXT_SWITCH) { // L:
																		// 3349
							...
							if (Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize] == 1) { // L:
								...
								Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = var4; // L:
																															// 3354
							}
							return 1; // L: 3355
							...
							var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize]; // L:
							// 3358
							Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = AbstractFont.escapeBrackets(var3); // L:
																																					// 3359
							return 1; // L: 3360
						} else if (var0 == ScriptOpcodes.APPEND_CHAR) { // L:
																		// 3362
							var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize]; // L:
							// 3363
							var9 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]; // L:
																											// 3364
							Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = var3 + (char) var9; // L:
																																		// 3365
							return 1; // L: 3366
						} else if (var0 == ScriptOpcodes.CHAR_ISPRINTABLE) { // L:
																				// 3368
							var10 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]; // L:
																											// 3369
							Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = StudioGame.isCharPrintable((char) var10) ? 1 : 0; // L:
																																							// 3370
							return 1; // L: 3371
						} else if (var0 == ScriptOpcodes.CHAR_ISALPHANUMERIC) { // L:
																				// 3373
							var10 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]; // L:
																											// 3374
							Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = FloorOverlayDefinition.isAlphaNumeric((char) var10) ? 1 : 0; // L:
																																										// 3375
							return 1; // L: 3376
						} else if (var0 == ScriptOpcodes.CHAR_ISALPHA) { // L:
																			// 3378
							var10 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]; // L:
																											// 3379
							Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = WorldMapDecorationType.isCharAlphabetic((char) var10) ? 1 : 0; // L:
																																										// 3380
							return 1; // L: 3381
						} else if (var0 == ScriptOpcodes.CHAR_ISNUMERIC) { // L:
																			// 3383
							var10 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]; // L:
																											// 3384
							Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = class83.isDigit((char) var10) ? 1 : 0; // L:
																																				// 3385
							return 1; // L: 3386
						} else if (var0 == ScriptOpcodes.STRING_LENGTH) { // L:
																			// 3388
							var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize]; // L:
							// 3389
							if (var3 != null) { // L: 3390
							...
							var5 = Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize + 1]; // L:
																											// 3398
							Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = var3.substring(var9, var5); // L:
																																				// 3399
							return 1; // L: 3400
						} else if (var0 == ScriptOpcodes.REMOVETAGS) { // L:
																		// 3402
							var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize]; // L:
							// 3403
							StringBuilder var15 = new StringBuilder(var3.length()); // L:
																					// 3404
							boolean var16 = false; // L: 3405
							for (var6 = 0; var6 < var3.length(); ++var6) { // L:
																			// 3406
							...
							Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = var15.toString(); // L:
																																	// 3412
							return 1; // L: 3413
						} else if (var0 == ScriptOpcodes.STRING_INDEXOF_CHAR) { // L:
																				// 3415
							var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize]; // L:
							// 3416
							var9 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]; // L:
																											// 3417
							Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = var3.indexOf(var9); // L:
																															// 3418
							return 1; // L: 3419
						} else if (var0 == ScriptOpcodes.STRING_INDEXOF_STRING) { // L:
																					// 3421
							Interpreter.Interpreter_stringStackSize -= 2; // L:
																			// 3422
							var3 = Interpreter.Interpreter_stringStack[Interpreter.Interpreter_stringStackSize]; // L:
							...
							var5 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]; // L:
																											// 3425
							Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = var3.indexOf(var4, var5); // L:
																																	// 3426
							return 1; // L: 3427
						} else if (var0 == 4122) { // L: 3429
							var3 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize]; // L:
							// 3430
							Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = var3.toUpperCase(); // L:
																																		// 3431
							return 1; // L: 3432
						} else {
							return 2; // L: 3434
					...
					var4 = Interpreter.Interpreter_stringStack[Interpreter.Interpreter_stringStackSize + 1]; // L:
																												// 3314
					if (class101.localPlayer.appearance != null && class101.localPlayer.appearance.isFemale) { // L:
						// 3315
						Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = var4;
					} else {
						Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = var3; // L:
						// 3316
					}
					return 1; // L: 3317
				}
