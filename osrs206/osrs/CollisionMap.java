...
public class CollisionMap {
	...
	public void clear() {
		for (int var1 = 0; var1 < this.xSize; ++var1) { // L: 53
			for (int var2 = 0; var2 < this.ySize; ++var2) { // L: 54
				if (var1 != 0 && var2 != 0 && var1 < this.xSize - 5 && var2 < this.ySize - 5) { // L:
																								// 55
	...
	static final void method3907() {
		for (GraphicsObject var0 = (GraphicsObject) Client.graphicsObjects.last(); var0 != null; var0 = (GraphicsObject) Client.graphicsObjects.previous()) { // L:
																																								// 4873
																																								// 4874
																																								// 4881
			if (var0.plane == PacketWriter.Client_plane && !var0.isFinished) { // L:
																				// 4875
				if (Client.cycle >= var0.cycleStart) { // L: 4876
					...
					if (var0.isFinished) { // L: 4878
						...
						class356.scene.drawEntity(var0.plane, var0.x, var0.y, var0.z, 60, var0, 0, -1L, false); // L:
						// 4879
					}
				}
			} else {
