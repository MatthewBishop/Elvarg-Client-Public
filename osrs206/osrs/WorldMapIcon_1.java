...
public class WorldMapIcon_1 extends AbstractWorldMapIcon {
	...
	public static final boolean method4592(int var0, int var1, RouteStrategy var2, CollisionMap var3) {
		...
		while (var11 != var18) { // L: 32
			...
			if (var16 > 0 && class193.directions[var16 - 1][var17] == 0 && (var12[var13 - 1][var14] & 19136782) == 0 && (var12[var13 - 1][var14 + 1] & 19136824) == 0) { // L:
																																											// 46
																																											// 47
																																											// 48
																																											// 49
			...
			if (var16 < 126 && class193.directions[var16 + 1][var17] == 0 && (var12[var13 + 2][var14] & 19136899) == 0 && (var12[var13 + 2][var14 + 1] & 19136992) == 0) { // L:
																																											// 56
																																											// 57
																																											// 58
																																											// 59
			...
			if (var17 > 0 && class193.directions[var16][var17 - 1] == 0 && (var12[var13][var14 - 1] & 19136782) == 0 && (var12[var13 + 1][var14 - 1] & 19136899) == 0) { // L:
																																											// 66
																																											// 67
																																											// 68
																																											// 69
			...
			if (var17 < 126 && class193.directions[var16][var17 + 1] == 0 && (var12[var13][var14 + 2] & 19136824) == 0 && (var12[var13 + 1][var14 + 2] & 19136992) == 0) { // L:
																																											// 76
																																											// 77
																																											// 78
																																											// 79
			...
			if (var16 > 0 && var17 > 0 && class193.directions[var16 - 1][var17 - 1] == 0 && (var12[var13 - 1][var14] & 19136830) == 0 && (var12[var13 - 1][var14 - 1] & 19136782) == 0 && (var12[var13][var14 - 1] & 19136911) == 0) { // L:
																																																										// 86
																																																										// 87
																																																										// 88
																																																										// 89
			...
			if (var16 < 126 && var17 > 0 && class193.directions[var16 + 1][var17 - 1] == 0 && (var12[var13 + 1][var14 - 1] & 19136911) == 0 && (var12[var13 + 2][var14 - 1] & 19136899) == 0 && (var12[var13 + 2][var14] & 19136995) == 0) { // L:
																																																												// 97
																																																												// 98
																																																												// 99
																																																												// 100
			...
			if (var16 > 0 && var17 < 126 && class193.directions[var16 - 1][var17 + 1] == 0 && (var12[var13 - 1][var14 + 1] & 19136830) == 0 && (var12[var13 - 1][var14 + 2] & 19136824) == 0 && (var12[var13][var14 + 2] & 19137016) == 0) { // L:
																																																												// 108
																																																												// 109
																																																												// 110
																																																												// 111
			...
			if (var16 < 126 && var17 < 126 && class193.directions[var16 + 1][var17 + 1] == 0 && (var12[var13 + 1][var14 + 2] & 19137016) == 0 && (var12[var13 + 2][var14 + 2] & 19136992) == 0 && (var12[var13 + 2][var14 + 1] & 19136995) == 0) { // L:
																																																													// 119
																																																													// 120
																																																													// 121
																																																													// 122
	...
	public static StructComposition StructDefinition_getStructDefinition(int var0) {
		StructComposition var1 = (StructComposition) StructComposition.StructDefinition_cached.get((long) var0); // L:
		// 23
		if (var1 != null) { // L: 24
			return var1;
		} else {
			byte[] var2 = StructComposition.StructDefinition_archive.takeFile(34, var0); // L:
																							// 25
			...
			StructComposition.StructDefinition_cached.put(var1, (long) var0); // L:
																				// 29
			return var1; // L: 30
		}
	}
	
	public static final int method4594(int var0, int var1) {
		int var2 = var1 * 57 + var0; // L: 912
		var2 ^= var2 << 13; // L: 913
		int var3 = var2 * (var2 * var2 * 15731 + 789221) + 1376312589 & Integer.MAX_VALUE; // L:
																							// 914
	...
	static void method4590(Buffer var0, int var1) {
		...
		class350.writeRandomDat(var2, var1, Client.randomDatData, 0, 24); // L:
																			// 12396
		if (JagexCache.JagexCache_randomDat != null) { // L: 12399
			try {
				JagexCache.JagexCache_randomDat.seek(0L); // L: 12401
				JagexCache.JagexCache_randomDat.write(var0.array, var1, 24); // L:
																				// 12402
