	...
	static void method2065() {
		synchronized (ArchiveDiskActionHandler.ArchiveDiskActionHandler_lock) { // L:
			...
			if (ArchiveDiskActionHandler.field3971 == 0) { // L: 61
				ArchiveDiskActionHandler.ArchiveDiskActionHandler_thread = new Thread(new ArchiveDiskActionHandler()); // L:
				// 62
				ArchiveDiskActionHandler.ArchiveDiskActionHandler_thread.setDaemon(true); // L:
																							// 63
				ArchiveDiskActionHandler.ArchiveDiskActionHandler_thread.start(); // L:
																					// 64
				ArchiveDiskActionHandler.ArchiveDiskActionHandler_thread.setPriority(5); // L:
																							// 65
			}
	...
	static final void method2007(byte[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, Scene var8, CollisionMap[] var9) {
		...
		while (true) {
			...
			while (true) {
				...
				if (var17 == var4 && var16 >= var5 && var16 < var5 + 8 && var15 >= var6 && var15 < var6 + 8) { // L:
																												// 277
					ObjectComposition var21 = class162.getObjectDefinition(var11); // L:
																					// 278
					int var22 = var2 + FloorOverlayDefinition.method3810(var16 & 7, var15 & 7, var7, var21.sizeX, var21.sizeY, var20); // L:
																																		// 279
					int var23 = var3 + class141.method3044(var16 & 7, var15 & 7, var7, var21.sizeX, var21.sizeY, var20); // L:
					// 280
					if (var22 > 0 && var23 > 0 && var22 < 103 && var23 < 103) { // L:
																				// 281
						int var24 = var1; // L: 282
						if ((Tiles_renderFlags[1][var22][var23] & 2) == 2) { // L:
																				// 283
							var24 = var1 - 1;
						}
						...
						class268.addObjects(var1, var22, var23, var11, var20 + var7 & 3, var19, var8, var25); // L:
																												// 286
					}
				}
			}
