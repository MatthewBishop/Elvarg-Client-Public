...
public class class306 {
	...
	static final void method5765(Player var0, int var1, int var2, class192 var3) {
		...
		if (var4 >= var6 && var4 < 104 - var6 && var5 >= var6 && var5 < 104 - var6) { // L:
																						// 8217
			if (var1 >= var6 && var1 < 104 - var6 && var2 >= var6 && var2 < 104 - var6) { // L:
																							// 8218
				int var8 = var0.transformedSize(); // L: 8220
				RouteStrategy var9 = VerticalAlignment.method3533(var1, var2); // L:
																				// 8221
				CollisionMap var10 = Client.collisionMaps[var0.plane]; // L:
																		// 8222
				...
				if (var8 == 1) { // L: 8233
					...
					while (true) {
						...
						if (var9.hasArrived(1, var15, var16, var10)) { // L:
																		// 8259
						...
						if (var35 > 0 && class193.directions[var35 - 1][var36] == 0 && (var23[var24 - 1][var25] & 19136776) == 0) { // L:
																																	// 8266
							class193.bufferX[var38] = var15 - 1; // L: 8267
							class193.bufferY[var38] = var16; // L: 8268
							var38 = var38 + 1 & 4095; // L: 8269
							class193.directions[var35 - 1][var36] = 2; // L:
																		// 8270
							class193.distances[var35 - 1][var36] = var26; // L:
																			// 8271
						}
						if (var35 < 127 && class193.directions[var35 + 1][var36] == 0 && (var23[var24 + 1][var25] & 19136896) == 0) { // L:
																																		// 8273
							class193.bufferX[var38] = var15 + 1; // L: 8274
							class193.bufferY[var38] = var16; // L: 8275
							var38 = var38 + 1 & 4095; // L: 8276
							class193.directions[var35 + 1][var36] = 8; // L:
																		// 8277
							class193.distances[var35 + 1][var36] = var26; // L:
																			// 8278
						}
						if (var36 > 0 && class193.directions[var35][var36 - 1] == 0 && (var23[var24][var25 - 1] & 19136770) == 0) { // L:
																																	// 8280
							class193.bufferX[var38] = var15; // L: 8281
							class193.bufferY[var38] = var16 - 1; // L: 8282
							var38 = var38 + 1 & 4095; // L: 8283
							class193.directions[var35][var36 - 1] = 1; // L:
																		// 8284
							class193.distances[var35][var36 - 1] = var26; // L:
																			// 8285
						}
						if (var36 < 127 && class193.directions[var35][var36 + 1] == 0 && (var23[var24][var25 + 1] & 19136800) == 0) { // L:
																																		// 8287
							class193.bufferX[var38] = var15; // L: 8288
							class193.bufferY[var38] = var16 + 1; // L: 8289
							var38 = var38 + 1 & 4095; // L: 8290
							class193.directions[var35][var36 + 1] = 4; // L:
																		// 8291
							class193.distances[var35][var36 + 1] = var26; // L:
																			// 8292
						}
						if (var35 > 0 && var36 > 0 && class193.directions[var35 - 1][var36 - 1] == 0 && (var23[var24 - 1][var25 - 1] & 19136782) == 0 && (var23[var24 - 1][var25] & 19136776) == 0 && (var23[var24][var25 - 1] & 19136770) == 0) { // L:
																																																													// 8294
							class193.bufferX[var38] = var15 - 1; // L: 8295
							class193.bufferY[var38] = var16 - 1; // L: 8296
							var38 = var38 + 1 & 4095; // L: 8297
							class193.directions[var35 - 1][var36 - 1] = 3; // L:
																			// 8298
							class193.distances[var35 - 1][var36 - 1] = var26; // L:
																				// 8299
						}
						if (var35 < 127 && var36 > 0 && class193.directions[var35 + 1][var36 - 1] == 0 && (var23[var24 + 1][var25 - 1] & 19136899) == 0 && (var23[var24 + 1][var25] & 19136896) == 0 && (var23[var24][var25 - 1] & 19136770) == 0) { // L:
																																																														// 8301
							class193.bufferX[var38] = var15 + 1; // L: 8302
							class193.bufferY[var38] = var16 - 1; // L: 8303
							var38 = var38 + 1 & 4095; // L: 8304
							class193.directions[var35 + 1][var36 - 1] = 9; // L:
																			// 8305
							class193.distances[var35 + 1][var36 - 1] = var26; // L:
																				// 8306
						}
						if (var35 > 0 && var36 < 127 && class193.directions[var35 - 1][var36 + 1] == 0 && (var23[var24 - 1][var25 + 1] & 19136824) == 0 && (var23[var24 - 1][var25] & 19136776) == 0 && (var23[var24][var25 + 1] & 19136800) == 0) { // L:
																																																														// 8308
							class193.bufferX[var38] = var15 - 1; // L: 8309
							class193.bufferY[var38] = var16 + 1; // L: 8310
							var38 = var38 + 1 & 4095; // L: 8311
							class193.directions[var35 - 1][var36 + 1] = 6; // L:
																			// 8312
							class193.distances[var35 - 1][var36 + 1] = var26; // L:
																				// 8313
						}
						if (var35 < 127 && var36 < 127 && class193.directions[var35 + 1][var36 + 1] == 0 && (var23[var24 + 1][var25 + 1] & 19136992) == 0 && (var23[var24 + 1][var25] & 19136896) == 0 && (var23[var24][var25 + 1] & 19136800) == 0) { // L:
																																																														// 8315
							class193.bufferX[var38] = var15 + 1; // L: 8316
							class193.bufferY[var38] = var16 + 1; // L: 8317
							var38 = var38 + 1 & 4095; // L: 8318
							class193.directions[var35 + 1][var36 + 1] = 12; // L:
																			// 8319
							class193.distances[var35 + 1][var36 + 1] = var26; // L:
																				// 8320
						}
					...
					var33 = class127.method2844(var4, var5, var8, var9, var10); // L:
																				// 8330
				}
				int var7;
				label346 : {
					...
					if (!var33) { // L: 8335
						...
						for (var25 = var38 - var37; var25 <= var37 + var38; ++var25) { // L:
																						// 8344
							for (var26 = var22 - var37; var26 <= var22 + var37; ++var26) { // L:
																							// 8345
								int var27 = var25 - var14; // L: 8346
								int var28 = var26 - var15; // L: 8347
								if (var27 >= 0 && var28 >= 0 && var27 < 128 && var28 < 128 && class193.distances[var27][var28] < 100) { // L:
																																		// 8348
																																		// 8349
									int var29 = 0; // L: 8350
									if (var25 < var38) { // L: 8351
										var29 = var38 - var25;
									} else if (var25 > var32 + var38 - 1) { // L:
																			// 8352
									...
									if (var26 < var22) { // L: 8354
										var30 = var22 - var26;
									} else if (var26 > var24 + var22 - 1) { // L:
																			// 8355
										var30 = var26 - (var22 + var24 - 1);
									}
									int var31 = var30 * var30 + var29 * var29; // L:
																				// 8356
									if (var31 < var36 || var36 == var31 && class193.distances[var27][var28] < var19) { // L:
										// 8357
										var36 = var31; // L: 8358
										var19 = class193.distances[var27][var28]; // L:
																					// 8359
										var16 = var25; // L: 8360
										var35 = var26; // L: 8361
									}
					...
					if (var16 == var4 && var5 == var35) { // L: 8377
						...
						for (var19 = var20 = class193.directions[var16 - var14][var35 - var15]; var4 != var16 || var35 != var5; var19 = class193.directions[var16 - var14][var35 - var15]) { // L:
							// 8388
							// 8389
							// 8399
	...
	static final void changeGameOptions(int var0) {
		...
		ObjectSound.update();
		int var3 = FloorUnderlayDefinition.VarpDefinition_get(var0).type; // L:
																			// 11872
		if (var3 != 0) { // L: 11873
			...
			if (var3 == 1) { // L: 11875
				if (var2 == 1) { // L: 11876
					...
					((TextureProvider) Rasterizer3D.Rasterizer3D_textureLoader).setBrightness(0.9D); // L:
																										// 11878
				...
				if (var2 == 2) { // L: 11882
					...
					((TextureProvider) Rasterizer3D.Rasterizer3D_textureLoader).setBrightness(0.8D); // L:
																										// 11884
				...
				if (var2 == 3) { // L: 11888
					...
					((TextureProvider) Rasterizer3D.Rasterizer3D_textureLoader).setBrightness(0.7D); // L:
																										// 11890
				...
				if (var2 == 4) { // L: 11894
					...
					((TextureProvider) Rasterizer3D.Rasterizer3D_textureLoader).setBrightness(0.6D); // L:
																										// 11896
			...
			if (var3 == 18) { // L: 11928
				Client.playerAttackOption = (AttackOption) Actor.findEnumerated(class7.method52(), var2); // L:
																											// 11929
			...
			if (var3 == 22) { // L: 11936
				Client.npcAttackOption = (AttackOption) Actor.findEnumerated(class7.method52(), var2); // L:
																										// 11937
