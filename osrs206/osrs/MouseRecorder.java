		...
		for (; this.isRunning; DynamicObject.method1991(50L)) { // L: 18 27
			synchronized (this.lock) { // L: 19
				if (this.index < 500) { // L: 20
					...
					this.millis[this.index] = MouseHandler.MouseHandler_millis; // L:
																				// 23
					++this.index; // L: 24
				}
			}
				...
				do {
					...
					for (var10 = 0; var10 < 4; ++var10) { // L: 92
						if (var3[var10] == 2) { // L: 95
							...
							var11 = var0[var6].isMembersOnly() ? 1 : 0; // L:
																		// 106
						...
						if (var12 != var11) { // L: 113
							if ((var4[var10] != 1 || var11 <= var12) && (var4[var10] != 0 || var11 >= var12)) { // L:
								// 116
								// 117
								var9 = false; // L: 119
							}
				...
				do {
					...
					for (var10 = 0; var10 < 4; ++var10) { // L: 127
						if (var3[var10] == 2) { // L: 130
							...
							var11 = var0[var5].isMembersOnly() ? 1 : 0; // L:
																		// 141
