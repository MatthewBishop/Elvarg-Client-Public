...
public class class266 {
	...
	static SpritePixels[] method5212() {
		SpritePixels[] var0 = new SpritePixels[class456.SpriteBuffer_spriteCount]; // L:
																					// 157
		for (int var1 = 0; var1 < class456.SpriteBuffer_spriteCount; ++var1) { // L:
																				// 158
			...
			var2.subHeight = class456.SpriteBuffer_spriteHeights[var1]; // L:
																		// 165
