...
public final class BZip2Decompressor {
	...
	static void BZip2Decompressor_decompress(BZip2State var0) {
		...
		while (true) {
			while (var26) {
				...
				var0.originalPointer = var0.originalPointer << 8 | var1 & 255; // L:
																				// 193
				...
				for (var36 = 0; var36 < 16; ++var36) { // L: 204
					if (var0.inUse16[var36]) { // L: 205
						for (var37 = 0; var37 < 16; ++var37) { // L: 206
							var1 = BZip2Decompressor_readNextBit(var0); // L:
																		// 207
							if (var1 == 1) { // L: 208
				...
				byte var29;
				for (var29 = 0; var29 < var40; var27[var29] = var29++) { // L:
																			// 229
				}
				for (var36 = 0; var36 < var41; ++var36) { // L: 230
					var29 = var0.selectorMtf[var36]; // L: 231
					byte var28;
					for (var28 = var27[var29]; var29 > 0; --var29) { // L: 232
																		// 233
																		// 235
					...
					for (var36 = 0; var36 < var39; ++var36) { // L: 243
						while (true) {
							var1 = BZip2Decompressor_readNextBit(var0); // L:
																		// 245
							if (var1 == 0) { // L: 246
								var0.temp_charArray2d[var38][var36] = (byte) var50; // L:
																					// 251
								break;
							}
							var1 = BZip2Decompressor_readNextBit(var0); // L:
				...
				for (var38 = 0; var38 < var40; ++var38) { // L: 254
					...
					for (var36 = 0; var36 < var39; ++var36) { // L: 257
						if (var0.temp_charArray2d[var38][var36] > var3) { // L:
																			// 258
							var3 = var0.temp_charArray2d[var38][var36];
						}
						if (var0.temp_charArray2d[var38][var36] < var2) { // L:
																			// 259
							var2 = var0.temp_charArray2d[var38][var36];
						}
					}
					BZip2Decompressor_createHuffmanTables(var0.limit[var38], var0.base[var38], var0.perm[var38], var0.temp_charArray2d[var38], var2, var3, var39); // L:
																																									// 261
				...
				for (var35 = 15; var35 >= 0; --var35) { // L: 273
					...
					var0.getAndMoveToFrontDecode_yy[var35] = var56 + 1; // L:
																		// 278
				}
				int var47 = 0; // L: 281
				byte var54;
				...
				int var52;
				byte var53;
				for (var52 = BZip2Decompressor_readBits(var22, var0); var52 > var23[var51]; var52 = var52 << 1 | var53) { // L:
																															// 293
																															// 295
																															// 298
					++var51; // L: 296
				...
				while (true) {
					...
					while (var46 != var42) { // L: 302
						if (var46 != 0 && var46 != 1) { // L: 303
							...
							int var30;
							if (var33 < 16) { // L: 350
								var30 = var0.getAndMoveToFrontDecode_yy[0]; // L:
																			// 351
								for (var1 = var0.ll8[var30 + var33]; var33 > 3; var33 -= 4) { // L:
																								// 352
																								// 353
																								// 359
									int var34 = var30 + var33; // L: 354
									var0.ll8[var34] = var0.ll8[var34 - 1]; // L:
																			// 355
									var0.ll8[var34 - 1] = var0.ll8[var34 - 2]; // L:
																				// 356
									var0.ll8[var34 - 2] = var0.ll8[var34 - 3]; // L:
																				// 357
									var0.ll8[var34 - 3] = var0.ll8[var34 - 4]; // L:
																				// 358
								}
								while (var33 > 0) { // L: 361
									var0.ll8[var30 + var33] = var0.ll8[var30 + var33 - 1]; // L:
																							// 362
									--var33; // L: 363
								}
								...
								var30 = var0.getAndMoveToFrontDecode_yy[var31] + var32; // L:
																						// 370
								for (var1 = var0.ll8[var30]; var30 > var0.getAndMoveToFrontDecode_yy[var31]; --var30) { // L:
									// 371
									// 372
									// 374
									var0.ll8[var30] = var0.ll8[var30 - 1]; // L:
																			// 373
								}
								for (var10002 = var0.getAndMoveToFrontDecode_yy[var31]++; var31 > 0; --var31) { // L:
									// 376
									// 377
									// 380
									var10002 = var0.getAndMoveToFrontDecode_yy[var31]--; // L:
																							// 378
									var0.ll8[var0.getAndMoveToFrontDecode_yy[var31]] = var0.ll8[var0.getAndMoveToFrontDecode_yy[var31 - 1] + 16 - 1]; // L:
																																						// 379
								}
								var10002 = var0.getAndMoveToFrontDecode_yy[0]--; // L:
																					// 382
								var0.ll8[var0.getAndMoveToFrontDecode_yy[0]] = var1; // L:
																						// 383
								if (var0.getAndMoveToFrontDecode_yy[0] == 0) { // L:
																				// 384
									var56 = 4095; // L: 385
									for (var35 = 15; var35 >= 0; --var35) { // L:
																			// 386
										for (var55 = 15; var55 >= 0; --var55) { // L:
																				// 387
											var0.ll8[var56] = var0.ll8[var0.getAndMoveToFrontDecode_yy[var35] + var55]; // L:
											// 388
											--var56; // L: 389
										}
										var0.getAndMoveToFrontDecode_yy[var35] = var56 + 1; // L:
							...
							var10002 = var0.unzftab[var0.seqToUnseq[var1 & 255] & 255]++; // L:
																							// 396
							class136.BZip2Decompressor_block[var47] = var0.seqToUnseq[var1 & 255] & 255; // L:
																											// 397
							++var47; // L: 398
							if (var45 == 0) { // L: 399
								++var43; // L: 400
							...
							for (var52 = BZip2Decompressor_readBits(var22, var0); var52 > var23[var51]; var52 = var52 << 1 | var53) { // L:
																																		...
																																		// 415
								++var51; // L: 413
								var53 = BZip2Decompressor_readNextBit(var0); // L:
																				// 414
							}
							...
							++var48; // L: 330
							var1 = var0.seqToUnseq[var0.ll8[var0.getAndMoveToFrontDecode_yy[0]] & 255]; // L:
																										// 331
							var10000 = var0.unzftab; // L: 332
							for (var10000[var1 & 255] += var48; var48 > 0; --var48) { // L:
																						// 333
																						// 336
								class136.BZip2Decompressor_block[var47] = var1 & 255; // L:
																						// 334
								++var47; // L: 335
							}
						}
					...
					for (var36 = 0; var36 < var47; ++var36) { // L: 426
						var1 = (byte) (class136.BZip2Decompressor_block[var36] & 255); // L:
																						// 427
					...
					var0.field4722 = class136.BZip2Decompressor_block[var0.originalPointer] >> 8; // L:
																									// 431
					var0.nblocks_used = 0; // L: 432
					var0.field4722 = class136.BZip2Decompressor_block[var0.field4722]; // L:
																						// 433
					...
					if (var0.field4734 + 1 == var0.nblocks_used && var0.su_rNToGo == 0) { // L:
																							// 440
						var26 = true;
						break;
					}
	...
	static int BZip2Decompressor_readBits(int var0, BZip2State var1) {
		while (var1.bsLive < var0) { // L: 456
			var1.bsBuff = var1.bsBuff << 8 | var1.inputArray[var1.nextByte] & 255; // L:
																					// 462
			var1.bsLive += 8; // L: 463
			++var1.nextByte; // L: 464
		...
		int var2 = var1.bsBuff >> var1.bsLive - var0 & (1 << var0) - 1; // L:
																		// 458
