...
public class class347 extends AbstractQueue {
	...
	void method6341() {
		...
		this.field4166 = (class345[]) ((class345[]) Arrays.copyOf(this.field4166, var1)); // L:
																							// 24
	} // L: 25
	...
	void method6342(int var1) {
		class345 var2;
		int var3;
		for (var2 = this.field4166[var1]; var1 > 0; var1 = var3) { // L: 96 97
																	// 108
			var3 = var1 - 1 >>> 1; // L: 98
			class345 var4 = this.field4166[var3]; // L: 99
			if (this.field4168 != null) { // L: 100
				if (this.field4168.compare(var2.field4159, var4.field4159) >= 0) { // L:
																					// 101
					break;
				}
			} else if (((Comparable) var2.field4159).compareTo(var4.field4159) >= 0) { // L:
																						// 104
				break;
			}
	...
	void method6354(int var1) {
		...
		int var8;
		for (int var3 = this.field4165 >>> 1; var1 < var3; var1 = var8) { // L:
																			// 117
																			// 118
																			// 140
			...
			if (this.field4168 != null) { // L: 124
				if (var6 < this.field4165 && this.field4168.compare(var5.field4159, var7.field4159) > 0) { // L:
																											// 125
					var8 = var6;
				} else {
					var8 = var4; // L: 126
				}
			} else if (var6 < this.field4165 && ((Comparable) var5.field4159).compareTo(var7.field4159) > 0) { // L:
																												// 129
				var8 = var6;
			} else {
				var8 = var4; // L: 130
			...
			if (this.field4168 != null) { // L: 132
				if (this.field4168.compare(var2.field4159, this.field4166[var8].field4159) <= 0) { // L:
																									// 133
					break;
				}
			} else if (((Comparable) var2.field4159).compareTo(this.field4166[var8].field4159) <= 0) { // L:
																										// 136
				break;
			}
	...
	public boolean remove(Object var1) {
		...
		if (var2 == null) { // L: 78
			...
			if (var2.field4158 == this.field4165) { // L: 81
				...
				this.field4166[var2.field4158].field4158 = var2.field4158; // L:
																			// 88
	...
	public Object peek() {
		return this.field4165 == 0 ? null : this.field4166[0].field4159; // L:
																			// 54
																			// 55
	}
	public int size() {
