...
public class class11 implements TlsAuthentication {
	...
	public void notifyServerCertificate(Certificate var1) throws IOException {
		try {
			CertificateFactory var2 = CertificateFactory.getInstance("X.509"); // L:
																				// 310
			LinkedList var3 = new LinkedList(); // L: 311
			org.bouncycastle.asn1.x509.Certificate[] var4 = var1.getCertificateList(); // L:
																						// 313
			for (int var5 = 0; var5 < var4.length; ++var5) { // L: 314
				org.bouncycastle.asn1.x509.Certificate var6 = var4[var5]; // L:
																			// 315
				var3.add(var2.generateCertificate(new ByteArrayInputStream(var6.getEncoded()))); // L:
																									// 317
			}
			this.this$2.this$1.field63 = (java.security.cert.Certificate[]) ((java.security.cert.Certificate[]) var3.toArray(new java.security.cert.Certificate[0])); // L:
																																										// 321
	...
	static final void method98(int var0, int var1, int var2, int var3) {
		for (int var4 = var1; var4 <= var3 + var1; ++var4) { // L: 79
			for (int var5 = var0; var5 <= var0 + var2; ++var5) { // L: 80
				if (var5 >= 0 && var5 < 104 && var4 >= 0 && var4 < 104) { // L:
																			// 81
	...
	static int method96(int var0, Script var1, boolean var2) {
		if (var0 == 7100) { // L: 4602
			...
			return 1; // L: 4608
		} else if (var0 != 7102 && var0 != 7103 && var0 != 7104 && var0 != 7105 && var0 != 7109) { // L:
																									// 4610
			if (var0 == 7106) { // L: 4614
				...
				Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = class18.method234() ? 1 : 0; // L:
				// 4623
				return 1; // L: 4624
