...
public class WorldMapRegion {
	...
	final HashMap fonts;
	static {
		WorldMapRegion_cachedSprites = new DemotingHashTable(37748736, 256); // L:
																				// 26
	}
	...
	void method4694(int var1, int var2, int var3) {
		SpritePixels var4 = class432.method7578(this.regionX, this.regionY, this.pixelsPerTile); // L:
																									// 67
		if (var4 != null) { // L: 68
	...
	void initWorldMapData1(HashSet var1, List var2) {
		...
		while (var3.hasNext()) { // L: 92
			...
			if (var4.getRegionX() == this.regionX && var4.getRegionY() == this.regionY) { // L:
																							// 88
	...
	void getIconsForTiles(int var1, int var2, int var3, int var4, AbstractWorldMapData var5) {
		for (int var6 = var1; var6 < var3 + var1; ++var6) { // L: 97
			label76 : for (int var7 = var2; var7 < var2 + var4; ++var7) { // L:
																			// 98
				for (int var8 = 0; var8 < var5.planes; ++var8) { // L: 99
					WorldMapDecoration[] var9 = var5.decorations[var8][var6][var7]; // L:
																					// 100
					if (var9 != null && var9.length != 0) { // L: 101
						WorldMapDecoration[] var10 = var9; // L: 105
						for (int var11 = 0; var11 < var10.length; ++var11) { // L:
																				// 106
							ObjectComposition var13;
							boolean var14;
							label67 : {
								WorldMapDecoration var12 = var10[var11]; // L:
																			// 107
								var13 = class162.getObjectDefinition(var12.objectDefinitionId); // L:
																								// 109
								if (var13.transforms != null) { // L: 112
									int[] var15 = var13.transforms; // L: 114
									for (int var16 = 0; var16 < var15.length; ++var16) { // L:
																							// 115
										int var17 = var15[var16]; // L: 116
										ObjectComposition var18 = class162.getObjectDefinition(var17); // L:
																										// 118
							...
							if (var14) { // L: 133
								this.getIcon(var13, var8, var6, var7, var5); // L:
																				// 136
	...
	void getIcon(ObjectComposition var1, int var2, int var3, int var4, AbstractWorldMapData var5) {
		Coord var6 = new Coord(var2, var3 + this.regionX * 64, this.regionY * 64 + var4); // L:
																							// 147
		Coord var7 = null; // L: 148
		if (this.worldMapData_0 != null) { // L: 149
			var7 = new Coord(this.worldMapData_0.minPlane + var2, var3 + this.worldMapData_0.regionXLow * 64, var4 + this.worldMapData_0.regionYLow * 64); // L:
																																							// 150
		} else {
			WorldMapData_1 var8 = (WorldMapData_1) var5; // L: 153
			var7 = new Coord(var2 + var8.minPlane, var8.regionXLow * 64 + var3 + var8.getChunkXLow() * 8, var8.regionYLow * 64 + var4 + var8.getChunkYLow() * 8); // L:
																																									// 154
		}
		...
		if (var1.transforms != null) { // L: 157
			...
			var10 = new WorldMapIcon_0(var7, var6, var9.objectId, this.createMapLabel(var9)); // L:
																								// 162
		}
		var9 = class432.WorldMapElement_get(((AbstractWorldMapIcon) var10).getElement()); // L:
																							// 164
	...
	void initWorldMapIcon1s() {
		...
		while (var1.hasNext()) { // L: 178
			AbstractWorldMapIcon var2 = (AbstractWorldMapIcon) var1.next(); // L:
																			// 172
	...
	void addAllToIconList(List var1) {
		...
		while (var2.hasNext()) {
			...
			if (class432.WorldMapElement_get(var3.element).field1830 && var3.coord2.x >> 6 == this.regionX && var3.coord2.y >> 6 == this.regionY) { // L:
																																					// 185
																																					// 188
				WorldMapIcon_0 var4 = new WorldMapIcon_0(var3.coord2, var3.coord2, var3.element, this.method4808(var3.element)); // L:
																																	// 189
	...
	boolean loadGeography(AbstractArchive var1) {
		...
		if (this.worldMapData_0 != null) { // L: 212
			...
			if (this.worldMapData_0.isFullyLoaded()) { // L: 214
				this.getIconsForTiles(0, 0, 64, 64, this.worldMapData_0); // L:
																			// 215
				return true; // L: 216
			} else {
				return false; // L: 218
			...
			Iterator var3;
			WorldMapData_1 var4;
			for (var3 = this.worldMapData1List.iterator(); var3.hasNext(); var2 &= var4.isFullyLoaded()) { // L:
																											// 222
																											// 226
			...
			if (var2) { // L: 229
				...
				while (var3.hasNext()) {
					...
					this.getIconsForTiles(var4.getChunkX() * 8, var4.getChunkY() * 8, 8, 8, var4); // L:
																									// 233
				}
			}
			return var2; // L: 237
	...
	void drawTile(int var1, WorldMapScaleHandler var2, IndexedSprite[] var3, AbstractArchive var4, AbstractArchive var5) {
		...
		if (this.worldMapData_0 != null || !this.worldMapData1List.isEmpty()) { // L:
																				// 243
			if (class432.method7578(this.regionX, this.regionY, var1) == null) { // L:
																					// 246
				...
				if (this.worldMapData_0 != null) { // L: 253
					...
					var8 = ((AbstractWorldMapData) this.worldMapData1List.getFirst()).groupId; // L:
																								// 257
				}
				...
				if (var6) { // L: 260
					...
					if (var7 == null) { // L: 264
						...
						var9 = new WorldMapSprite(ItemLayer.method3920(var7).pixels); // L:
																						// 268
					}
					SpritePixels var11 = new SpritePixels(this.pixelsPerTile * 64, this.pixelsPerTile * 64); // L:
																												// 271
					...
					Static.method2699(var11, this.regionX, this.regionY, this.pixelsPerTile); // L:
																								// 279
	...
	void flashElements(HashSet var1, int var2, int var3) {
		...
		while (var4.hasNext()) {
			AbstractWorldMapIcon var5 = (AbstractWorldMapIcon) var4.next(); // L:
																			// 293
			if (var5.hasValidElement()) { // L: 295
				int var6 = var5.getElement(); // L: 296
				if (var1.contains(var6)) { // L: 297
					WorldMapElement var7 = class432.WorldMapElement_get(var6); // L:
																				// 298
					this.drawBackgroundCircle(var7, var5.screenX, var5.screenY, var2, var3); // L:
																								// 299
				}
			}
		}
	...
	void method4784(WorldMapScaleHandler var1, IndexedSprite[] var2, WorldMapSprite var3) {
		...
		for (var4 = 0; var4 < 64; ++var4) { // L: 307
			for (var5 = 0; var5 < 64; ++var5) { // L: 308
				this.drawTileGround(var4, var5, this.worldMapData_0, var1, var3); // L:
																					// 309
				this.method4782(var4, var5, this.worldMapData_0, var1); // L:
																		// 310
			}
		}
		for (var4 = 0; var4 < 64; ++var4) { // L: 313
			for (var5 = 0; var5 < 64; ++var5) { // L: 314
				this.method4708(var4, var5, this.worldMapData_0, var1, var2); // L:
																				// 315
			}
		}
	} // L: 318
	...
	void method4788(WorldMapScaleHandler var1, IndexedSprite[] var2, WorldMapSprite var3) {
		...
		while (var4.hasNext()) {
			...
			for (var6 = var5.getChunkX() * 8; var6 < var5.getChunkX() * 8 + 8; ++var6) { // L:
																							// 324
				for (var7 = var5.getChunkY() * 8; var7 < var5.getChunkY() * 8 + 8; ++var7) { // L:
																								// 325
	...
	void drawTileGround(int var1, int var2, AbstractWorldMapData var3, WorldMapScaleHandler var4, WorldMapSprite var5) {
		...
		if (var6 == -1 && var7 == -1) { // L: 352
			Rasterizer2D.Rasterizer2D_fillRectangle(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile, this.pixelsPerTile, this.backgroundColor); // L:
																																												// 353
		}
		...
		if (var7 != -1) { // L: 356
			...
			if (var11 == null) { // L: 361
				...
				int var12 = class154.method3170(Rasterizer3D.Rasterizer3D_textureLoader.getAverageTextureRGB(var11.texture), 96); // L:
				// 369
				var9 = Rasterizer3D.Rasterizer3D_colorPalette[var12] | -16777216; // L:
																					// 370
				...
				int var16 = (var14 / 32 << 7) + var15 / 2 + (var13 / 4 << 10); // L:
																				// 385
				int var17 = class154.method3170(var16, 96); // L: 389
				var9 = Rasterizer3D.Rasterizer3D_colorPalette[var17] | -16777216; // L:
																					// 390
			}
			var8 = var9; // L: 393
		}
		if (var7 > -1 && var3.field2796[0][var1][var2] == 0) { // L: 395
			Rasterizer2D.Rasterizer2D_fillRectangle(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile, this.pixelsPerTile, var8); // L:
																																								// 396
		} else {
			var9 = this.method4711(var1, var2, var3, var5); // L: 399
			if (var7 == -1) { // L: 400
				Rasterizer2D.Rasterizer2D_fillRectangle(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile, this.pixelsPerTile, var9); // L:
																																									// 401
			} else {
				var4.method5108(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), var9, var8, this.pixelsPerTile, this.pixelsPerTile, var3.field2796[0][var1][var2], var3.field2795[0][var1][var2]); // L:
																																																				// 404
			}
		}
	} // L: 397 402 405
	...
	void method4782(int var1, int var2, AbstractWorldMapData var3, WorldMapScaleHandler var4) {
		for (int var5 = 1; var5 < var3.planes; ++var5) { // L: 408
			...
			if (var6 > -1) { // L: 410
				...
				FloorOverlayDefinition var9 = class124.method2814(var6); // L:
																			// 414
				int var7;
				if (var9 == null) { // L: 415
					var7 = var8; // L: 416
					...
					int var10 = class154.method3170(Rasterizer3D.Rasterizer3D_textureLoader.getAverageTextureRGB(var9.texture), 96); // L:
					// 423
					var7 = Rasterizer3D.Rasterizer3D_colorPalette[var10] | -16777216; // L:
																						// 424
					...
					int var14 = (var12 / 32 << 7) + var13 / 2 + (var11 / 4 << 10); // L:
																					// 439
					int var15 = class154.method3170(var14, 96); // L: 443
					var7 = Rasterizer3D.Rasterizer3D_colorPalette[var15] | -16777216; // L:
																						// 444
				}
				if (var3.field2796[var5][var1][var2] == 0) { // L: 448
					Rasterizer2D.Rasterizer2D_fillRectangle(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile, this.pixelsPerTile, var7); // L:
																																										// 449
				} else {
					var4.method5108(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), 0, var7, this.pixelsPerTile, this.pixelsPerTile, var3.field2796[var5][var1][var2], var3.field2795[var5][var1][var2]); // L:
																																																						// 452
				}
			}
		}
	...
	int method4711(int var1, int var2, AbstractWorldMapData var3, WorldMapSprite var4) {
		return var3.floorUnderlayIds[0][var1][var2] == 0 ? this.backgroundColor : var4.getTileColor(var1, var2); // L:
		// 459
		// 460
		// 462
	}
	...
	void method4706(int var1, int var2, AbstractWorldMapData var3, IndexedSprite[] var4) {
		for (int var5 = 0; var5 < var3.planes; ++var5) { // L: 466
			WorldMapDecoration[] var6 = var3.decorations[var5][var1][var2]; // L:
																			// 467
			if (var6 != null && var6.length != 0) { // L: 468
				...
				for (int var8 = 0; var8 < var7.length; ++var8) { // L: 473
					...
					if (Clock.method3331(var9.decoration) || WorldMapLabelSize.method4575(var9.decoration)) { // L:
																												// 476
						ObjectComposition var10 = class162.getObjectDefinition(var9.objectDefinitionId); // L:
																											// 477
						if (var10.mapSceneId != -1) { // L: 478
							if (var10.mapSceneId != 46 && var10.mapSceneId != 52) { // L:
																					// 479
								var4[var10.mapSceneId].method8135(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile * 2, this.pixelsPerTile * 2); // L:
																																												// 483
							} else {
								var4[var10.mapSceneId].method8135(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), this.pixelsPerTile * 2 + 1, this.pixelsPerTile * 2 + 1); // L:
																																														// 480
							}
						}
					}
	...
	void method4713(int var1, int var2, AbstractWorldMapData var3) {
		for (int var4 = 0; var4 < var3.planes; ++var4) { // L: 494
			WorldMapDecoration[] var5 = var3.decorations[var4][var1][var2]; // L:
																			// 495
			if (var5 != null && var5.length != 0) { // L: 496
				...
				for (int var7 = 0; var7 < var6.length; ++var7) { // L: 501
					...
					boolean var9 = var10 >= WorldMapDecorationType.field3549.id && var10 <= WorldMapDecorationType.field3534.id || var10 == WorldMapDecorationType.field3535.id; // L:
																																													// 507
					if (var9) { // L: 509
						ObjectComposition var11 = class162.getObjectDefinition(var8.objectDefinitionId); // L:
																											// 510
						int var12 = var11.int1 != 0 ? -3407872 : -3355444; // L:
																			// 511
						if (var8.decoration == WorldMapDecorationType.field3549.id) { // L:
																						// 512
							this.method4723(var1, var2, var8.rotation, var12); // L:
																				// 513
						}
						if (var8.decoration == WorldMapDecorationType.field3533.id) { // L:
																						// 515
							this.method4723(var1, var2, var8.rotation, -3355444); // L:
																					// 516
							this.method4723(var1, var2, var8.rotation + 1, var12); // L:
																					// 517
						}
						if (var8.decoration == WorldMapDecorationType.field3534.id) { // L:
																						// 519
						...
						if (var8.decoration == WorldMapDecorationType.field3535.id) { // L:
																						// 525
							int var13 = var8.rotation % 2; // L: 526
							int var14;
							if (var13 == 0) { // L: 527
								for (var14 = 0; var14 < this.pixelsPerTile; ++var14) { // L:
																						// 528
									Rasterizer2D.Rasterizer2D_drawHorizontalLine(var14 + this.pixelsPerTile * var1, (64 - var2) * this.pixelsPerTile - 1 - var14, 1, var12); // L:
																																												// 529
								}
							} else {
								for (var14 = 0; var14 < this.pixelsPerTile; ++var14) { // L:
																						// 533
									Rasterizer2D.Rasterizer2D_drawHorizontalLine(var14 + this.pixelsPerTile * var1, var14 + this.pixelsPerTile * (63 - var2), 1, var12); // L:
																																											// 534
								}
							}
						}
	...
	void drawNonLinkMapIcons(int var1, int var2, HashSet var3, int var4) {
		...
		while (var7.hasNext()) {
			...
			int var10 = (int) (var5 * (float) var9.x + (float) var1 - var6); // L:
																				// 552
			int var11 = (int) ((float) (var2 + var4) - var5 * (float) var9.y - var6); // L:
																						// 553
			AbstractWorldMapIcon var12 = (AbstractWorldMapIcon) var8.getValue(); // L:
																					// 554
			if (var12 != null && var12.hasValidElement()) { // L: 555
				var12.screenX = var10; // L: 556
				var12.screenY = var11; // L: 557
				WorldMapElement var13 = class432.WorldMapElement_get(var12.getElement()); // L:
																							// 558
	...
	void method4715(HashSet var1, int var2, int var3) {
		...
		while (var4.hasNext()) {
			...
			if (var5.hasValidElement()) { // L: 571
				WorldMapElement var6 = class432.WorldMapElement_get(var5.getElement()); // L:
																						// 572
				if (var6 != null && var1.contains(var6.getObjectId())) { // L:
																			// 573
					this.drawBackgroundCircle(var6, var5.screenX, var5.screenY, var2, var3); // L:
																								// 574
				}
			}
		}
	...
	void drawBackgroundCircle(WorldMapElement var1, int var2, int var3, int var4, int var5) {
		...
		if (var6 != null) { // L: 582
			var6.drawTransBgAt(var2 - var6.subWidth / 2, var3 - var6.subHeight / 2); // L:
																						// 585
			if (var4 % var5 < var5 / 2) { // L: 586
				Rasterizer2D.Rasterizer2D_drawCircleAlpha(var2, var3, 15, 16776960, 128); // L:
																							// 587
				Rasterizer2D.Rasterizer2D_drawCircleAlpha(var2, var3, 7, 16777215, 256); // L:
																							// 588
			}
		}
	} // L: 583 590
	...
	void method4771(AbstractWorldMapIcon var1, int var2, int var3, float var4) {
		WorldMapElement var5 = class432.WorldMapElement_get(var1.getElement()); // L:
																				// 593
	...
	void method4718(WorldMapElement var1, int var2, int var3) {
		...
		if (var4 != null) { // L: 600
			int var5 = this.method4721(var4, var1.horizontalAlignment); // L:
																		// 601
	...
	void method4719(AbstractWorldMapIcon var1, WorldMapElement var2, int var3, int var4, float var5) {
		...
		if (var6 != null) { // L: 609
			if (var6.size.method4567(var5)) { // L: 612
				...
				var7.drawLines(var6.text, var3 - var6.width / 2, var4, var6.width, var6.height, -16777216 | var2.field1834, 0, 1, 0, var7.ascent / 2); // L:
																																						// 616
			}
		}
	} // L: 610 613 617
	...
	void drawMapLinks(int var1, int var2, HashSet var3, int var4) {
		...
		while (var6.hasNext()) {
			AbstractWorldMapIcon var7 = (AbstractWorldMapIcon) var6.next(); // L:
																			// 622
			if (var7.hasValidElement()) { // L: 624
				...
				var7.screenX = (int) ((float) var1 + var5 * (float) var8); // L:
																			// 627
				var7.screenY = (int) ((float) (63 - var9) * var5 + (float) var2); // L:
																					// 628
				if (!var3.contains(var7.getElement())) { // L: 629
					this.method4771(var7, var7.screenX, var7.screenY, var5); // L:
																				// 632
				}
			}
		}
	...
	WorldMapLabel createMapLabel(WorldMapElement var1) {
		if (var1.name != null && this.fonts != null && this.fonts.get(WorldMapLabelSize.WorldMapLabelSize_small) != null) { // L:
																															// 677
			...
			if (var2 == null) { // L: 698
				...
				if (var14 == null) { // L: 702
					...
					return new WorldMapLabel(var1.name, var9, var8, var2); // L:
																			// 722
				}
			}
		} else {
		...
		if (var4 >= var1 && var5 >= var2) { // L: 727
			if (var4 < var3 + var1 && var5 < var3 + var2) { // L: 728
				...
				while (var7.hasNext()) { // L: 729
					...
					if (var8.hasValidElement() && var8.fitsScreen(var4, var5)) { // L:
																					// 732
						var6.add(var8); // L: 733
					}
				}
	...
	void method4723(int var1, int var2, int var3, int var4) {
		...
		if (var3 == 3) {
			Rasterizer2D.Rasterizer2D_drawHorizontalLine(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2) + this.pixelsPerTile - 1, this.pixelsPerTile, var4); // L:
																																											// 760
		}
	} // L: 761
}
