...
public class WorldMapScaleHandler {
	...
	void method5108(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		if (var7 != 0 && this.pixelsPerTile != 0 && this.tileTemplates != null) { // L:
																					// 14
			var8 = this.method5085(var8, var7); // L: 15
			var7 = this.method5086(var7); // L: 16
			Rasterizer2D.Rasterizer2D_drawGradientPixels(var1, var2, var5, var6, var3, var4, this.tileTemplates[var7 - 1][var8], this.pixelsPerTile); // L:
																																						// 17
		}
	} // L: 18
	...
	void init0() {
		byte[] var1 = new byte[this.pixelsPerTile * this.pixelsPerTile]; // L:
																			// 49
		int var2 = 0; // L: 50
		int var3;
		int var4;
