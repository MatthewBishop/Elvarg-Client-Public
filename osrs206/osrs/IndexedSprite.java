...
public final class IndexedSprite extends Rasterizer2D {
		...
		if (this.subWidth != this.width || this.subHeight != this.height) { // L:
			...
			for (int var3 = 0; var3 < this.subHeight; ++var3) { // L: 21
				for (int var4 = 0; var4 < this.subWidth; ++var4) { // L: 22
					var1[var4 + (var3 + this.yOffset) * this.width + this.xOffset] = this.pixels[var2++]; // L:
																											// 23
				}
			}
	...
	public void drawAt(int var1, int var2) {
		...
		if (var6 > 0 && var5 > 0) { // L: 83
			IndexedSprite_two(Rasterizer2D.Rasterizer2D_pixels, this.pixels, this.palette, var4, var3, var6, var5, var7, var8); // L:
																																// 84
		}
	} // L: 85
	public void method8135(int var1, int var2, int var3, int var4) {
		...
		IndexedSprite_something(Rasterizer2D.Rasterizer2D_pixels, this.pixels, this.palette, var7, var8, var13, var14, var3, var4, var11, var12, var5); // L:
																																						// 157
	} // L: 158
