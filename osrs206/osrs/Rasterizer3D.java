...
public class Rasterizer3D extends Rasterizer2D {
	...
	static {
		...
		for (var0 = 0; var0 < 2048; ++var0) { // L: 43
			Rasterizer3D_sine[var0] = (int) (65536.0D * Math.sin((double) var0 * 0.0030679615D)); // L:
																									// 44
			Rasterizer3D_cosine[var0] = (int) (65536.0D * Math.cos((double) var0 * 0.0030679615D)); // L:
																									// 45
		}
	} // L: 47
	public static final void Rasterizer3D_setClipFromRasterizer2D() {
		Rasterizer3D_setClip(Rasterizer2D.Rasterizer2D_xClipStart, Rasterizer2D.Rasterizer2D_yClipStart, Rasterizer2D.Rasterizer2D_xClipEnd, Rasterizer2D.Rasterizer2D_yClipEnd); // L:
																																													// 54
	} // L: 55
	static final void Rasterizer3D_setClip(int var0, int var1, int var2, int var3) {
		...
		if (Rasterizer3D_rowOffsets.length < Rasterizer3D_clipHeight) { // L: 61
			Rasterizer3D_rowOffsets = new int[Equations.farthestBitValue(Rasterizer3D_clipHeight)];
		}
	...
	public static final void Rasterizer3D_method3() {
		...
		Rasterizer3D_clipMidX2 = Rasterizer3D_clipWidth - Rasterizer3D_clipMidX; // L:
																					// 73
		Rasterizer3D_clipNegativeMidY = -Rasterizer3D_clipMidY; // L: 74
		Rasterizer3D_clipMidY2 = Rasterizer3D_clipHeight - Rasterizer3D_clipMidY; // L:
																					// 75
	} // L: 76
	...
	public static void method4030(int var0, int var1, int var2) {
		field2345 = var0 < 0 || var0 > Rasterizer3D_clipWidth || var1 < 0 || var1 > Rasterizer3D_clipWidth || var2 < 0 || var2 > Rasterizer3D_clipWidth; // L:
																																							// 156
	} // L: 157
			...
			if (var0 <= var1 && var0 <= var2) { // L: 191
				if (var0 < Rasterizer3D_clipHeight) { // L: 192
					...
					if (var1 < var2) { // L: 200
						...
						if (var0 != var1 && var17 < var16 || var0 == var1 && var17 > var15) { // L:
																								// 213
							var2 -= var1; // L: 214
							var1 -= var0; // L: 215
							...
							while (true) {
								...
								if (var1 < 0) {
									while (true) {
										...
										Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, 0, 0, var5 >> 14, var4 >> 14, var6, var19); // L:
																																					// 225
										var5 += var17; // L: 226
										var4 += var15; // L: 227
										var6 += var20; // L: 228
										var0 += Rasterizer2D.Rasterizer2D_width; // L:
																					// 229
									}
								}
								Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, 0, 0, var5 >> 14, var3 >> 14, var6, var19); // L:
																																			// 218
								var5 += var17; // L: 219
								var3 += var16; // L: 220
								var6 += var20; // L: 221
							...
							while (true) {
								...
								if (var1 < 0) {
									while (true) {
										...
										Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, 0, 0, var4 >> 14, var5 >> 14, var6, var19); // L:
																																					// 245
										var5 += var17; // L: 246
										var4 += var15; // L: 247
										var6 += var20; // L: 248
								...
								Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, 0, 0, var3 >> 14, var5 >> 14, var6, var19); // L:
																																			// 238
								var5 += var17; // L: 239
								var3 += var16; // L: 240
								var6 += var20; // L: 241
						...
						if (var0 != var2 && var17 < var16 || var0 == var2 && var15 > var16) { // L:
																								// 267
							var1 -= var2; // L: 268
							var2 -= var0; // L: 269
							...
							while (true) {
								...
								Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, 0, 0, var4 >> 14, var3 >> 14, var6, var19); // L:
																																			// 272
								var4 += var17; // L: 273
								var3 += var16; // L: 274
								var6 += var20; // L: 275
							...
							while (true) {
								...
								Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, 0, 0, var3 >> 14, var4 >> 14, var6, var19); // L:
																																			// 292
								var4 += var17; // L: 293
								var3 += var16; // L: 294
								var6 += var20; // L: 295
				...
				if (var1 < Rasterizer3D_clipHeight) { // L: 310
					...
					if (var2 < var0) { // L: 318
						...
						if (var2 != var1 && var16 < var15 || var2 == var1 && var16 > var17) { // L:
																								// 331
							var0 -= var2; // L: 332
							var2 -= var1; // L: 333
							...
							while (true) {
								...
								if (var2 < 0) {
									while (true) {
										...
										Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var1, 0, 0, var3 >> 14, var5 >> 14, var7, var19); // L:
																																					// 343
										var3 += var16; // L: 344
										var5 += var17; // L: 345
										var7 += var20; // L: 346
										var1 += Rasterizer2D.Rasterizer2D_width; // L:
																					// 347
									}
								}
								Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var1, 0, 0, var3 >> 14, var4 >> 14, var7, var19); // L:
																																			// 336
								var3 += var16; // L: 337
								var4 += var15; // L: 338
								var7 += var20; // L: 339
							...
							while (true) {
								...
								if (var2 < 0) {
									while (true) {
										...
										Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var1, 0, 0, var5 >> 14, var3 >> 14, var7, var19); // L:
																																					// 363
										var3 += var16; // L: 364
										var5 += var17; // L: 365
										var7 += var20; // L: 366
								...
								Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var1, 0, 0, var4 >> 14, var3 >> 14, var7, var19); // L:
																																			// 356
								var3 += var16; // L: 357
								var4 += var15; // L: 358
								var7 += var20; // L: 359
						...
						if (var16 < var15) { // L: 385
							...
							while (true) {
								...
								Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var1, 0, 0, var5 >> 14, var4 >> 14, var7, var19); // L:
																																			// 390
								var5 += var16; // L: 391
								var4 += var15; // L: 392
								var7 += var20; // L: 393
							...
							while (true) {
								...
								Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var1, 0, 0, var4 >> 14, var5 >> 14, var7, var19); // L:
																																			// 410
								var5 += var16; // L: 411
								var4 += var15; // L: 412
								var7 += var20; // L: 413
				...
				if (var0 < var1) { // L: 432
						...
						while (true) {
							...
							if (var0 < 0) {
								while (true) {
									...
									Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, 0, 0, var4 >> 14, var3 >> 14, var8, var19); // L:
																																				// 457
									var4 += var15; // L: 458
									var3 += var16; // L: 459
									var8 += var20; // L: 460
									var2 += Rasterizer2D.Rasterizer2D_width; // L:
																				// 461
								}
							}
							Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, 0, 0, var4 >> 14, var5 >> 14, var8, var19); // L:
																																		// 450
							var4 += var15; // L: 451
							var5 += var17; // L: 452
							var8 += var20; // L: 453
						...
						while (true) {
							...
							if (var0 < 0) {
								while (true) {
									...
									Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, 0, 0, var3 >> 14, var4 >> 14, var8, var19); // L:
																																				// 477
									var4 += var15; // L: 478
									var3 += var16; // L: 479
									var8 += var20; // L: 480
							...
							Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, 0, 0, var5 >> 14, var4 >> 14, var8, var19); // L:
																																		// 470
							var4 += var15; // L: 471
							var5 += var17; // L: 472
							var8 += var20; // L: 473
					...
					if (var15 < var17) { // L: 499
						...
						while (true) {
							...
							Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, 0, 0, var3 >> 14, var5 >> 14, var8, var19); // L:
																																		// 504
							var3 += var15; // L: 505
							var5 += var17; // L: 506
							var8 += var20; // L: 507
						...
						while (true) {
							...
							Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, 0, 0, var5 >> 14, var3 >> 14, var8, var19); // L:
																																		// 524
							var3 += var15; // L: 525
							var5 += var17; // L: 526
							var8 += var20; // L: 527
	...
	static final void method4032(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, byte var9, byte var10, byte var11, byte var12) {
		...
		method4096(var0, var1, var2, var3, var4, var5, var6, var7, var8); // L:
																			// 547
	} // L: 548
		...
		if (var4 < var5) { // L: 572
			...
			if (field2340) { // L: 575
				...
				if (Rasterizer3D_alpha == 0) { // L: 578
					...
					if (var3 > 0) { // L: 602
						do {
							var10 = (var6 & (var6 >> 31 & 1) - 1) >> 8; // L:
																		// 604
							var2 = Rasterizer3D_colorPalette[var10]; // L: 605
							var6 += var7; // L: 606
							var2 = (var9 * (var2 & 65280) >> 8 & 65280) + (var9 * (var2 & 16711935) >> 8 & 16711935); // L:
							// 607
							var11 = var0[var1]; // L: 608
							var0[var1++] = ((var11 & 16711935) * var8 >> 8 & 16711935) + var2 + (var8 * (var11 & 65280) >> 8 & 65280); // L:
																																		// 609
		...
		if (var0 <= var1 && var0 <= var2) { // L: 669
			if (var0 < Rasterizer3D_clipHeight) { // L: 670
				...
				if (var1 < var2) { // L: 673
					...
					if (var0 != var1 && var9 < var7 || var0 == var1 && var9 > var8) { // L:
																						// 685
						var2 -= var1; // L: 686
						var1 -= var0; // L: 687
						...
						while (true) {
							...
							if (var1 < 0) {
								while (true) {
									...
									Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, var6, 0, var5 >> 14, var4 >> 14); // L:
																																		// 696
									var5 += var9; // L: 697
									var4 += var8; // L: 698
									var0 += Rasterizer2D.Rasterizer2D_width; // L:
							...
							Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, var6, 0, var5 >> 14, var3 >> 14); // L:
																																// 690
							var5 += var9; // L: 691
							var3 += var7; // L: 692
						...
						while (true) {
							...
							if (var1 < 0) {
								while (true) {
									...
									Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, var6, 0, var4 >> 14, var5 >> 14); // L:
																																		// 714
									var5 += var9; // L: 715
									var4 += var8; // L: 716
									var0 += Rasterizer2D.Rasterizer2D_width; // L:
							...
							Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, var6, 0, var3 >> 14, var5 >> 14); // L:
																																// 708
							var5 += var9; // L: 709
							var3 += var7; // L: 710
					...
					if (var0 != var2 && var9 < var7 || var0 == var2 && var8 > var7) { // L:
																						// 734
						var1 -= var2; // L: 735
						var2 -= var0; // L: 736
						...
						while (true) {
							...
							Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, var6, 0, var4 >> 14, var3 >> 14); // L:
																																// 739
							var4 += var9; // L: 740
							var3 += var7; // L: 741
						...
						while (true) {
							...
							Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, var6, 0, var3 >> 14, var4 >> 14); // L:
																																// 757
							var4 += var9; // L: 758
							var3 += var7; // L: 759
			...
			if (var1 < Rasterizer3D_clipHeight) { // L: 773
				...
				if (var2 < var0) { // L: 776
					...
					if (var2 != var1 && var7 < var8 || var2 == var1 && var7 > var9) { // L:
																						// 788
						var0 -= var2; // L: 789
						var2 -= var1; // L: 790
						...
						while (true) {
							...
							if (var2 < 0) {
								while (true) {
									...
									Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var1, var6, 0, var3 >> 14, var5 >> 14); // L:
																																		// 799
									var3 += var7; // L: 800
									var5 += var9; // L: 801
									var1 += Rasterizer2D.Rasterizer2D_width; // L:
							...
							Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var1, var6, 0, var3 >> 14, var4 >> 14); // L:
																																// 793
							var3 += var7; // L: 794
							var4 += var8; // L: 795
						...
						while (true) {
							...
							if (var2 < 0) {
								while (true) {
									...
									Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var1, var6, 0, var5 >> 14, var3 >> 14); // L:
																																		// 817
									var3 += var7; // L: 818
									var5 += var9; // L: 819
									var1 += Rasterizer2D.Rasterizer2D_width; // L:
							...
							Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var1, var6, 0, var4 >> 14, var3 >> 14); // L:
																																// 811
							var3 += var7; // L: 812
							var4 += var8; // L: 813
					...
					if (var7 < var8) { // L: 837
						...
						while (true) {
							...
							Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var1, var6, 0, var5 >> 14, var4 >> 14); // L:
																																// 842
							var5 += var7; // L: 843
							var4 += var8; // L: 844
						...
						while (true) {
							...
							Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var1, var6, 0, var4 >> 14, var5 >> 14); // L:
																																// 860
							var5 += var7; // L: 861
							var4 += var8; // L: 862
			...
			if (var0 < var1) { // L: 879
					...
					while (true) {
						...
						if (var0 < 0) {
							while (true) {
								...
								Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, var6, 0, var4 >> 14, var3 >> 14); // L:
																																	// 902
								var4 += var8; // L: 903
								var3 += var7; // L: 904
								var2 += Rasterizer2D.Rasterizer2D_width; // L:
						...
						Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, var6, 0, var4 >> 14, var5 >> 14); // L:
																															// 896
						var4 += var8; // L: 897
						var5 += var9; // L: 898
					...
					while (true) {
						...
						if (var0 < 0) {
							while (true) {
								...
								Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, var6, 0, var3 >> 14, var4 >> 14); // L:
																																	// 920
								var4 += var8; // L: 921
								var3 += var7; // L: 922
								var2 += Rasterizer2D.Rasterizer2D_width; // L:
						...
						Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, var6, 0, var5 >> 14, var4 >> 14); // L:
																															// 914
						var4 += var8; // L: 915
						var5 += var9; // L: 916
				...
				if (var8 < var9) { // L: 940
					...
					while (true) {
						...
						Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, var6, 0, var3 >> 14, var5 >> 14); // L:
																															// 945
						var3 += var8; // L: 946
						var5 += var9; // L: 947
					...
					while (true) {
						...
						Rasterizer3D_horizAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, var6, 0, var5 >> 14, var3 >> 14); // L:
																															// 963
						var3 += var8; // L: 964
						var5 += var9; // L: 965
		...
		if (var4 < var5) { // L: 991
			...
			if (Rasterizer3D_alpha != 0) { // L: 994
				if (Rasterizer3D_alpha == 254) { // L: 1006
					...
					var2 = (var7 * (var2 & 65280) >> 8 & 65280) + (var7 * (var2 & 16711935) >> 8 & 16711935); // L:
																												// 1021
					while (true) {
						--var3; // L: 1022
						int var8;
						if (var3 < 0) {
							...
							while (true) {
								...
								var0[var1++] = ((var8 & 16711935) * var6 >> 8 & 16711935) + var2 + (var6 * (var8 & 65280) >> 8 & 65280); // L:
																																			// 1035
							}
						}
	...
	static final void method4070(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18) {
		int[] var19 = Rasterizer3D_textureLoader.getTexturePixels(var18); // L:
																			// 1041
		int var20;
		if (var19 == null) { // L: 1042
			var20 = Rasterizer3D_textureLoader.getAverageTextureRGB(var18); // L:
																			// 1043
			method4096(var0, var1, var2, var3, var4, var5, method4041(var20, var6), method4041(var20, var7), method4041(var20, var8)); // L:
																																		// 1044
		} else {
			Rasterizer3D_isLowDetailTexture = Rasterizer3D_textureLoader.isLowDetail(var18); // L:
																								// 1047
			field2338 = Rasterizer3D_textureLoader.vmethod4538(var18); // L:
																		// 1048
			...
			if (var29 != 0) { // L: 1062
				int var30 = (var24 * var23 - var25 * var21 << 9) / var29; // L:
																			// 1063
				int var31 = (var25 * var20 - var24 * var22 << 9) / var29; // L:
																			// 1064
				...
				int var33 = (int) (((long) (var15 * var14 - var17 * var12) << 3 << 14) / (long) Rasterizer3D_zoom); // L:
				// 1072
				int var34 = (int) (((long) (var17 * var9 - var11 * var15) << 14) / (long) Rasterizer3D_zoom); // L:
																												// 1073
				int var35 = var10 * var12 - var13 * var9 << 14; // L: 1074
				int var36 = (int) (((long) (var13 * var15 - var16 * var12) << 3 << 14) / (long) Rasterizer3D_zoom); // L:
				// 1075
				int var37 = (int) (((long) (var16 * var9 - var10 * var15) << 14) / (long) Rasterizer3D_zoom); // L:
																												// 1076
				int var38 = var13 * var11 - var10 * var14 << 14; // L: 1077
				int var39 = (int) (((long) (var16 * var14 - var13 * var17) << 3 << 14) / (long) Rasterizer3D_zoom); // L:
				// 1078
				int var40 = (int) (((long) (var17 * var10 - var11 * var16) << 14) / (long) Rasterizer3D_zoom); // L:
				// 1079
				int var41;
				if (var0 <= var1 && var0 <= var2) { // L: 1080
					if (var0 < Rasterizer3D_clipHeight) { // L: 1081
						...
						if (var1 < var2) { // L: 1085
							...
							if ((var0 == var1 || var28 >= var26) && (var0 != var1 || var28 <= var27)) { // L:
																										// 1102
								var2 -= var1; // L: 1129
								var1 -= var0; // L: 1130
								...
								while (true) {
									...
									if (var1 < 0) {
										while (true) {
											...
											Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0, var4 >> 14, var5 >> 14, var6, var30, var32, var35, var38, var33, var36, var39); // L:
																																																		// 1143
											var5 += var28; // L: 1144
											var4 += var27; // L: 1145
											var6 += var31; // L: 1146
									...
									Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0, var3 >> 14, var5 >> 14, var6, var30, var32, var35, var38, var33, var36, var39); // L:
																																																// 1133
									var5 += var28; // L: 1134
									var3 += var26; // L: 1135
									var6 += var31; // L: 1136
								...
								while (true) {
									...
									if (var1 < 0) {
										while (true) {
											...
											Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0, var5 >> 14, var4 >> 14, var6, var30, var32, var35, var38, var33, var36, var39); // L:
																																																		// 1117
											var5 += var28; // L: 1118
											var4 += var27; // L: 1119
											var6 += var31; // L: 1120
									...
									Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0, var5 >> 14, var3 >> 14, var6, var30, var32, var35, var38, var33, var36, var39); // L:
																																																// 1107
									var5 += var28; // L: 1108
									var3 += var26; // L: 1109
									var6 += var31; // L: 1110
							...
							if ((var0 == var2 || var28 >= var26) && (var0 != var2 || var27 <= var26)) { // L:
																										// 1172
								var1 -= var2; // L: 1199
								var2 -= var0; // L: 1200
								...
								while (true) {
									...
									Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0, var3 >> 14, var4 >> 14, var6, var30, var32, var35, var38, var33, var36, var39); // L:
																																																// 1203
									var4 += var28; // L: 1204
									var3 += var26; // L: 1205
									var6 += var31; // L: 1206
								...
								while (true) {
									...
									Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0, var4 >> 14, var3 >> 14, var6, var30, var32, var35, var38, var33, var36, var39); // L:
																																																// 1177
									var4 += var28; // L: 1178
									var3 += var26; // L: 1179
									var6 += var31; // L: 1180
					...
					if (var1 < Rasterizer3D_clipHeight) { // L: 1227
						...
						if (var2 < var0) { // L: 1231
							...
							if (var2 != var1 && var26 < var27 || var2 == var1 && var26 > var28) { // L:
																									// 1248
								var0 -= var2; // L: 1249
								var2 -= var1; // L: 1250
								...
								while (true) {
									...
									if (var2 < 0) {
										while (true) {
											...
											Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1, var3 >> 14, var5 >> 14, var7, var30, var32, var35, var38, var33, var36, var39); // L:
																																																		// 1263
											var3 += var26; // L: 1264
											var5 += var28; // L: 1265
											var7 += var31; // L: 1266
									...
									Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1, var3 >> 14, var4 >> 14, var7, var30, var32, var35, var38, var33, var36, var39); // L:
																																																// 1253
									var3 += var26; // L: 1254
									var4 += var27; // L: 1255
									var7 += var31; // L: 1256
								...
								while (true) {
									...
									if (var2 < 0) {
										while (true) {
											...
											Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1, var5 >> 14, var3 >> 14, var7, var30, var32, var35, var38, var33, var36, var39); // L:
																																																		// 1289
											var3 += var26; // L: 1290
											var5 += var28; // L: 1291
											var7 += var31; // L: 1292
									...
									Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1, var4 >> 14, var3 >> 14, var7, var30, var32, var35, var38, var33, var36, var39); // L:
																																																// 1279
									var3 += var26; // L: 1280
									var4 += var27; // L: 1281
									var7 += var31; // L: 1282
							...
							if (var26 < var27) { // L: 1318
								...
								while (true) {
									...
									Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1, var5 >> 14, var4 >> 14, var7, var30, var32, var35, var38, var33, var36, var39); // L:
																																																// 1323
									var5 += var26; // L: 1324
									var4 += var27; // L: 1325
									var7 += var31; // L: 1326
								...
								while (true) {
									...
									Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1, var4 >> 14, var5 >> 14, var7, var30, var32, var35, var38, var33, var36, var39); // L:
																																																// 1349
									var5 += var26; // L: 1350
									var4 += var27; // L: 1351
									var7 += var31; // L: 1352
					...
					if (var0 < var1) { // L: 1377
							...
							while (true) {
								...
								if (var0 < 0) {
									while (true) {
										...
										Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2, var4 >> 14, var3 >> 14, var8, var30, var32, var35, var38, var33, var36, var39); // L:
																																																	// 1409
										var4 += var27; // L: 1410
										var3 += var26; // L: 1411
										var8 += var31; // L: 1412
								...
								Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2, var4 >> 14, var5 >> 14, var8, var30, var32, var35, var38, var33, var36, var39); // L:
																																															// 1399
								var4 += var27; // L: 1400
								var5 += var28; // L: 1401
								var8 += var31; // L: 1402
							...
							while (true) {
								...
								if (var0 < 0) {
									while (true) {
										...
										Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2, var3 >> 14, var4 >> 14, var8, var30, var32, var35, var38, var33, var36, var39); // L:
																																																	// 1435
										var4 += var27; // L: 1436
										var3 += var26; // L: 1437
										var8 += var31; // L: 1438
								...
								Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2, var5 >> 14, var4 >> 14, var8, var30, var32, var35, var38, var33, var36, var39); // L:
																																															// 1425
								var4 += var27; // L: 1426
								var5 += var28; // L: 1427
								var8 += var31; // L: 1428
						...
						if (var27 < var28) { // L: 1464
							...
							while (true) {
								...
								Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2, var3 >> 14, var5 >> 14, var8, var30, var32, var35, var38, var33, var36, var39); // L:
																																															// 1469
								var3 += var27; // L: 1470
								var5 += var28; // L: 1471
								var8 += var31; // L: 1472
							...
							while (true) {
								...
								Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2, var5 >> 14, var3 >> 14, var8, var30, var32, var35, var38, var33, var36, var39); // L:
																																															// 1495
								var3 += var27; // L: 1496
								var5 += var28; // L: 1497
								var8 += var31; // L: 1498
	...
	static final void Rasterizer3D_iDontKnow(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14) {
		...
		if (var5 < var6) { // L: 1527
			...
			if (Rasterizer3D_isLowDetailTexture) { // L: 1531
				...
				var16 = (var21 - var19 >> 3) + (var20 - var18 >> 3 << 20); // L:
																			// 1567
				var17 >>= 3; // L: 1568
				var8 <<= 3; // L: 1569
				var15 = var7 >> 8; // L: 1570
				if (field2338) { // L: 1571
					if (var17 > 0) { // L: 1572
						do {
							var3 = var1[(var2 >>> 26) + (var2 & 4032)]; // L:
																		// 1574
							var0[var4++] = (var15 * (var3 & 65280) & 16711680) + ((var3 & 16711935) * var15 & -16711936) >> 8; // L:
																																// 1575
							var2 += var16; // L: 1576
							var3 = var1[(var2 >>> 26) + (var2 & 4032)]; // L:
																		// 1577
					...
					if (var17 > 0) { // L: 1630
						do {
							if ((var3 = var1[(var2 >>> 26) + (var2 & 4032)]) != 0) { // L:
																						// 1632
								var0[var4] = (var15 * (var3 & 65280) & 16711680) + ((var3 & 16711935) * var15 & -16711936) >> 8; // L:
																																	// 1633
							}
				...
				var16 = (var21 - var19 >> 3) + (var20 - var18 >> 3 << 18); // L:
																			// 1742
				var17 >>= 3; // L: 1743
				var8 <<= 3; // L: 1744
				var15 = var7 >> 8; // L: 1745
				if (field2338) { // L: 1746
					if (var17 > 0) { // L: 1747
						do {
							var3 = var1[(var2 & 16256) + (var2 >>> 25)]; // L:
																			// 1749
							var0[var4++] = (var15 * (var3 & 65280) & 16711680) + ((var3 & 16711935) * var15 & -16711936) >> 8; // L:
																																// 1750
							var2 += var16; // L: 1751
					...
					if (var17 > 0) { // L: 1805
						do {
							if ((var3 = var1[(var2 & 16256) + (var2 >>> 25)]) != 0) { // L:
																						// 1807
								var0[var4] = (var15 * (var3 & 65280) & 16711680) + ((var3 & 16711935) * var15 & -16711936) >> 8; // L:
																																	// 1808
							}
	...
	static final void drawTexturedTile(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18) {
		...
		if (var19 == null) { // L: 1885
			...
			if (var29 != 0) { // L: 1905
				...
				int var33 = (int) (((long) (var15 * var14 - var17 * var12) << 14) / (long) Rasterizer3D_zoom); // L:
				// 1915
				int var34 = (int) (((long) (var17 * var9 - var11 * var15) << 14) / (long) Rasterizer3D_zoom); // L:
																												// 1916
				int var35 = var10 * var12 - var13 * var9 << 14; // L: 1917
				int var36 = (int) (((long) (var13 * var15 - var16 * var12) << 14) / (long) Rasterizer3D_zoom); // L:
				// 1918
				int var37 = (int) (((long) (var16 * var9 - var10 * var15) << 14) / (long) Rasterizer3D_zoom); // L:
																												// 1919
				int var38 = var13 * var11 - var10 * var14 << 14; // L: 1920
				int var39 = (int) (((long) (var16 * var14 - var13 * var17) << 14) / (long) Rasterizer3D_zoom); // L:
				// 1921
				int var40 = (int) (((long) (var17 * var10 - var11 * var16) << 14) / (long) Rasterizer3D_zoom); // L:
				// 1922
				int var41;
						...
						if (var1 < var2) { // L: 1928
								...
								while (true) {
									...
									if (var1 < 0) {
										while (true) {
											...
											Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0, var5 >> 14, var4 >> 14, var6, var30, var32, var35, var38, var33, var36, var39); // L:
																																																			// 1960
											var5 += var28; // L: 1961
											var4 += var27; // L: 1962
											var6 += var31; // L: 1963
									...
									Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0, var5 >> 14, var3 >> 14, var6, var30, var32, var35, var38, var33, var36, var39); // L:
																																																	// 1950
									var5 += var28; // L: 1951
									var3 += var26; // L: 1952
									var6 += var31; // L: 1953
								...
								while (true) {
									...
									if (var1 < 0) {
										while (true) {
											...
											Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0, var4 >> 14, var5 >> 14, var6, var30, var32, var35, var38, var33, var36, var39); // L:
																																																			// 1986
											var5 += var28; // L: 1987
											var4 += var27; // L: 1988
											var6 += var31; // L: 1989
									...
									Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0, var3 >> 14, var5 >> 14, var6, var30, var32, var35, var38, var33, var36, var39); // L:
																																																	// 1976
									var5 += var28; // L: 1977
									var3 += var26; // L: 1978
									var6 += var31; // L: 1979
							...
							if (var0 != var2 && var28 < var26 || var0 == var2 && var27 > var26) { // L:
								...
								while (true) {
									...
									Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0, var4 >> 14, var3 >> 14, var6, var30, var32, var35, var38, var33, var36, var39); // L:
																																																	// 2020
									var4 += var28; // L: 2021
									var3 += var26; // L: 2022
									var6 += var31; // L: 2023
								...
								while (true) {
									...
									Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0, var3 >> 14, var4 >> 14, var6, var30, var32, var35, var38, var33, var36, var39); // L:
																																																	// 2046
									var4 += var28; // L: 2047
									var3 += var26; // L: 2048
									var6 += var31; // L: 2049
						...
						if (var2 < var0) { // L: 2074
								...
								while (true) {
									...
									if (var2 < 0) {
										while (true) {
											...
											Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1, var5 >> 14, var3 >> 14, var7, var30, var32, var35, var38, var33, var36, var39); // L:
																																																			// 2132
											var3 += var26; // L: 2133
											var5 += var28; // L: 2134
											var7 += var31; // L: 2135
									...
									Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1, var4 >> 14, var3 >> 14, var7, var30, var32, var35, var38, var33, var36, var39); // L:
																																																	// 2122
									var3 += var26; // L: 2123
									var4 += var27; // L: 2124
									var7 += var31; // L: 2125
								...
								while (true) {
									...
									if (var2 < 0) {
										while (true) {
											...
											Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1, var3 >> 14, var5 >> 14, var7, var30, var32, var35, var38, var33, var36, var39); // L:
																																																			// 2106
											var3 += var26; // L: 2107
											var5 += var28; // L: 2108
											var7 += var31; // L: 2109
									...
									Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1, var3 >> 14, var4 >> 14, var7, var30, var32, var35, var38, var33, var36, var39); // L:
																																																	// 2096
									var3 += var26; // L: 2097
									var4 += var27; // L: 2098
									var7 += var31; // L: 2099
							...
							if (var26 < var27) { // L: 2161
								...
								while (true) {
									...
									Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1, var5 >> 14, var4 >> 14, var7, var30, var32, var35, var38, var33, var36, var39); // L:
																																																	// 2166
									var5 += var26; // L: 2167
									var4 += var27; // L: 2168
									var7 += var31; // L: 2169
								...
								while (true) {
									...
									Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1, var4 >> 14, var5 >> 14, var7, var30, var32, var35, var38, var33, var36, var39); // L:
																																																	// 2192
									var5 += var26; // L: 2193
									var4 += var27; // L: 2194
									var7 += var31; // L: 2195
					...
					if (var0 < var1) { // L: 2220
							...
							while (true) {
								...
								if (var0 < 0) {
									while (true) {
										...
										Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2, var4 >> 14, var3 >> 14, var8, var30, var32, var35, var38, var33, var36, var39); // L:
																																																		// 2252
										var4 += var27; // L: 2253
										var3 += var26; // L: 2254
										var8 += var31; // L: 2255
								...
								Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2, var4 >> 14, var5 >> 14, var8, var30, var32, var35, var38, var33, var36, var39); // L:
								// 2242
								var4 += var27; // L: 2243
								var5 += var28; // L: 2244
								var8 += var31; // L: 2245
							...
							while (true) {
								...
								if (var0 < 0) {
									while (true) {
										...
										Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2, var3 >> 14, var4 >> 14, var8, var30, var32, var35, var38, var33, var36, var39); // L:
																																																		// 2278
										var4 += var27; // L: 2279
										var3 += var26; // L: 2280
										var8 += var31; // L: 2281
								...
								Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2, var5 >> 14, var4 >> 14, var8, var30, var32, var35, var38, var33, var36, var39); // L:
								// 2268
								var4 += var27; // L: 2269
								var5 += var28; // L: 2270
								var8 += var31; // L: 2271
						...
						if (var27 < var28) { // L: 2307
							...
							while (true) {
								...
								Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2, var3 >> 14, var5 >> 14, var8, var30, var32, var35, var38, var33, var36, var39); // L:
								// 2312
								var3 += var27; // L: 2313
								var5 += var28; // L: 2314
								var8 += var31; // L: 2315
							...
							while (true) {
								...
								Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2, var5 >> 14, var3 >> 14, var8, var30, var32, var35, var38, var33, var36, var39); // L:
								// 2338
								var3 += var27; // L: 2339
								var5 += var28; // L: 2340
								var8 += var31; // L: 2341
	...
	static final void Rasterizer3D_textureAlpha(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14) {
		...
		if (var5 < var6) { // L: 2370
			...
			if (Rasterizer3D_isLowDetailTexture) { // L: 2374
				...
				var16 = (var21 - var19) / var17 + ((var20 - var18) / var17 << 20); // L:
																					// 2407
				var17 >>= 3; // L: 2408
				var8 <<= 3; // L: 2409
				var15 = var7 >> 8; // L: 2410
				...
				var16 = (var21 - var19) / var17 + ((var20 - var18) / var17 << 18); // L:
																					// 2544
				var17 >>= 3; // L: 2545
				var8 <<= 3; // L: 2546
				var15 = var7 >> 8; // L: 2547
