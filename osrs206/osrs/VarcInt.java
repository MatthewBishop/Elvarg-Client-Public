...
public class VarcInt extends DualNode {
	...
	static int method3411(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.GETWINDOWMODE) { // L: 3754
			Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = class9.getWindowedMode(); // L:
			// 3755
			return 1; // L: 3756
		} else {
			int var3;
			if (var0 == ScriptOpcodes.SETWINDOWMODE) { // L: 3758
				...
				Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = class19.clientPreferences.method2268(); // L:
																																	// 3764
				return 1; // L: 3765
