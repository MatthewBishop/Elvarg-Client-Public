...
public class StructComposition extends DualNode {
	...
	void decodeNext(Buffer var1, int var2) {
		if (var2 == 249) {
			this.params = LoginScreenAnimation.readStringIntParameters(var1, this.params); // L:
																							// 44
		}
	} // L: 46
	...
	static int method3617(int var0, Script var1, boolean var2) {
		...
		if (var0 != ScriptOpcodes.CC_SETOBJECT && var0 != ScriptOpcodes.CC_SETOBJECT_NONUM && var0 != ScriptOpcodes.CC_SETOBJECT_ALWAYS_NUM) { // L:
																																				// 834
			if (var0 == ScriptOpcodes.CC_SETNPCHEAD) { // L: 854
				...
				var3.modelId = class101.localPlayer.appearance.getChatHeadId(); // L:
																				// 861
				return 1; // L: 862
			} else {
				return 2; // L: 864
			...
			int var4 = Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize]; // L:
																							// 836
			int var5 = Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize + 1]; // L:
																								// 837
			var3.itemId = var4; // L: 838
			var3.itemQuantity = var5; // L: 839
			ItemComposition var6 = EnumComposition.ItemDefinition_get(var4); // L:
																				// 840
			...
			} else if (var0 == ScriptOpcodes.CC_SETOBJECT_ALWAYS_NUM | var6.isStackable == 1) { // L:
																								// 848
