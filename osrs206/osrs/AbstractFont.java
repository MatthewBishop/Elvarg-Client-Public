...
public abstract class AbstractFont extends Rasterizer2D {
	...
	AbstractFont(byte[] var1, int[] var2, int[] var3, int[] var4, int[] var5, int[] var6, byte[][] var7) {
		...
		for (int var10 = 0; var10 < 256; ++var10) { // L: 45
			if (this.topBearings[var10] < var8 && this.heights[var10] != 0) { // L:
																				// 46
	...
	void readMetrics(byte[] var1) {
		...
		if (var1.length == 257) { // L: 59
			...
			for (var13 = 0; var13 < 256; ++var13) { // L: 80
				...
				byte var14 = 0; // L: 82
				for (int var9 = 0; var9 < var12[var13].length; ++var9) { // L:
																			// 83
				...
				if (var13 != 32 && var13 != 160) { // L: 90
					for (var8 = 0; var8 < 256; ++var8) { // L: 91
						if (var8 != 32 && var8 != 160) { // L: 92
							this.kerning[var8 + (var13 << 8)] = (byte) method6443(var11, var12, var4, this.advances, var10, var13, var8); // L:
																																			// 93
						}
					}
				}
		...
		if (var1 == null) { // L: 128
			...
			for (int var5 = 0; var5 < var1.length(); ++var5) { // L: 132
				...
				if (var6 == '<') { // L: 134
						...
						if (var7.equals("lt")) { // L: 141
							...
							if (!var7.equals("gt")) { // L: 142
								if (var7.startsWith("img=")) { // L: 143
									try {
										int var8 = FaceNormal.method4344(var7.substring(4)); // L:
																								// 145
										var4 += AbstractFont_modIconSprites[var8].width; // L:
																							// 146
										var3 = -1; // L: 147
					...
					if (var2 == -1) { // L: 155
						var4 += this.advances[(char) (class295.charToByteCp1252(var6) & 255)]; // L:
																								// 156
			...
			for (int var14 = 0; var14 < var13; ++var14) { // L: 176
				...
				if (var15 == '<') { // L: 178
					...
					if (var15 == '>' && var10 != -1) { // L: 182
						String var16 = var1.substring(var10 + 1, var14); // L:
																			// 183
						var10 = -1; // L: 184
						var6.append('<'); // L: 185
						...
						if (var16.equals("br")) { // L: 188
							var3[var12] = var6.toString().substring(var5, var6.length()); // L:
																							// 189
							++var12; // L: 190
							...
							try {
								int var17 = FaceNormal.method4344(var16.substring(4)); // L:
																						// 208
								var4 += AbstractFont_modIconSprites[var17].width; // L:
																					// 209
								var11 = 0; // L: 210
					...
					if (var10 == -1) { // L: 216
						...
						if (var2 != null && var4 > var2[var12 < var2.length ? var12 : var2.length - 1] && var7 >= 0) { // L:
							// 228
							var3[var12] = var6.toString().substring(var5, var7 - var9); // L:
																						// 229
							++var12; // L: 230
							var5 = var7; // L: 231
							var7 = -1; // L: 232
	...
	public int lineWidth(String var1, int var2) {
		int var3 = this.breakLines(var1, new int[]{var2}, AbstractFont_lines); // L:
																				// 249
		int var4 = 0; // L: 250
	...
	public int lineCount(String var1, int var2) {
		return this.breakLines(var1, new int[]{var2}, AbstractFont_lines); // L:
																			// 259
	}
	...
	public Bounds method6372(int var1, int var2, String var3, int var4, int var5) {
		if (var3 != null && var3.length() >= var2 + var1) { // L: 280
			...
			int var8 = this.stringWidth(var3.substring(var1, var2 + var1)); // L:
																			// 286
	...
	public int drawLines(String var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
		if (var1 == null) { // L: 317
			...
			if (var5 < var10 + this.maxAscent + this.maxDescent && var5 < var10 + var10) { // L:
																							// 321
				var11 = null;
			}
			int var12 = this.breakLines(var1, var11, AbstractFont_lines); // L:
																			// 322
			...
			if (var9 == 0) { // L: 325
				...
				var14 = (var5 - this.maxAscent - this.maxDescent - var10 * (var12 - 1)) / (var12 + 1); // L:
																										// 329
				if (var14 < 0) { // L: 330
					var14 = 0;
				}
			...
			for (var14 = 0; var14 < var12; ++var14) { // L: 334
				if (var8 == 0) {
					this.draw0(AbstractFont_lines[var14], var2, var13); // L:
																		// 335
					...
					this.calculateLineJustification(AbstractFont_lines[var14], var4); // L:
																						// 341
					this.draw0(AbstractFont_lines[var14], var2, var13); // L:
																		// 342
	...
	public void drawCenteredWave(String var1, int var2, int var3, int var4, int var5, int var6) {
		if (var1 != null) { // L: 352
			...
			this.drawWithOffsets0(var1, var2 - this.stringWidth(var1) / 2, var3, (int[]) null, var7); // L:
																										// 356
		}
	} // L: 357
	public void drawCenteredWave2(String var1, int var2, int var3, int var4, int var5, int var6) {
		if (var1 != null) { // L: 360
			...
			for (int var9 = 0; var9 < var1.length(); ++var9) { // L: 364
				var7[var9] = (int) (Math.sin((double) var9 / 5.0D + (double) var6 / 5.0D) * 5.0D); // L:
																									// 365
				var8[var9] = (int) (Math.sin((double) var9 / 3.0D + (double) var6 / 5.0D) * 5.0D); // L:
																									// 366
			}
			this.drawWithOffsets0(var1, var2 - this.stringWidth(var1) / 2, var3, var7, var8); // L:
																								// 368
		}
	} // L: 369
	public void drawCenteredShake(String var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		if (var1 != null) { // L: 372
			...
			this.drawWithOffsets0(var1, var2 - this.stringWidth(var1) / 2, var3, (int[]) null, var10); // L:
																										// 378
		}
	} // L: 379
	public void drawRandomAlphaAndSpacing(String var1, int var2, int var3, int var4, int var5, int var6) {
		if (var1 != null) { // L: 382
			...
			AbstractFont_alpha = 192 + (AbstractFont_random.nextInt() & 31); // L:
																				// 385
			...
			this.drawWithOffsets0(var1, var2, var3, var7, (int[]) null); // L:
																			// 392
		}
	} // L: 393
	...
	void draw0(String var1, int var2, int var3) {
		...
		for (int var6 = 0; var6 < var1.length(); ++var6) { // L: 439
			if (var1.charAt(var6) != 0) { // L: 440
				char var7 = (char) (class295.charToByteCp1252(var1.charAt(var6)) & 255); // L:
																							// 441
				if (var7 == '<') { // L: 442
					var4 = var6; // L: 443
				} else {
						...
						if (var8.equals("lt")) { // L: 449
							...
							if (!var8.equals("gt")) { // L: 450
								if (var8.startsWith("img=")) { // L: 451
									try {
										var9 = FaceNormal.method4344(var8.substring(4)); // L:
																							// 453
										IndexedSprite var10 = AbstractFont_modIconSprites[var9]; // L:
																									// 454
										var10.drawAt(var2, var3 + this.ascent - var10.height); // L:
																								// 455
					...
					if (var4 == -1) { // L: 468
						...
						if (var7 != ' ') { // L: 472
							if (AbstractFont_alpha == 256) { // L: 473
								...
								this.drawGlyph(this.pixels[var7], var2 + this.leftBearings[var7], var3 + this.topBearings[var7], var12, var9, AbstractFont_color); // L:
																																									// 475
							} else {
								...
								this.drawGlyphAlpha(this.pixels[var7], var2 + this.leftBearings[var7], var3 + this.topBearings[var7], var12, var9, AbstractFont_color, AbstractFont_alpha); // L:
																																															// 479
							}
						} else if (AbstractFont_justificationTotal > 0) { // L:
																			// 483
							AbstractFont_justificationCurrent += AbstractFont_justificationTotal; // L:
																									// 484
							var2 += AbstractFont_justificationCurrent >> 8; // L:
																			// 485
	...
	void drawWithOffsets0(String var1, int var2, int var3, int[] var4, int[] var5) {
		...
		for (int var9 = 0; var9 < var1.length(); ++var9) { // L: 503
			if (var1.charAt(var9) != 0) { // L: 504
				char var10 = (char) (class295.charToByteCp1252(var1.charAt(var9)) & 255); // L:
																							// 505
				if (var10 == '<') { // L: 506
					var6 = var9; // L: 507
				} else {
							...
							if (!var11.equals("gt")) { // L: 514
								if (var11.startsWith("img=")) { // L: 515
									try {
										...
										++var8; // L: 523
										var14 = FaceNormal.method4344(var11.substring(4)); // L:
																							// 524
										IndexedSprite var15 = AbstractFont_modIconSprites[var14]; // L:
																									// 525
										var15.drawAt(var12 + var2, var13 + (var3 + this.ascent - var15.height)); // L:
										// 526
					...
					if (var6 == -1) { // L: 539
						...
						if (var10 != ' ') { // L: 550
							if (AbstractFont_alpha == 256) { // L: 551
								...
								this.drawGlyph(this.pixels[var10], var13 + var2 + this.leftBearings[var10], var3 + var14 + this.topBearings[var10], var17, var12, AbstractFont_color); // L:
								// 553
							} else {
								...
								this.drawGlyphAlpha(this.pixels[var10], var13 + var2 + this.leftBearings[var10], var3 + var14 + this.topBearings[var10], var17, var12, AbstractFont_color, AbstractFont_alpha); // L:
																																																				// 557
							}
						} else if (AbstractFont_justificationTotal > 0) { // L:
																			// 561
	...
	static void AbstractFont_drawGlyph(byte[] var0, int var1, int var2, int var3, int var4, int var5) {
		...
		if (var3 > 0 && var4 > 0) { // L: 607
			AbstractFont_placeGlyph(Rasterizer2D.Rasterizer2D_pixels, var0, var5, var9, var6, var3, var4, var7, var8); // L:
			// 608
		}
	} // L: 609
	...
	static void AbstractFont_drawGlyphAlpha(byte[] var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		...
		if (var3 > 0 && var4 > 0) { // L: 662
			AbstractFont_placeGlyphAlpha(Rasterizer2D.Rasterizer2D_pixels, var0, var5, var10, var7, var3, var4, var8, var9, var6); // L:
																																	// 663
		}
	} // L: 664
	static void AbstractFont_placeGlyphAlpha(int[] var0, byte[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9) {
		var2 = ((var2 & 65280) * var9 & 16711680) + (var9 * (var2 & 16711935) & -16711936) >> 8; // L:
																									// 667
		var9 = 256 - var9; // L: 668
		for (int var10 = -var6; var10 < 0; ++var10) { // L: 669
			for (int var11 = -var5; var11 < 0; ++var11) { // L: 670
				if (var1[var3++] != 0) { // L: 671
					...
					var0[var4++] = (((var12 & 65280) * var9 & 16711680) + ((var12 & 16711935) * var9 & -16711936) >> 8) + var2; // L:
																																// 673
				} else {
					++var4; // L: 675
				}
