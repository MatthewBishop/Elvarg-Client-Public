...
public class class432 implements MouseWheel {
	...
	static void method7572() {
		if (class360.javaVendor.toLowerCase().indexOf("microsoft") != -1) { // L:
																			// 124
	...
	static SpritePixels method7578(int var0, int var1, int var2) {
		DemotingHashTable var3 = WorldMapRegion.WorldMapRegion_cachedSprites; // L:
																				// 38
	...
	static void method7576(int var0, byte[] var1, ArchiveDisk var2) {
		...
		synchronized (ArchiveDiskActionHandler.ArchiveDiskActionHandler_requestQueue) { // L:
																						// 23
			ArchiveDiskActionHandler.ArchiveDiskActionHandler_requestQueue.addFirst(var3); // L:
																							// 24
		} // L: 25
	...
	public static WorldMapElement WorldMapElement_get(int var0) {
		return var0 >= 0 && var0 < WorldMapElement.WorldMapElement_cached.length && WorldMapElement.WorldMapElement_cached[var0] != null ? WorldMapElement.WorldMapElement_cached[var0] : new WorldMapElement(var0); // L:
																																																						// 62
																																																						// 63
	}
