...
final public class GrandExchangeOfferUnitPriceComparator implements Comparator {
	
	int compare_bridged(GrandExchangeEvent var1, GrandExchangeEvent var2) {
		return var1.grandExchangeOffer.unitPrice < var2.grandExchangeOffer.unitPrice ? -1 : (var2.grandExchangeOffer.unitPrice == var1.grandExchangeOffer.unitPrice ? 0 : 1); // L:
																																												// 43
	}
	...
	static boolean method6031() {
		...
		try {
			...
			GraphicsObject.method1877("Date not valid.", "Please ensure date follows the format", "DD/MM/YYYY and is after 01/01/1900"); // L:
																																			// 1080
			return false; // L: 1081
		}
		if (var0 == null) { // L: 1083
			...
			java.util.Calendar var2 = java.util.Calendar.getInstance(); // L:
																		// 1088
			...
			if (!var7) { // L: 1105
				...
				if (!var5) { // L: 1109
					...
					class174.field1891 = (int) (var0.getTime() / 86400000L - 11745L); // L:
																						// 1113
				}
				return true; // L: 1115
			}
		...
		if (var1 > Client.npcCount) { // L: 8015
			...
			for (var2 = 0; var2 < var1; ++var2) { // L: 8017
				...
				if (var5 == 0) { // L: 8021
					...
					if (var6 == 0) { // L: 8027
						Client.npcIndices[++Client.npcCount - 1] = var3; // L:
																			// 8028
						var4.npcCycle = Client.cycle; // L: 8029
						Client.field539[++Client.field538 - 1] = var3; // L:
																		// 8030
					} else {
						int var7;
						int var8;
						if (var6 == 1) { // L: 8033
							...
							var4.method2361(var7, class192.field2212); // L:
																		// 8037
							...
							if (var0.readBits(1) == 1) { // L: 8045
								...
								var4.method2361(var7, class192.field2211); // L:
																			// 8047
								var8 = var0.readBits(3); // L: 8048
								var4.method2361(var8, class192.field2211); // L:
																			// 8049
							} else {
								var7 = var0.readBits(3); // L: 8052
								var4.method2361(var7, class192.field2209); // L:
																			// 8053
							}
							...
							Client.field616[++Client.field615 - 1] = var3; // L:
																			// 8060
						}
					}
				}
