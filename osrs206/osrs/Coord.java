...
public class Coord {
	...
	String toString(String var1) {
		return this.plane + var1 + (this.x >> 6) + var1 + (this.y >> 6) + var1 + (this.x & 63) + var1 + (this.y & 63); // L:
		// 64
	}
	public boolean equals(Object var1) {
		if (this == var1) { // L: 42
			...
			return !(var1 instanceof Coord) ? false : this.equalsCoord((Coord) var1); // L:
																						// 43
																						// 44
		}
	}
	...
	static void method5549(int var0, String var1) {
		...
		Username var5 = new Username(var1, HealthBarDefinition.loginType); // L:
																			// 9517
		for (int var6 = 0; var6 < var2; ++var6) { // L: 9518
			Player var7 = Client.players[var3[var6]]; // L: 9519
			if (var7 != null && var7 != class101.localPlayer && var7.username != null && var7.username.equals(var5)) { // L:
				// 9520
				PacketBufferNode var8;
				if (var0 == 1) { // L: 9521
					var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2970, Client.packetWriter.isaacCipher); // L:
					// 9523
					...
					var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2991, Client.packetWriter.isaacCipher); // L:
					// 9530
					...
					var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2965, Client.packetWriter.isaacCipher); // L:
					// 9537
					...
					var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2947, Client.packetWriter.isaacCipher); // L:
					// 9544
