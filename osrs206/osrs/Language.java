...
public class Language implements MouseWheel {
	...
	final int id;
	static {
		Language_EN = new Language("EN", "en", "English", ModeWhere.field4106, 0, "GB"); // L:
																							// 12
		Language_DE = new Language("DE", "de", "German", ModeWhere.field4106, 1, "DE"); // L:
																						// 13
		Language_FR = new Language("FR", "fr", "French", ModeWhere.field4106, 2, "FR"); // L:
																						// 14
		Language_PT = new Language("PT", "pt", "Portuguese", ModeWhere.field4106, 3, "BR"); // L:
																							// 15
		Language_NL = new Language("NL", "nl", "Dutch", ModeWhere.field4105, 4, "NL"); // L:
																						// 16
		Language_ES = new Language("ES", "es", "Spanish", ModeWhere.field4105, 5, "ES"); // L:
																							// 17
		Language_ES_MX = new Language("ES_MX", "es-mx", "Spanish (Latin American)", ModeWhere.field4106, 6, "MX"); // L:
		// 18
	...
	static Language[] method6069() {
		return new Language[]{Language_NL, Language_ES, Language_ES_MX, Language_DE, Language_FR, Language_EN, Language_PT}; // L:
																																// 42
	}
	...
	static int method6068(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.ADD) { // L: 3049
			...
			var4 = Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize + 1]; // L:
																							// 3052
			Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = var3 + var4; // L:
																										// 3053
			return 1; // L: 3054
			...
			var4 = Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize + 1]; // L:
																							// 3066
			Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = var4 * var3; // L:
																										// 3067
			return 1; // L: 3068
			...
			var3 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]; // L:
																							// 3078
			Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = (int) (Math.random() * (double) var3); // L:
																																// 3079
			return 1; // L: 3080
		} else if (var0 == ScriptOpcodes.RANDOMINC) { // L: 3082
			var3 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]; // L:
																							// 3083
			Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = (int) (Math.random() * (double) (var3 + 1)); // L:
																																		// 3084
			return 1; // L: 3085
		} else {
			int var5;
			...
			if (var0 == ScriptOpcodes.INTERPOLATE) { // L: 3087
				...
				var5 = Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize + 2]; // L:
																								// 3091
				var6 = Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize + 3]; // L:
																								// 3092
				var7 = Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize + 4]; // L:
																								// 3093
				Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = var3 + (var7 - var5) * (var4 - var3) / (var6 - var5); // L:
																																					// 3094
				return 1; // L: 3095
				...
				var4 = Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize + 1]; // L:
																								// 3100
				Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = var3 + var4 * var3 / 100; // L:
				// 3101
				return 1; // L: 3102
				...
				var4 = Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize + 1]; // L:
																								// 3107
				Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = var3 | 1 << var4; // L:
																												// 3108
				return 1; // L: 3109
				...
				var4 = Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize + 1]; // L:
																								// 3114
				Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = var3 & -1 - (1 << var4); // L:
				// 3115
				return 1; // L: 3116
				...
				var4 = Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize + 1]; // L:
																								// 3121
				Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = (var3 & 1 << var4) != 0 ? 1 : 0; // L:
																																// 3122
				return 1; // L: 3123
				...
				if (var3 == 0) { // L: 3136
					...
					Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = (int) Math.pow((double) var3, (double) var4); // L:
																																				// 3137
				}
				return 1; // L: 3138
				...
				if (var3 == 0) { // L: 3144
					...
					switch (var4) { // L: 3148
						case 0 :
							Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = Integer.MAX_VALUE; // L:
							// 3161
							break; // L: 3162
						case 1 :
							Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = var3; // L:
																												// 3151
							break;
						case 2 :
							Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = (int) Math.sqrt((double) var3); // L:
																																		// 3156
							break; // L: 3157
						case 3 :
							Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = (int) Math.cbrt((double) var3); // L:
																																		// 3176
							break;
						case 4 :
							Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = (int) Math.sqrt(Math.sqrt((double) var3)); // L:
																																					// 3166
							break; // L: 3167
						default :
							Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = (int) Math.pow((double) var3, 1.0D / (double) var4); // L:
																																								// 3171
					}
					return 1; // L: 3180
				}
				...
				long var9 = (long) Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize]; // L:
																										// 3198
				long var11 = (long) Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize + 1]; // L:
																												// 3199
				long var13 = (long) Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize + 2]; // L:
																												// 3200
				Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = (int) (var9 * var13 / var11); // L:
																															// 3201
				return 1; // L: 3202
			} else if (var0 == ScriptOpcodes.BITCOUNT) { // L: 3204
				var3 = Equations.numberOfBits(Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]); // L:
				// 3205
				Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = var3; // L:
																									// 3206
				return 1; // L: 3207
				...
				var5 = Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize + 2]; // L:
																								// 3220
				Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = class17.method232(var3, var4, var5); // L:
																																	// 3221
				return 1; // L: 3222
				...
				var5 = Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize + 2]; // L:
																								// 3228
				Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = class137.method2931(var3, var4, var5); // L:
																																	// 3229
				return 1; // L: 3230
				...
				var5 = Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize + 2]; // L:
																								// 3236
				var6 = 31 - var5; // L: 3237
				Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = var3 << var6 >>> var4 + var6; // L:
																															// 3238
				return 1; // L: 3239
				...
				Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = var3 | var4 << var5; // L:
				// 3250
				return 1; // L: 3251
			} else if (var0 == 4032) { // L: 3253
				Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize - 1] = ClanMate.method6650(Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize - 1]); // L:
																																														// 3254
				return 1; // L: 3255
			} else if (var0 == 4033) { // L: 3257
				Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize - 1] = class155.method3194(Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize - 1]); // L:
																																														// 3258
				return 1; // L: 3259
				...
				Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize - 1] = Math.abs(Interpreter.Interpreter_intStack[class446.Interpreter_intStackSize - 1]); // L:
																																												// 3270
				return 1; // L: 3271
			} else {
				return 2; // L: 3273
	...
	static final InterfaceParent method6063(int var0, int var1, int var2) {
		...
		BufferedNetSocket.revalidateWidgetScroll(_Junk.Widget_interfaceComponents[var0 >> 16], var4, false); // L:
		// 12005
