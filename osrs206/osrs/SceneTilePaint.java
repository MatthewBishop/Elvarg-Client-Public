...
public final class SceneTilePaint {
		...
		for (int var5 = 0; var5 < var2; ++var5) { // L: 116
			...
			if (var6 != 0) { // L: 118
				if (var6 >= 128 && var6 < 160) { // L: 119
					char var7 = class340.cp1252AsciiExtension[var6 - 128]; // L:
																			// 120
					if (var7 == 0) { // L: 121
						var7 = '?';
					}
	...
	static final int getTileHeight(int var0, int var1, int var2) {
		...
		if (var3 >= 0 && var4 >= 0 && var3 <= 103 && var4 <= 103) { // L: 5464
			...
			if (var2 < 3 && (Tiles.Tiles_renderFlags[1][var3][var4] & 2) == 2) { // L:
																					// 5466
				var5 = var2 + 1;
			}
			int var6 = var0 & 127; // L: 5467
			int var7 = var1 & 127; // L: 5468
			int var8 = Tiles.Tiles_heights[var5][var3 + 1][var4] * var6 + (128 - var6) * Tiles.Tiles_heights[var5][var3][var4] >> 7; // L:
																																		// 5469
			int var9 = var6 * Tiles.Tiles_heights[var5][var3 + 1][var4 + 1] + Tiles.Tiles_heights[var5][var3][var4 + 1] * (128 - var6) >> 7; // L:
																																				// 5470
	...
	static final void method4530(int var0, int var1, boolean var2) {
		if (Client.currentClanChannels[var0] != null) { // L: 12276
			if (var1 >= 0 && var1 < Client.currentClanChannels[var0].method3113()) { // L:
																						// 12277
				ClanChannelMember var3 = (ClanChannelMember) Client.currentClanChannels[var0].members.get(var1); // L:
				// 12278
				PacketBufferNode var4 = EnumComposition.getPacketBufferNode(ClientPacket.field2960, Client.packetWriter.isaacCipher); // L:
																																		// 12279
				var4.packetBuffer.writeByte(4 + ScriptEvent.stringCp1252NullTerminatedByteSize(var3.username.getName())); // L:
				// 12280
				...
				var4.packetBuffer.writeStringCp1252NullTerminated(var3.username.getName()); // L:
																							// 12284
