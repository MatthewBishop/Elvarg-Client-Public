...
public final class NPC extends Actor {
	...
	protected final Model getModel() {
		if (this.definition == null) { // L: 96
			...
			Anim_SequenceDefinition var1 = super.sequence != -1 && super.sequenceDelay == 0 ? Anim_SequenceDefinition.SequenceDefinition_get(super.sequence) : null; // L:
																																					// 97
			Anim_SequenceDefinition var2 = super.movementSequence == -1 || super.movementSequence == super.idleSequence && var1 != null ? null : Anim_SequenceDefinition.SequenceDefinition_get(super.movementSequence); // L:
																																																		// 98
			Model var3 = this.definition.getModel(var1, super.sequenceFrame, var2, super.movementFrame); // L:
																											// 99
			if (var3 == null) { // L: 100
				return null;
			} else {
				...
				if (super.spotAnimation != -1 && super.spotAnimationFrame != -1) { // L:
																					// 103
					Model var4 = _Junk.SpotAnimationDefinition_get(super.spotAnimation).getModel(super.spotAnimationFrame); // L:
																																	// 104
					if (var4 != null) { // L: 105
	...
	final void method2362(int var1, int var2, boolean var3) {
		if (super.sequence != -1 && Anim_SequenceDefinition.SequenceDefinition_get(super.sequence).field2188 == 1) {
			super.sequence = -1;
		}
		if (!var3) {
			...
			if (var4 >= -8 && var4 <= 8 && var5 >= -8 && var5 <= 8) { // L: 73
				...
				for (int var6 = super.pathLength; var6 > 0; --var6) { // L: 75
					...
					super.pathTraversed[var6] = super.pathTraversed[var6 - 1]; // L:
																				// 78
				}
	...
	public static String method2382(long var0) {
		...
		return Calendar.DAYS_OF_THE_WEEK[var2 - 1] + ", " + var3 / 10 + var3 % 10 + "-" + Calendar.MONTH_NAMES_ENGLISH_GERMAN[0][var4] + "-" + var5 + " " + var6 / 10 + var6 % 10 + ":" + var7 / 10 + var7 % 10 + ":" + var8 / 10 + var8 % 10 + " GMT"; // L:
																																																														// 39
	}
