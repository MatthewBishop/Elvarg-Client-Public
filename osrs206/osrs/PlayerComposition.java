...
public class PlayerComposition {
	...
	public void changeAppearance(int var1, boolean var2) {
		if (var1 != 1 || !this.isFemale) {
			...
			if (var3 != 0) { // L: 58
				...
				} while (var4 == null || var4.nonSelectable || (this.isFemale ? 7 : 0) + var1 != var4.bodypartID); // L:
				// 70
	...
	public Model getModel(Anim_SequenceDefinition var1, int var2, Anim_SequenceDefinition var3, int var4) {
		if (this.npcTransformId != -1) {
			return BuddyRankComparator.getNpcDefinition(this.npcTransformId).getModel(var1, var2, var3, var4); // L:
																												// 155
		} else {
			long var5 = this.hash;
			int[] var7 = this.equipment;
			if (var1 != null && (var1.shield >= 0 || var1.weapon >= 0)) { // L:
																			// 159
				var7 = new int[12];
				...
				if (var1.shield >= 0) {
					var5 += (long) (var1.shield - this.equipment[5] << 40); // L:
																			// 163
			...
			if (var18 == null) {
				...
				for (int var10 = 0; var10 < 12; ++var10) { // L: 174
					...
					if (var11 >= 256 && var11 < 512 && !SecureRandomFuture.KitDefinition_get(var11 - 256).ready()) { // L:
						// 176
						// 177
						var9 = true;
					}
					if (var11 >= 512 && !EnumComposition.ItemDefinition_get(var11 - 512).hasNoValidModel(this.isFemale)) { // L:
						// 179
						// 180
						var9 = true;
					}
				...
				if (var18 == null) { // L: 187
					...
					for (int var12 = 0; var12 < 12; ++var12) { // L: 190
						...
						if (var13 >= 256 && var13 < 512) { // L: 192
							ModelData var14 = SecureRandomFuture.KitDefinition_get(var13 - 256).getModelData(); // L:
							// 193
							if (var14 != null) { // L: 194
								var19[var11++] = var14;
							}
						...
						if (var13 >= 512) { // L: 196
							ItemComposition var22 = EnumComposition.ItemDefinition_get(var13 - 512); // L:
																										// 197
							ModelData var15 = var22.method3721(this.isFemale); // L:
																				// 198
							if (var15 != null) { // L: 199
								if (this.field3339 != null) { // L: 200
									class167 var16 = this.field3339[var12]; // L:
																			// 201
									if (var16 != null) { // L: 202
										int var17;
										if (var16.field1814 != null && var22.recolorFrom != null && var22.recolorTo.length == var16.field1814.length) { // L:
																																						// 203
											for (var17 = 0; var17 < var22.recolorFrom.length; ++var17) { // L:
																											// 204
												var15.recolor(var22.recolorTo[var17], var16.field1814[var17]); // L:
																												// 205
											}
										}
										if (var16.field1815 != null && var22.retextureFrom != null && var16.field1815.length == var22.retextureTo.length) { // L:
																																							// 208
											for (var17 = 0; var17 < var22.retextureFrom.length; ++var17) { // L:
																											// 209
												var15.retexture(var22.retextureTo[var17], var16.field1815[var17]); // L:
												// 210
											}
										}
									}
					...
					for (var13 = 0; var13 < 5; ++var13) { // L: 220
						if (this.bodyColors[var13] < field3342[var13].length) { // L:
																				// 221
							var20.recolor(field3343[var13], field3342[var13][this.bodyColors[var13]]);
						}
						if (this.bodyColors[var13] < field3334[var13].length) { // L:
																				// 222
	...
	ModelData getModelData() {
		if (this.npcTransformId != -1) { // L: 238
			return BuddyRankComparator.getNpcDefinition(this.npcTransformId).getModelData(); // L:
																								// 239
		} else {
			...
			for (int var2 = 0; var2 < 12; ++var2) { // L: 242
				...
				if (var3 >= 256 && var3 < 512 && !SecureRandomFuture.KitDefinition_get(var3 - 256).method3417()) { // L:
					// 244
					// 245
					var1 = true;
				}
				if (var3 >= 512 && !EnumComposition.ItemDefinition_get(var3 - 512).method3746(this.isFemale)) { // L:
					// 247
					// 248
					var1 = true;
				}
			...
			if (var1) { // L: 251
				...
				for (int var4 = 0; var4 < 12; ++var4) { // L: 254
					...
					if (var5 >= 256 && var5 < 512) { // L: 256
						var6 = SecureRandomFuture.KitDefinition_get(var5 - 256).getKitDefinitionModels(); // L:
																											// 257
						if (var6 != null) { // L: 258
							var7[var3++] = var6;
						}
					...
					if (var5 >= 512) { // L: 260
						var6 = EnumComposition.ItemDefinition_get(var5 - 512).method3723(this.isFemale); // L:
																											// 261
						if (var6 != null) { // L: 262
							var7[var3++] = var6;
						}
				...
				for (var5 = 0; var5 < 5; ++var5) { // L: 266
					if (this.bodyColors[var5] < field3342[var5].length) { // L:
																			// 267
						var8.recolor(field3343[var5], field3342[var5][this.bodyColors[var5]]);
					}
					if (this.bodyColors[var5] < field3334[var5].length) { // L:
																			// 268
	...
	public int getChatHeadId() {
		return this.npcTransformId == -1 ? (this.equipment[0] << 15) + this.equipment[1] + (this.equipment[11] << 5) + (this.equipment[8] << 10) + (this.bodyColors[0] << 25) + (this.bodyColors[4] << 20) : 305419896 + BuddyRankComparator.getNpcDefinition(this.npcTransformId).id; // L:
																																																																						// 274
																																																																						// 275
	}
	
	public static PacketBufferNode method5600(int var0, String var1, Language var2, int var3) {
		PacketBufferNode var4 = EnumComposition.getPacketBufferNode(ClientPacket.field2973, Client.packetWriter.isaacCipher); // L:
																																// 17
		...
		_Junk.method720(var4.packetBuffer, var1); // L: 167
