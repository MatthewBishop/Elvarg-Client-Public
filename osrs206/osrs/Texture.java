...
public class Texture extends Node {
	...
	boolean load(double var1, int var3, AbstractArchive var4) {
		...
		for (int var6 = 0; var6 < this.fileIds.length; ++var6) { // L: 58
			IndexedSprite var7 = AbstractSocket.method6819(var4, this.fileIds[var6]); // L:
																						// 59
			var7.normalize(); // L: 60
			...
			if ((var10 & -16777216) == 50331648) { // L: 66
				...
				for (var13 = 0; var13 < var9.length; ++var13) { // L: 69
					...
					if (var14 >> 8 == (var14 & 65535)) { // L: 71
						var14 &= 255; // L: 72
						var9[var13] = var11 * var14 >> 8 & 16711935 | var12 * var14 & 65280; // L:
																								// 73
					}
				}
			}
	...
	void animate(int var1) {
		if (this.pixels != null) { // L: 113
			...
			int var7;
			int[] var10;
			if (this.animationDirection == 1 || this.animationDirection == 3) { // L:
																				// 114
				if (Texture_animatedPixels == null || Texture_animatedPixels.length < this.pixels.length) { // L:
																											// 115
			...
			if (this.animationDirection == 2 || this.animationDirection == 4) { // L:
																				// 131
				if (Texture_animatedPixels == null || Texture_animatedPixels.length < this.pixels.length) { // L:
																											// 132
					Texture_animatedPixels = new int[this.pixels.length];
				...
				for (var6 = 0; var6 < var3; var6 += var2) { // L: 140
					for (var7 = 0; var7 < var2; ++var7) { // L: 141
						...
						Texture_animatedPixels[var8] = this.pixels[var9]; // L:
																			// 144
					}
				}
