...
public class class151 extends class144 {
	...
	static void method3136(GameEngine var0) {
		while (class18.isKeyDown()) { // L: 1835
			if (_Junk.field3196 == 13) { // L: 1836
				Tiles.method2021(); // L: 1837
				return; // L: 1838
			}
			if (_Junk.field3196 == 96) { // L: 1840
				if (Login.worldSelectPage > 0 && class266.worldSelectLeftSprite != null) { // L:
																							// 1841
					--Login.worldSelectPage; // L: 1842
				}
			} else if (_Junk.field3196 == 97 && Login.worldSelectPage < Login.worldSelectPagesCount && SceneTilePaint.worldSelectRightSprite != null) { // L:
																																							// 1845
																																							// 1846
		...
		if (MouseHandler.MouseHandler_lastButton == 1 || !Static.mouseCam && MouseHandler.MouseHandler_lastButton == 4) { // L:
			...
			if (MouseHandler.MouseHandler_lastPressedX >= var1 && MouseHandler.MouseHandler_lastPressedX <= var1 + 14 && MouseHandler.MouseHandler_lastPressedY >= 4 && MouseHandler.MouseHandler_lastPressedY <= 18) { // L:
				// 1853
				ReflectionCheck.changeWorldSelectSorting(0, 0); // L: 1854
				return; // L: 1855
			}
			if (MouseHandler.MouseHandler_lastPressedX >= var1 + 15 && MouseHandler.MouseHandler_lastPressedX <= var1 + 80 && MouseHandler.MouseHandler_lastPressedY >= 4 && MouseHandler.MouseHandler_lastPressedY <= 18) { // L:
				// 1857
				ReflectionCheck.changeWorldSelectSorting(0, 1); // L: 1858
				return; // L: 1859
			}
			int var2 = Login.xPadding + 390; // L: 1861
			if (MouseHandler.MouseHandler_lastPressedX >= var2 && MouseHandler.MouseHandler_lastPressedX <= var2 + 14 && MouseHandler.MouseHandler_lastPressedY >= 4 && MouseHandler.MouseHandler_lastPressedY <= 18) { // L:
				// 1862
				ReflectionCheck.changeWorldSelectSorting(1, 0); // L: 1863
				return; // L: 1864
			}
			if (MouseHandler.MouseHandler_lastPressedX >= var2 + 15 && MouseHandler.MouseHandler_lastPressedX <= var2 + 80 && MouseHandler.MouseHandler_lastPressedY >= 4 && MouseHandler.MouseHandler_lastPressedY <= 18) { // L:
				// 1866
				ReflectionCheck.changeWorldSelectSorting(1, 1); // L: 1867
				return; // L: 1868
			}
			int var3 = Login.xPadding + 500; // L: 1870
			if (MouseHandler.MouseHandler_lastPressedX >= var3 && MouseHandler.MouseHandler_lastPressedX <= var3 + 14 && MouseHandler.MouseHandler_lastPressedY >= 4 && MouseHandler.MouseHandler_lastPressedY <= 18) { // L:
				// 1871
				ReflectionCheck.changeWorldSelectSorting(2, 0); // L: 1872
				return; // L: 1873
			}
			if (MouseHandler.MouseHandler_lastPressedX >= var3 + 15 && MouseHandler.MouseHandler_lastPressedX <= var3 + 80 && MouseHandler.MouseHandler_lastPressedY >= 4 && MouseHandler.MouseHandler_lastPressedY <= 18) { // L:
				// 1875
				ReflectionCheck.changeWorldSelectSorting(2, 1); // L: 1876
				return; // L: 1877
			}
			int var4 = Login.xPadding + 610; // L: 1879
			if (MouseHandler.MouseHandler_lastPressedX >= var4 && MouseHandler.MouseHandler_lastPressedX <= var4 + 14 && MouseHandler.MouseHandler_lastPressedY >= 4 && MouseHandler.MouseHandler_lastPressedY <= 18) { // L:
				// 1880
				ReflectionCheck.changeWorldSelectSorting(3, 0); // L: 1881
				return; // L: 1882
			}
			if (MouseHandler.MouseHandler_lastPressedX >= var4 + 15 && MouseHandler.MouseHandler_lastPressedX <= var4 + 80 && MouseHandler.MouseHandler_lastPressedY >= 4 && MouseHandler.MouseHandler_lastPressedY <= 18) { // L:
				// 1884
				ReflectionCheck.changeWorldSelectSorting(3, 1); // L: 1885
				return; // L: 1886
			}
			if (MouseHandler.MouseHandler_lastPressedX >= Login.xPadding + 708 && MouseHandler.MouseHandler_lastPressedY >= 4 && MouseHandler.MouseHandler_lastPressedX <= Login.xPadding + 708 + 50 && MouseHandler.MouseHandler_lastPressedY <= 20) { // L:
																																																														// 1888
				Tiles.method2021(); // L: 1889
				return; // L: 1890
			}
			if (Login.hoveredWorldIndex != -1) { // L: 1892
				World var5 = class362.World_worlds[Login.hoveredWorldIndex]; // L:
																				// 1893
				class295.changeWorld(var5); // L: 1894
				Tiles.method2021(); // L: 1895
				return; // L: 1896
			}
			if (Login.worldSelectPage > 0 && class266.worldSelectLeftSprite != null && MouseHandler.MouseHandler_lastPressedX >= 0 && MouseHandler.MouseHandler_lastPressedX <= class266.worldSelectLeftSprite.subWidth && MouseHandler.MouseHandler_lastPressedY >= class78.canvasHeight / 2 - 50 && MouseHandler.MouseHandler_lastPressedY <= class78.canvasHeight / 2 + 50) { // L:
																																																																																													// 1898
	...
	static final void method3146(PendingSpawn var0) {
		...
		if (0L != var1) { // L: 7803
			int var6 = class356.scene.getObjectFlags(var0.plane, var0.x, var0.y, var1); // L:
																						// 7804
			var3 = _Junk.Entity_unpackID(var1); // L: 7805
			var4 = var6 & 31; // L: 7806
