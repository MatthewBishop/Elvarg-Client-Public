...
public class class353 {
	...
	static int method6506(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.IF_GETINVOBJECT) { // L: 1420
			...
			int var5 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]; // L:
																								// 1432
			InterfaceParent var4 = (InterfaceParent) Client.interfaceParents.get((long) var5); // L:
																								// 1433
			if (var4 != null) { // L: 1434
			...
			Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = Client.rootInterface; // L:
																												// 1439
			return 1; // L: 1440
