...
public class WorldMap {
	...
	public void init(AbstractArchive var1, AbstractArchive var2, AbstractArchive var3, Font var4, HashMap var5, IndexedSprite[] var6) {
		...
		this.fonts.put(WorldMapLabelSize.WorldMapLabelSize_small, var5.get(fontNameVerdana11)); // L:
																								// 111
		this.fonts.put(WorldMapLabelSize.WorldMapLabelSize_medium, var5.get(fontNameVerdana13)); // L:
																									// 112
		this.fonts.put(WorldMapLabelSize.WorldMapLabelSize_large, var5.get(fontNameVerdana15)); // L:
																								// 113
		this.cacheLoader = new WorldMapArchiveLoader(var1); // L: 114
		int var7 = this.WorldMap_archive.getGroupId(WorldMapCacheName.field2867.name); // L:
																						// 115
		...
		for (int var9 = 0; var9 < var8.length; ++var9) { // L: 118
			Buffer var10 = new Buffer(this.WorldMap_archive.takeFile(var7, var8[var9])); // L:
																							// 119
	...
	public void onCycle(int var1, int var2, boolean var3, int var4, int var5, int var6, int var7) {
		if (this.cacheLoader.isLoaded()) { // L: 138
			...
			if (var3) { // L: 143
				int var8 = (int) Math.ceil((double) ((float) var6 / this.zoom)); // L:
																					// 146
				int var9 = (int) Math.ceil((double) ((float) var7 / this.zoom)); // L:
																					// 147
				List var10 = this.worldMapManager.method4819(this.centerTileX - var8 / 2 - 1, this.centerTileY - var9 / 2 - 1, var8 / 2 + this.centerTileX + 1, var9 / 2 + this.centerTileY + 1, var4, var5, var6, var7, var1, var2); // L:
																																																										// 148
				...
				ScriptEvent var14;
				WorldMapEvent var15;
				for (var12 = var10.iterator(); var12.hasNext(); BoundaryObject.runScriptEvent(var14)) { // L:
																										// 150
																										// 163
					var13 = (AbstractWorldMapIcon) var12.next(); // L: 151
					var11.add(var13); // L: 153
					var14 = new ScriptEvent(); // L: 154
					var15 = new WorldMapEvent(var13.getElement(), var13.coord1, var13.coord2); // L:
																								// 155
				...
				while (var12.hasNext()) {
					...
					if (!var11.contains(var13)) { // L: 169
						...
						var15 = new WorldMapEvent(var13.getElement(), var13.coord1, var13.coord2); // L:
																									// 171
						var14.setArgs(new Object[]{var15, var1, var2}); // L:
																		// 172
	...
	public void method7307(int var1, int var2, boolean var3, boolean var4) {
		long var5;
		label40 : {
			var5 = Equations.getCurrentTime(); // L: 182
			...
			if (!this.hasTarget() && (var4 || var3)) { // L: 185
				...
				if (!var7) { // L: 190
					...
					if (this.field4546 != -1) { // L: 197
						...
						this.setWorldMapPosition(this.field4546 - (int) ((float) var8 / this.zoomTarget), (int) ((float) var9 / this.zoomTarget) + this.field4547, false); // L:
																																											// 200
					}
					break label40;
				}
	...
	void method7217(int var1, int var2, boolean var3, long var4) {
		if (this.currentMapArea != null) { // L: 215
			int var6 = (int) ((float) this.centerTileX + ((float) (var1 - this.worldMapDisplayX) - (float) this.getDisplayWith() * this.zoom / 2.0F) / this.zoom); // L:
																																									// 216
			int var7 = (int) ((float) this.centerTileY - ((float) (var2 - this.worldMapDisplayY) - (float) this.getDisplayHeight() * this.zoom / 2.0F) / this.zoom); // L:
																																										// 217
			this.mouseCoord = this.currentMapArea.coord(var6 + this.currentMapArea.getRegionLowX() * 64, var7 + this.currentMapArea.getRegionLowY() * 64); // L:
																																							// 218
			if (this.mouseCoord != null && var3) { // L: 219
				boolean var8 = Client.staffModLevel >= 2; // L: 222
				int var10;
				int var11;
				if (var8 && KeyHandler.KeyHandler_pressedKeys[82] && KeyHandler.KeyHandler_pressedKeys[81]) { // L:
																												// 224
					int var14 = this.mouseCoord.x; // L: 225
					var10 = this.mouseCoord.y; // L: 226
					var11 = this.mouseCoord.plane; // L: 227
					PacketBufferNode var12 = EnumComposition.getPacketBufferNode(ClientPacket.field2966, Client.packetWriter.isaacCipher); // L:
																																			// 230
					...
					if (this.field4514) { // L: 240
						...
						if (var4 - this.field4534 > 500L || var10 < -25 || var10 > 25 || var11 < -25 || var11 > 25) { // L:
							// 243
							var9 = false; // L: 244
						}
					}
					if (var9) { // L: 247
						PacketBufferNode var13 = EnumComposition.getPacketBufferNode(ClientPacket.field2990, Client.packetWriter.isaacCipher); // L:
																																				// 248
						var13.packetBuffer.method7783(this.mouseCoord.packed()); // L:
																					// 249
	...
	void smoothZoom() {
		if (UrlRequester.field1362 != null) { // L: 260
			...
			if (this.zoom < this.zoomTarget) { // L: 264
				this.zoom = Math.min(this.zoomTarget, this.zoom / 30.0F + this.zoom); // L:
																						// 265
			}
			if (this.zoom > this.zoomTarget) { // L: 267
				this.zoom = Math.max(this.zoomTarget, this.zoom - this.zoom / 30.0F); // L:
																						// 268
			}
		}
	} // L: 262 270
	...
	void scrollToTarget() {
		if (this.hasTarget()) { // L: 273
			...
			this.setWorldMapPosition(var1 + this.centerTileX, var2 + this.centerTileY, true); // L:
																								// 284
			if (this.centerTileX == this.worldMapTargetX && this.worldMapTargetY == this.centerTileY) { // L:
																										// 285
	...
	final void setWorldMapPosition(int var1, int var2, boolean var3) {
		...
		Equations.getCurrentTime(); // L: 294
		if (var3) {
	...
	boolean hasTarget() {
		return this.worldMapTargetX != -1 && this.worldMapTargetY != -1; // L:
																			// 306
	}
	...
	public int currentMapAreaId() {
		return this.currentMapArea == null ? -1 : this.currentMapArea.getId(); // L:
																				// 348
																				// 349
																				// 351
	}
	...
	void setCurrentMapArea(WorldMapArea var1) {
		if (this.currentMapArea == null || var1 != this.currentMapArea) { // L:
																			// 359
	...
	void initializeWorldMapManager(WorldMapArea var1) {
		...
		this.worldMapManager = new WorldMapManager(this.mapSceneSprites, this.fonts, this.WorldMap_geographyArchive, this.WorldMap_groundArchive); // L:
																																					// 368
	...
	public void method7292(WorldMapArea var1, Coord var2, Coord var3, boolean var4) {
		if (var1 != null) { // L: 373
			...
			if (!var4 && this.currentMapArea.containsCoord(var2.plane, var2.x, var2.y)) { // L:
																							// 379
	...
	void jump(int var1, int var2, int var3) {
		if (this.currentMapArea != null) { // L: 388
			int[] var4 = this.currentMapArea.position(var1, var2, var3); // L:
																			// 391
			if (var4 == null) { // L: 392
				var4 = this.currentMapArea.position(this.currentMapArea.getOriginPlane(), this.currentMapArea.getOriginX(), this.currentMapArea.getOriginY()); // L:
																																								// 393
			}
			this.setWorldMapPosition(var4[0] - this.currentMapArea.getRegionLowX() * 64, var4[1] - this.currentMapArea.getRegionLowY() * 64, true); // L:
																																					// 395
			this.worldMapTargetX = -1; // L: 396
			this.worldMapTargetY = -1; // L: 397
			this.zoom = this.getZoomFromPercentage(this.currentMapArea.getZoom()); // L:
																					// 398
	...
	public void draw(int var1, int var2, int var3, int var4, int var5) {
		...
		Rasterizer2D.Rasterizer2D_setClip(var1, var2, var3 + var1, var2 + var4); // L:
																					// 408
		Rasterizer2D.Rasterizer2D_fillRectangle(var1, var2, var3, var4, -16777216); // L:
																					// 409
		...
		if (var7 < 100) { // L: 411
			...
			if (!this.worldMapManager.isLoaded()) { // L: 415
				this.worldMapManager.load(this.WorldMap_archive, this.currentMapArea.getInternalName(), Client.isMembersWorld); // L:
																																// 416
			...
			if (this.flashingElements != null) { // L: 421
				...
				if (this.flashCount >= this.maxFlashCount && !this.perpetualFlash) { // L:
																						// 427
					this.flashingElements = null; // L: 428
				}
			}
			int var8 = (int) Math.ceil((double) ((float) var3 / this.zoom)); // L:
																				// 431
			int var9 = (int) Math.ceil((double) ((float) var4 / this.zoom)); // L:
																				// 432
			this.worldMapManager.drawTiles(this.centerTileX - var8 / 2, this.centerTileY - var9 / 2, var8 / 2 + this.centerTileX, var9 / 2 + this.centerTileY, var1, var2, var3 + var1, var2 + var4); // L:
			// 433
			boolean var10;
			if (!this.elementsDisabled) { // L: 434
				...
				this.worldMapManager.drawElements(this.centerTileX - var8 / 2, this.centerTileY - var9 / 2, var8 / 2 + this.centerTileX, var9 / 2 + this.centerTileY, var1, var2, var3 + var1, var2 + var4, this.field4561, this.flashingElements, this.flashCycle, this.cyclesPerFlash, var10); // L:
																																																																									// 440
			}
	...
	boolean method7201(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (this.sprite == null) { // L: 456
			return true;
		} else if (this.sprite.subWidth == var1 && this.sprite.subHeight == var2) { // L:
																					// 457
			if (this.worldMapManager.pixelsPerTile != this.cachedPixelsPerTile) { // L:
																					// 458
				return true;
	...
	void method7202(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (UrlRequester.field1362 != null) { // L: 466
			...
			int var13 = var1 - (var7 + var11 - this.minCachedTileX) * this.worldMapManager.pixelsPerTile; // L:
																											// 475
			int var14 = var2 - this.worldMapManager.pixelsPerTile * (var7 - (var12 - this.minCachedTileY)); // L:
																											// 476
			if (this.method7201(var8, var9, var13, var14, var3, var4)) { // L:
																			// 477
				if (this.sprite != null && this.sprite.subWidth == var8 && this.sprite.subHeight == var9) { // L:
																											// 478
					Arrays.fill(this.sprite.pixels, 0); // L: 481
				} else {
					this.sprite = new SpritePixels(var8, var9); // L: 479
				}
				this.minCachedTileX = this.getDisplayX() - var5 / 2 - var7; // L:
																			// 482
				this.minCachedTileY = this.getDisplayY() - var6 / 2 - var7; // L:
																			// 483
				this.cachedPixelsPerTile = this.worldMapManager.pixelsPerTile; // L:
																				// 484
				UrlRequester.field1362.method6046(this.minCachedTileX, this.minCachedTileY, this.sprite, (float) this.cachedPixelsPerTile / var10); // L:
																																					// 485
				this.field4560 = Client.field770; // L: 486
				var13 = var1 - (var11 + var7 - this.minCachedTileX) * this.worldMapManager.pixelsPerTile; // L:
																											// 487
				var14 = var2 - this.worldMapManager.pixelsPerTile * (var7 - (var12 - this.minCachedTileY)); // L:
																											// 488
			}
			Rasterizer2D.Rasterizer2D_fillRectangleAlpha(var1, var2, var3, var4, 0, 128); // L:
																							// 490
			if (1.0F == var10) { // L: 491
				this.sprite.method8171(var13, var14, 192); // L: 492
			} else {
				this.sprite.method8155(var13, var14, (int) ((float) var8 * var10), (int) (var10 * (float) var9), 192); // L:
				// 495
			}
		}
	} // L: 498
	...
	public void drawOverview(int var1, int var2, int var3, int var4) {
		if (this.cacheLoader.isLoaded()) { // L: 501
			...
			this.worldMapManager.drawOverview(var1, var2, var3, var4, this.flashingElements, this.flashCycle, this.cyclesPerFlash); // L:
																																	// 510
		}
	} // L: 502 511
	...
	void drawLoading(int var1, int var2, int var3, int var4, int var5) {
		...
		Rasterizer2D.Rasterizer2D_fillRectangle(var1, var2, var3, var4, -16777216); // L:
																					// 521
		Rasterizer2D.Rasterizer2D_drawRectangle(var7 - 152, var8, 304, 34, -65536); // L:
																					// 522
		Rasterizer2D.Rasterizer2D_fillRectangle(var7 - 150, var8 + 2, var5 * 3, 30, -65536); // L:
																								// 523
		this.font.drawCentered("Loading...", var7, var8 + var6, -1, -1); // L:
																			// 524
	} // L: 525
	...
	public void setWorldMapPositionTarget(int var1, int var2) {
		if (this.currentMapArea != null && this.currentMapArea.containsPosition(var1, var2)) { // L:
																								// 566
			this.worldMapTargetX = var1 - this.currentMapArea.getRegionLowX() * 64; // L:
																					// 569
			this.worldMapTargetY = var2 - this.currentMapArea.getRegionLowY() * 64; // L:
																					// 570
		}
	} // L: 567 571
	...
	public void setWorldMapPositionTargetInstant(int var1, int var2) {
		if (this.currentMapArea != null) { // L: 574
			this.setWorldMapPosition(var1 - this.currentMapArea.getRegionLowX() * 64, var2 - this.currentMapArea.getRegionLowY() * 64, true); // L:
																																				// 577
	...
	public void jumpToSourceCoordInstant(int var1, int var2, int var3) {
		if (this.currentMapArea != null) { // L: 593
			int[] var4 = this.currentMapArea.position(var1, var2, var3); // L:
																			// 596
			if (var4 != null) { // L: 597
				this.setWorldMapPositionTargetInstant(var4[0], var4[1]); // L:
																			// 598
			}
		}
	} // L: 594 600
	...
	public int getDisplayX() {
		return this.currentMapArea == null ? -1 : this.centerTileX + this.currentMapArea.getRegionLowX() * 64; // L:
																												// 603
		// 604
		// 606
	}
	...
	public int getDisplayY() {
		return this.currentMapArea == null ? -1 : this.centerTileY + this.currentMapArea.getRegionLowY() * 64; // L:
																												// 610
		// 611
		// 613
	}
	...
	public Coord getDisplayCoord() {
		return this.currentMapArea == null ? null : this.currentMapArea.coord(this.getDisplayX(), this.getDisplayY()); // L:
		// 617
		// 618
		// 620
	}
	...
	public void flashCategory(int var1) {
		...
		for (int var2 = 0; var2 < WorldMapElement.WorldMapElement_count; ++var2) { // L:
																					// 666
			if (class432.WorldMapElement_get(var2) != null && class432.WorldMapElement_get(var2).category == var1) { // L:
				// 667
				// 670
				this.flashingElements.add(class432.WorldMapElement_get(var2).objectId); // L:
																						// 671
			}
		}
	} // L: 674
	...
	public void setCategoryDisabled(int var1, boolean var2) {
		...
		for (int var3 = 0; var3 < WorldMapElement.WorldMapElement_count; ++var3) { // L:
																					// 701
			if (class432.WorldMapElement_get(var3) != null && class432.WorldMapElement_get(var3).category == var1) { // L:
				// 702
				// 705
				int var4 = class432.WorldMapElement_get(var3).objectId; // L:
																		// 706
				if (!var2) { // L: 707
	...
	public void addElementMenuOptions(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (this.cacheLoader.isLoaded()) { // L: 737
			int var7 = (int) Math.ceil((double) ((float) var3 / this.zoom)); // L:
																				// 740
			int var8 = (int) Math.ceil((double) ((float) var4 / this.zoom)); // L:
																				// 741
			List var9 = this.worldMapManager.method4819(this.centerTileX - var7 / 2 - 1, this.centerTileY - var8 / 2 - 1, var7 / 2 + this.centerTileX + 1, var8 / 2 + this.centerTileY + 1, var1, var2, var3, var4, var5, var6); // L:
																																																									// 742
			if (!var9.isEmpty()) { // L: 743
				...
				do {
					...
					AbstractWorldMapIcon var11 = (AbstractWorldMapIcon) var10.next(); // L:
																						// 747
					WorldMapElement var12 = class432.WorldMapElement_get(var11.getElement()); // L:
																								// 749
					var13 = false; // L: 750
					for (int var14 = this.menuOpcodes.length - 1; var14 >= 0; --var14) { // L:
																							// 751
						if (var12.menuActions[var14] != null) { // L: 752
							class4.insertMenuItemNoShift(var12.menuActions[var14], var12.menuTargetName, this.menuOpcodes[var14], var11.getElement(), var11.coord1.packed(), var11.coord2.packed()); // L:
																																																		// 753
							var13 = true; // L: 754
						}
					}
	...
	public Coord method7235(int var1, Coord var2) {
		if (!this.cacheLoader.isLoaded()) { // L: 765
			...
			return null; // L: 769
		} else if (!this.currentMapArea.containsPosition(var2.x, var2.y)) { // L:
																			// 771
			return null; // L: 772
		} else {
	...
	public AbstractWorldMapIcon iconNext() {
		if (this.iconIterator == null) { // L: 853
			...
			do {
				...
				var1 = (AbstractWorldMapIcon) this.iconIterator.next(); // L:
																		// 857
	...
	static final void method7376() {
		...
		int var1 = (class101.localPlayer.y >> 7) + WorldMapLabelSize.baseY; // L:
																			// 5421
		if (var0 >= 3053 && var0 <= 3156 && var1 >= 3056 && var1 <= 3136) { // L:
																			// 5422
			Client.field607 = 1;
		}
		if (var0 >= 3072 && var0 <= 3118 && var1 >= 9492 && var1 <= 9535) { // L:
																			// 5423
			Client.field607 = 1;
		}
		if (Client.field607 == 1 && var0 >= 3139 && var0 <= 3199 && var1 >= 3008 && var1 <= 3062) { // L:
																									// 5424
			Client.field607 = 0;
		}
	} // L: 5425
	...
	static final void method7377(int var0, int var1, boolean var2) {
		if (!var2 || var0 != GrandExchangeOffer.field4070 || ApproximateRouteStrategy.field466 != var1) { // L:
																											// 5621
			...
			Static.drawLoadingMessage("Loading - please wait.", true); // L:
																					// 5627
				...
				for (var14 = var10; var11 != var14; var14 += var12) { // L: 5675
					...
					for (int var17 = 0; var17 < 4; ++var17) { // L: 5678
						if (var15 >= 0 && var16 >= 0 && var15 < 104 && var16 < 104) {
							Client.groundItems[var17][var13][var14] = Client.groundItems[var17][var15][var16]; // L:
							// 5679
						} else {
							Client.groundItems[var17][var13][var14] = null; // L:
																			// 5680
						}
					}
				}
			}
			for (PendingSpawn var18 = (PendingSpawn) Client.pendingSpawns.last(); var18 != null; var18 = (PendingSpawn) Client.pendingSpawns.previous()) { // L:
																																							// 5684
																																							// 5685
				// 5689
				var18.x -= var5; // L: 5686
				var18.y -= var6; // L: 5687
				if (var18.x < 0 || var18.y < 0 || var18.x >= 104 || var18.y >= 104) { // L:
																						// 5688
					var18.remove();
				}
			}
