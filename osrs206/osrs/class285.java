...
public class class285 {
	...
	static final void updateActorSequence(Actor var0, int var1) {
		...
		if (var0.field1184 >= Client.cycle) { // L: 4009
			...
			if (var0.field1194 == Client.cycle || var0.sequence == -1 || var0.sequenceDelay != 0 || var0.sequenceFrameCycle + 1 > Anim_SequenceDefinition.SequenceDefinition_get(var0.sequence).frameLengths[var0.sequenceFrame]) { // L:
				// 4011
				...
				int var5 = var0.field1205 * 64 + var0.field1182 * 128; // L:
																		// 4015
				int var6 = var0.field1205 * 64 + var0.field1181 * 128; // L:
																		// 4016
				int var7 = var0.field1205 * 64 + var0.field1183 * 128; // L:
																		// 4017
		...
		if (var0.x < 128 || var0.y < 128 || var0.x >= 13184 || var0.y >= 13184) { // L:
																					// 4026
		...
		if (class101.localPlayer == var0 && (var0.x < 1536 || var0.y < 1536 || var0.x >= 11776 || var0.y >= 11776)) { // L:
			// 4035
			// 4036
		...
		Anim_SequenceDefinition var8;
		if (var0.movementSequence != -1) { // L: 4049
			var8 = Anim_SequenceDefinition.SequenceDefinition_get(var0.movementSequence); // L:
																				// 4050
			if (var8 != null) { // L: 4051
				if (!var8.isCachedModelIdSet() && var8.frameIds != null) { // L:
																			// 4052
					++var0.movementFrameCycle; // L: 4053
					if (var0.movementFrame < var8.frameIds.length && var0.movementFrameCycle > var8.frameLengths[var0.movementFrame]) { // L:
																																		// 4054
		...
		if (var0.spotAnimation != -1 && Client.cycle >= var0.field1178) { // L:
																			// 4081
			if (var0.spotAnimationFrame < 0) { // L: 4082
				var0.spotAnimationFrame = 0;
			}
			var2 = _Junk.SpotAnimationDefinition_get(var0.spotAnimation).sequence; // L:
																							// 4083
			if (var2 != -1) { // L: 4084
				Anim_SequenceDefinition var9 = Anim_SequenceDefinition.SequenceDefinition_get(var2); // L:
																					// 4085
				if (var9 != null && var9.frameIds != null) { // L: 4086
					++var0.spotAnimationFrameCycle; // L: 4087
					if (var0.spotAnimationFrame < var9.frameIds.length && var0.spotAnimationFrameCycle > var9.frameLengths[var0.spotAnimationFrame]) { // L:
																																						// 4088
		...
		if (var0.sequence != -1 && var0.sequenceDelay <= 1) { // L: 4111
			var8 = Anim_SequenceDefinition.SequenceDefinition_get(var0.sequence); // L: 4112
			if (var8.field2187 == 1 && var0.field1203 > 0 && var0.field1184 <= Client.cycle && var0.field1194 < Client.cycle) { // L:
																																// 4113
																																// 4114
		...
		if (var0.sequence != -1 && var0.sequenceDelay == 0) { // L: 4120
			var8 = Anim_SequenceDefinition.SequenceDefinition_get(var0.sequence); // L: 4121
			if (var8 == null) { // L: 4122
				var0.sequence = -1; // L: 4155
			} else if (!var8.isCachedModelIdSet() && var8.frameIds != null) { // L:
																				// 4123
				++var0.sequenceFrameCycle; // L: 4124
				if (var0.sequenceFrame < var8.frameIds.length && var0.sequenceFrameCycle > var8.frameLengths[var0.sequenceFrame]) { // L:
																																	// 4125
	...
	static final void addPendingSpawnToScene(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) { // L: 7815
			if (Client.isLowDetail && var0 != PacketWriter.Client_plane) { // L:
																			// 7816
				return;
			}
			long var7 = 0L; // L: 7817
			...
			int var12;
			if (var7 != 0L) { // L: 7825
				var12 = class356.scene.getObjectFlags(var0, var2, var3, var7); // L:
																				// 7826
				int var14 = _Junk.Entity_unpackID(var7); // L: 7827
				int var15 = var12 & 31; // L: 7828
				int var16 = var12 >> 6 & 3; // L: 7829
				ObjectComposition var13;
				if (var1 == 0) { // L: 7830
					class356.scene.removeBoundaryObject(var0, var2, var3); // L:
																			// 7831
				...
				if (var1 == 2) { // L: 7836
					class356.scene.removeGameObject(var0, var2, var3); // L:
																		// 7837
					var13 = class162.getObjectDefinition(var14); // L: 7838
					if (var2 + var13.sizeX > 103 || var3 + var13.sizeX > 103 || var2 + var13.sizeY > 103 || var3 + var13.sizeY > 103) { // L:
																																		// 7839
						return;
					}
				...
				if (var1 == 3) { // L: 7842
					class356.scene.removeFloorDecoration(var0, var2, var3); // L:
																			// 7843
			...
			if (var4 >= 0) { // L: 7848
				var12 = var0; // L: 7849
				if (var0 < 3 && (Tiles.Tiles_renderFlags[1][var2][var3] & 2) == 2) { // L:
																						// 7850
					var12 = var0 + 1;
				}
				class142.method3050(var0, var12, var2, var3, var4, var5, var6, class356.scene, Client.collisionMaps[var0]); // L:
																															// 7851
			}
		}
	} // L: 7854
