...
public class KitDefinition extends DualNode {
	...
	public boolean method3417() {
		...
		for (int var2 = 0; var2 < 5; ++var2) { // L: 103
			if (this.models[var2] != -1 && !KitDefinition_modelsArchive.tryLoadFile(this.models[var2], 0)) { // L:
																												// 104
				var1 = false;
			}
		}
	...
	public ModelData getKitDefinitionModels() {
		...
		if (this.recolorFrom != null) { // L: 116
			for (var4 = 0; var4 < this.recolorFrom.length; ++var4) { // L: 117
				var5.recolor(this.recolorFrom[var4], this.recolorTo[var4]); // L:
																			// 118
			}
		}
		if (this.retextureFrom != null) { // L: 121
			for (var4 = 0; var4 < this.retextureFrom.length; ++var4) { // L: 122
				var5.retexture(this.retextureFrom[var4], this.retextureTo[var4]); // L:
																					// 123
			}
		}
		return var5; // L: 126
	...
	static final void method3439(Actor var0) {
		...
		if (var0.pathLength == 0) { // L: 4173
			...
			if (var0.sequence != -1 && var0.sequenceDelay == 0) { // L: 4177
				Anim_SequenceDefinition var1 = Anim_SequenceDefinition.SequenceDefinition_get(var0.sequence); // L:
																								// 4178
			...
			int var3 = var0.field1205 * 64 + var0.pathX[var0.pathLength - 1] * 128; // L:
																					// 4190
			int var4 = var0.field1205 * 64 + var0.pathY[var0.pathLength - 1] * 128; // L:
																					// 4191
			...
			if (var3 - var10 <= 256 && var3 - var10 >= -256 && var4 - var2 <= 256 && var4 - var2 >= -256) { // L:
																											// 4205
				...
				if (var9) { // L: 4223
					if (var0.rotation != var0.orientation && var0.targetIndex == -1 && var0.field1129 != 0) { // L:
																												// 4224
						var8 = 2;
					}
				...
				if (var8 >= 8) { // L: 4242
					if (var0.walkSequence == var0.movementSequence && var0.runSequence != -1) { // L:
																								// 4243
						var0.movementSequence = var0.runSequence;
					} else if (var0.movementSequence == var0.walkBackSequence && var0.field1180 != -1) { // L:
																											// 4244
						var0.movementSequence = var0.field1180;
					} else if (var0.walkLeftSequence == var0.movementSequence && var0.field1144 != -1) { // L:
																											// 4245
						var0.movementSequence = var0.field1144;
					} else if (var0.walkRightSequence == var0.movementSequence && var0.field1145 != -1) { // L:
																											// 4246
						var0.movementSequence = var0.field1145;
					}
				} else if (var8 <= 1) { // L: 4248
					if (var0.walkSequence == var0.movementSequence && var0.field1155 != -1) { // L:
																								// 4249
						var0.movementSequence = var0.field1155;
					} else if (var0.movementSequence == var0.walkBackSequence && var0.field1179 != -1) { // L:
																											// 4250
						var0.movementSequence = var0.field1179;
					} else if (var0.movementSequence == var0.walkLeftSequence && var0.field1137 != -1) { // L:
																											// 4251
						var0.movementSequence = var0.field1137;
					} else if (var0.walkRightSequence == var0.movementSequence && var0.field1149 != -1) { // L:
																											// 4252
