...
public class class101 extends UrlRequester {
	...
	URLConnection method2540(UrlRequest var1) throws IOException {
		HttpsURLConnection var2 = (HttpsURLConnection) var1.url.openConnection(); // L:
																					// 55
		...
		if (var7 < var0 && var7 < var1 && var7 < var2) { // L: 108
			...
			if (var7 > var0 && var7 > var1 && var7 > var2) {
				...
				if (var7 < var3 && var7 < var4 && var7 < var5) { // L: 112
					...
					return var7 <= var3 || var7 <= var4 || var7 <= var5; // L:
																			// 114
				}
			}
		}
	...
	static void method2547(boolean var0) {
		byte var1 = 0; // L: 1178
		boolean var2 = class19.clientPreferences.method2266() >= Client.field482; // L:
																					// 1181
		if (!var2) { // L: 1183
			var1 = 12; // L: 1184
		} else if (class353.client.method1102() || class353.client.method1103()) { // L:
																					// 1186
			var1 = 10; // L: 1187
		}
