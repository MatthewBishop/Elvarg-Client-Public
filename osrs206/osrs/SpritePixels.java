...
public final class SpritePixels extends Rasterizer2D {
	...
	public SpritePixels mirrorHorizontally() {
		SpritePixels var1 = new SpritePixels(this.subWidth, this.subHeight); // L:
																				// 34
		...
		for (int var2 = 0; var2 < this.subHeight; ++var2) { // L: 39
			for (int var3 = 0; var3 < this.subWidth; ++var3) { // L: 40
				var1.pixels[var3 + var2 * this.subWidth] = this.pixels[var2 * this.subWidth + this.subWidth - 1 - var3]; // L:
				// 41
			}
		}
		return var1; // L: 44
	...
	public SpritePixels copyNormalized() {
		...
		for (int var2 = 0; var2 < this.subHeight; ++var2) { // L: 60
			for (int var3 = 0; var3 < this.subWidth; ++var3) { // L: 61
				var1.pixels[var3 + (var2 + this.yOffset) * this.width + this.xOffset] = this.pixels[var3 + var2 * this.subWidth]; // L:
																																	// 62
			}
		}
		return var1; // L: 65
	...
	public void setRaster() {
		Rasterizer2D.Rasterizer2D_replace(this.pixels, this.subWidth, this.subHeight); // L:
																						// 69
	} // L: 70
	public void normalize() {
		if (this.subWidth != this.width || this.subHeight != this.height) { // L:
																			// 73
			...
			for (int var2 = 0; var2 < this.subHeight; ++var2) { // L: 75
				for (int var3 = 0; var3 < this.subWidth; ++var3) { // L: 76
					var1[var3 + (var2 + this.yOffset) * this.width + this.xOffset] = this.pixels[var3 + var2 * this.subWidth]; // L:
																																// 77
				}
			}
		...
		if (this.subWidth != this.width || this.subHeight != this.height) { // L:
			...
			for (int var9 = 0; var9 < this.subHeight; ++var9) { // L: 100
				for (int var10 = 0; var10 < this.subWidth; ++var10) { // L: 101
					var8[var6 * (var9 + var4) + var10 + var2] = this.pixels[var10 + var9 * this.subWidth]; // L:
																											// 102
				}
			}
	...
	public void flipHorizontally() {
		...
		for (int var3 = 0; var3 < this.subHeight; ++var3) { // L: 115
			for (int var4 = this.subWidth - 1; var4 >= 0; --var4) {
				var1[var2++] = this.pixels[var4 + var3 * this.subWidth]; // L:
																			// 116
			}
		}
			...
			for (int var5 = 0; var5 < this.subWidth; ++var5) { // L: 136
				...
				if (var6 == 0) { // L: 138
					if (var5 > 0 && this.pixels[var3 - 1] != 0) { // L: 139
						var6 = var1;
					} else if (var4 > 0 && this.pixels[var3 - this.subWidth] != 0) { // L:
																						// 140
						var6 = var1;
					} else if (var5 < this.subWidth - 1 && this.pixels[var3 + 1] != 0) { // L:
																							// 141
						var6 = var1;
					} else if (var4 < this.subHeight - 1 && this.pixels[var3 + this.subWidth] != 0) { // L:
																										// 142
						var6 = var1;
					}
				}
	...
	public void drawAt(int var1, int var2) {
		...
		if (var6 > 0 && var5 > 0) { // L: 191
			Sprite_draw(Rasterizer2D.Rasterizer2D_pixels, this.pixels, var4, var3, var6, var5, var7, var8); // L:
																											// 192
		}
	} // L: 193
	public void drawTransBgAt(int var1, int var2) {
		...
		if (var6 > 0 && var5 > 0) { // L: 245
			Sprite_drawTransBg(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var4, var3, var6, var5, var7, var8); // L:
			// 246
		}
	} // L: 247
	public void drawScaledAt(int var1, int var2, int var3, int var4) {
		if (var3 > 0 && var4 > 0) { // L: 278
			...
			if (var3 + var1 > Rasterizer2D.Rasterizer2D_xClipEnd) { // L: 308
				var15 = var3 + var1 - Rasterizer2D.Rasterizer2D_xClipEnd; // L:
																			// 309
				var3 -= var15; // L: 310
				var14 += var15; // L: 311
			}
			...
			Sprite_drawScaled(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var7, var8, var13, var14, var3, var4, var11, var12, var5); // L:
																																			// 320
		}
	} // L: 321
	public void drawTransOverlayAt(int var1, int var2, int var3, int var4) {
		if (var3 == 256) { // L: 340
			...
			if (var8 + var1 > Rasterizer2D.Rasterizer2D_xClipEnd) { // L: 369
				var11 = var8 + var1 - Rasterizer2D.Rasterizer2D_xClipEnd; // L:
																			// 370
				var8 -= var11; // L: 371
				var10 += var11; // L: 372
				var9 += var11; // L: 373
			...
			if (var8 > 0 && var7 > 0) { // L: 375
				Sprite_drawTransOverlay(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var6, var5, var8, var7, var9, var10, var3, var4); // L:
																																			// 376
			}
		}
	} // L: 342 377
	public void drawTransAt(int var1, int var2, int var3) {
		...
		if (var7 > 0 && var6 > 0) { // L: 431
			Sprite_drawTransparent(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var5, var4, var7, var6, var8, var9, var3); // L:
																																// 432
		}
	} // L: 433
	public void drawTransScaledAt(int var1, int var2, int var3, int var4, int var5) {
		if (var3 > 0 && var4 > 0) { // L: 452
			...
			if (var3 + var1 > Rasterizer2D.Rasterizer2D_xClipEnd) { // L: 482
				var16 = var3 + var1 - Rasterizer2D.Rasterizer2D_xClipEnd; // L:
																			// 483
				var3 -= var16; // L: 484
				var15 += var16; // L: 485
			}
			...
			Sprite_drawTransScaled(Rasterizer2D.Rasterizer2D_pixels, this.pixels, 0, var8, var9, var14, var15, var3, var4, var12, var13, var6, var5); // L:
																																						// 494
		}
	} // L: 495
	public void method8171(int var1, int var2, int var3) {
		...
		if (var7 > 0 && var6 > 0) { // L: 549
			if (var3 == 256) {
				method8176(0, 0, 0, Rasterizer2D.Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9); // L:
																																// 550
			} else {
				method8173(0, 0, 0, Rasterizer2D.Rasterizer2D_pixels, this.pixels, var5, 0, var4, 0, var7, var6, var8, var9, var3); // L:
																																	// 551
			}
		}
	} // L: 552
	public void method8155(int var1, int var2, int var3, int var4, int var5) {
		if (var3 > 0 && var4 > 0) { // L: 593
			...
			if (var5 == 256) { // L: 635
				...
				method8269(0, 0, 0, var8, this.pixels, Rasterizer2D.Rasterizer2D_pixels, 0, 0, -var4, var9, var14, var15, var3, var12, var13, var6, var5); // L:
																																							// 636
			}
		}
	} // L: 637
	public void method8270(int var1, int var2, int var3, int var4, int var5, int var6, int[] var7, int[] var8) {
		...
		int var10 = var2 + this.subHeight <= var6 ? this.subHeight : var6 - var2; // L:
																					// 687
		...
		int var13 = var3 + var11 + (var9 + var2 + var4) * Rasterizer2D.Rasterizer2D_width + var1; // L:
																									// 690
		...
		for (int var15 = var9; var15 < var10; ++var15) { // L: 692
			...
			for (int var20 = var19; var20 < var12; ++var20) { // L: 704
				int var21 = this.pixels[var20 + var15 * this.subWidth]; // L:
																		// 705
				if (var21 != 0) {
	...
	public void drawRotatedMaskedCenteredAround(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int[] var9, int[] var10) {
		try {
			...
			int var13 = (int) (Math.sin((double) var7 / 326.11D) * 65536.0D); // L:
																				// 717
			int var14 = (int) (Math.cos((double) var7 / 326.11D) * 65536.0D); // L:
																				// 718
			...
			for (var2 = 0; var2 < var4; ++var2) { // L: 724
				...
				for (var1 = -var10[var2]; var1 < 0; ++var1) { // L: 729
					Rasterizer2D.Rasterizer2D_pixels[var19++] = this.pixels[this.subWidth * (var21 >> 16) + (var20 >> 16)]; // L:
																															// 730
					var20 += var14; // L: 731
					var21 -= var13; // L: 732
				}
		...
		try {
			...
			for (var2 = 0; var2 < var4; ++var2) { // L: 753
				...
				for (var1 = -var3; var1 < 0; ++var1) { // L: 757
					int var20 = this.pixels[this.subWidth * (var19 >> 16) + (var18 >> 16)]; // L:
																							// 758
					if (var20 != 0) { // L: 759
	...
	public void method8180(int var1, int var2, int var3, int var4) {
		this.method8260(this.width << 3, this.height << 3, var1 << 4, var2 << 4, var3, var4); // L:
																								// 773
	} // L: 774
	void method8260(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var6 != 0) { // L: 777
			...
			double var7 = (double) (var5 & 65535) * 9.587379924285257E-5D; // L:
																			// 780
			int var9 = (int) Math.floor(Math.sin(var7) * (double) var6 + 0.5D); // L:
																				// 781
			int var10 = (int) Math.floor(Math.cos(var7) * (double) var6 + 0.5D); // L:
																					// 782
			int var11 = var10 * -var1 + -var2 * var9; // L: 783
			int var12 = -var2 * var10 + var9 * -(-var1); // L: 784
			int var13 = var10 * ((this.subWidth << 4) - var1) + -var2 * var9; // L:
																				// 785
			int var14 = var9 * -((this.subWidth << 4) - var1) + -var2 * var10; // L:
																				// 786
			int var15 = ((this.subHeight << 4) - var2) * var9 + var10 * -var1; // L:
																				// 787
			int var16 = ((this.subHeight << 4) - var2) * var10 + var9 * -(-var1); // L:
																					// 788
			int var17 = ((this.subHeight << 4) - var2) * var9 + var10 * ((this.subWidth << 4) - var1); // L:
																										// 789
			int var18 = ((this.subHeight << 4) - var2) * var10 + var9 * -((this.subWidth << 4) - var1); // L:
																										// 790
			int var19;
			int var20;
			...
			if (var20 < 0) { // L: 836
				...
				if (var22 < 0) { // L: 838
					int var23 = var19 + var21 * Rasterizer2D.Rasterizer2D_width; // L:
																					// 839
					double var24 = 1.6777216E7D / (double) var6; // L: 840
					int var26 = (int) Math.floor(Math.sin(var7) * var24 + 0.5D); // L:
																					// 841
					int var27 = (int) Math.floor(Math.cos(var7) * var24 + 0.5D); // L:
																					// 842
					...
					if (var27 == 0) { // L: 848
						if (var26 == 0) { // L: 849
							for (var33 = var22; var33 < 0; var23 += Rasterizer2D.Rasterizer2D_width) {
								...
								var36 = var31; // L: 853
								var37 = var20; // L: 854
								if (var30 >= 0 && var31 >= 0 && var30 - (this.subWidth << 12) < 0 && var31 - (this.subHeight << 12) < 0) { // L:
																																			// 855
																																			// 856
																																			// 857
																																			// 858
									for (; var37 < 0; ++var37) { // L: 859
										var38 = this.pixels[(var35 >> 12) + (var36 >> 12) * this.subWidth]; // L:
																											// 860
										if (var38 != 0) { // L: 861
							...
							for (var33 = var22; var33 < 0; var23 += Rasterizer2D.Rasterizer2D_width) {
								...
								var37 = var20; // L: 871
								if (var30 >= 0 && var30 - (this.subWidth << 12) < 0) { // L:
																						// 872
																						// 873
									if ((var32 = var36 - (this.subHeight << 12)) >= 0) { // L:
																							// 874
										var32 = (var26 - var32) / var26; // L:
																			// 875
										var37 = var20 + var32; // L: 876
										var36 += var26 * var32; // L: 877
										var34 = var23 + var32; // L: 878
									}
									if ((var32 = (var36 - var26) / var26) > var37) { // L:
																						// 880
										var37 = var32;
									}
									while (var37 < 0) {
							...
							for (var33 = var22; var33 < 0; var23 += Rasterizer2D.Rasterizer2D_width) {
								...
								if (var30 >= 0 && var30 - (this.subWidth << 12) < 0) { // L:
																						...
																						// 896
									if (var36 < 0) { // L: 897
										var32 = (var26 - 1 - var36) / var26; // L:
																				// 898
										var37 = var20 + var32; // L: 899
										var36 += var26 * var32; // L: 900
										var34 = var23 + var32; // L: 901
									}
									if ((var32 = (var36 + 1 - (this.subHeight << 12) - var26) / var26) > var37) { // L:
										// 903
										var37 = var32;
									}
									while (var37 < 0) {
						...
						if (var26 == 0) { // L: 914
							for (var33 = var22; var33 < 0; var23 += Rasterizer2D.Rasterizer2D_width) {
								...
								var36 = var31; // L: 918
								var37 = var20; // L: 919
								if (var31 >= 0 && var31 - (this.subHeight << 12) < 0) { // L:
																						// 920
																						// 921
									if ((var32 = var35 - (this.subWidth << 12)) >= 0) { // L:
																						// 922
										var32 = (var27 - var32) / var27; // L:
																			// 923
										var37 = var20 + var32; // L: 924
										var35 += var27 * var32; // L: 925
										var34 = var23 + var32; // L: 926
									}
									if ((var32 = (var35 - var27) / var27) > var37) { // L:
																						// 928
										var37 = var32;
									}
									while (var37 < 0) {
						...
						for (var33 = var22; var33 < 0; var23 += Rasterizer2D.Rasterizer2D_width) {
							...
							if (var31 >= 0 && var31 - (this.subHeight << 12) < 0) { // L:
																					...
																					// 1008
								if (var35 < 0) { // L: 1009
									var32 = (var27 - 1 - var35) / var27; // L:
																			// 1010
									var37 = var20 + var32; // L: 1011
									var35 += var27 * var32; // L: 1012
									var34 = var23 + var32; // L: 1013
								}
								if ((var32 = (var35 + 1 - (this.subWidth << 12) - var27) / var27) > var37) { // L:
																												// 1015
									var37 = var32;
								}
								while (var37 < 0) {
	...
	public void drawScaledWorldmap(int var1, int var2, int var3, int var4) {
		if (var3 <= this.width && var4 <= this.height) { // L: 1090
			...
			int var6 = (var3 * (this.xOffset + this.subWidth) + this.width - 1) / this.width + var1; // L:
																										// 1094
			int var7 = var2 + var4 * this.yOffset / this.height; // L: 1095
			int var8 = var2 + (this.height + (this.yOffset + this.subHeight) * var4 - 1) / this.height; // L:
																										// 1096
			...
			if (var5 < var6 && var7 < var8) { // L: 1101
				int var9 = var5 + var7 * Rasterizer2D.Rasterizer2D_width; // L:
																			// 1102
				int var10 = Rasterizer2D.Rasterizer2D_width - (var6 - var5); // L:
																				// 1103
				if (var9 < Rasterizer2D.Rasterizer2D_pixels.length) { // L: 1104
					for (int var11 = var7; var11 < var8; ++var11) { // L: 1107
						for (int var12 = var5; var12 < var6; ++var12) { // L:
																		// 1108
							int var13 = var12 - var1 << 4; // L: 1109
							int var14 = var11 - var2 << 4; // L: 1110
							int var15 = var13 * this.width / var3 - (this.xOffset << 4); // L:
																							// 1111
							int var16 = (var13 + 16) * this.width / var3 - (this.xOffset << 4); // L:
																								// 1112
							int var17 = var14 * this.height / var4 - (this.yOffset << 4); // L:
																							// 1113
							int var18 = (var14 + 16) * this.height / var4 - (this.yOffset << 4); // L:
																									// 1114
							int var19 = (var16 - var15) * (var18 - var17) >> 1; // L:
																				// 1115
							if (var19 != 0) { // L: 1116
								if (var15 < 0) { // L: 1117
									var15 = 0;
								...
								int var27 = 0; // L: 1134
								int var28;
								for (var28 = var17; var28 <= var18; ++var28) { // L:
																				// 1135
									int var29 = 16; // L: 1136
									...
									for (int var30 = var15; var30 <= var16; ++var30) { // L:
																						// 1139
										int var31 = this.pixels[var30 + var28 * this.subWidth]; // L:
																								// 1140
										if (var31 != 0) { // L: 1141
											int var32;
											if (var30 == var15) { // L: 1143
												var32 = var29 * var20;
											} else if (var30 == var16) { // L:
																			// 1144
												var32 = var29 * var21;
											} else {
											...
											var27 += var32; // L: 1146
											var24 += var32 * (var31 >> 16 & 255); // L:
																					// 1147
											var25 += var32 * (var31 >> 8 & 255); // L:
																					// 1148
											var26 += (var31 & 255) * var32; // L:
																			// 1149
										}
									}
								}
								if (var27 >= var19) { // L: 1153
									var28 = var26 / var27 + (var24 / var27 << 16) + (var25 / var27 << 8); // L:
																											// 1154
									if (var28 == 0) { // L: 1155
										var28 = 1;
									}
									Rasterizer2D.Rasterizer2D_pixels[var9] = var28; // L:
																					// 1156
								}
								++var9; // L: 1158
							}
	...
	static void Sprite_draw(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		for (int var8 = -var5; var8 < 0; ++var8) { // L: 196
			int var9;
			for (var9 = var3 + var4 - 3; var3 < var9; var0[var3++] = var1[var2++]) { // L:
																						// 197
																						// 198
																						// 202
			...
			for (var9 += 3; var3 < var9; var0[var3++] = var1[var2++]) { // L:
																		// 204
																		// 205
																		// 206
			}
		...
		for (int var11 = -var6; var11 < 0; ++var11) { // L: 437
			for (int var12 = -var5; var12 < 0; ++var12) { // L: 438
				...
				if (var2 != 0) { // L: 440
					...
					var0[var4++] = ((var13 & 16711935) * var10 + var9 * (var2 & 16711935) & -16711936) + ((var2 & 65280) * var9 + var10 * (var13 & 65280) & 16711680) >> 8; // L:
																																											// 442
				} else {
					++var4; // L: 444
				}
		...
		for (int var15 = -var8; var15 < 0; ++var15) { // L: 500
			...
			for (int var17 = -var7; var17 < 0; ++var17) { // L: 502
				...
				if (var2 != 0) { // L: 504
					...
					var0[var5++] = ((var2 & 65280) * var12 + var13 * (var18 & 65280) & 16711680) + ((var18 & 16711935) * var13 + var12 * (var2 & 16711935) & -16711936) >> 8; // L:
																																												// 506
				} else {
					++var5; // L: 508
				}
		...
		for (var8 = -var10; var8 < 0; ++var8) { // L: 573
			for (var6 = -var9; var6 < 0; ++var6) { // L: 574
				...
				if (var0 != 0) { // L: 576
					...
					var0 = (var1 & -16711936) + (var13 * var0 - var1 & 16711680) >>> 8; // L:
																						// 578
		...
		for (int var17 = var3; var8 < 0; ++var8) { // L: 662 663
			...
			for (var6 = -var12; var6 < 0; ++var6) { // L: 665
				...
				if (var0 != 0) { // L: 667
					...
					var0 = (var1 & -16711936) + (var0 * var16 - var1 & 16711680) >>> 8; // L:
																						// 669
