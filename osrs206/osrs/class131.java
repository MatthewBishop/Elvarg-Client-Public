...
public class class131 {
	...
	public void method2869(ClanSettings var1) {
		if (var1.field1627 == this.field1582 && this.field1584 == var1.field1628) { // L:
																					// 60
			for (class128 var2 = (class128) this.field1585.last(); var2 != null; var2 = (class128) this.field1585.previous()) { // L:
																																// 61
	...
	static void doWorldSorting(int var0, int var1, int var2, boolean var3, int var4, boolean var5) {
		if (var0 < var1) { // L: 177
			...
			for (int var9 = var0; var9 < var1; ++var9) { // L: 183
				if (_Junk.method5445(class362.World_worlds[var9], var8, var2, var3, var4, var5) <= 0) { // L:
					// 184
					World var10 = class362.World_worlds[var9]; // L: 185
					class362.World_worlds[var9] = class362.World_worlds[var7]; // L:
																				// 186
		...
		if (var0 == ScriptOpcodes.ENUM_STRING) { // L: 2280
			...
			for (var6 = 0; var6 < var10.outputCount; ++var6) { // L: 2286
				if (var9 == var10.keys[var6]) { // L: 2287
					Interpreter.Interpreter_stringStack[++Interpreter.Interpreter_stringStackSize - 1] = var10.strVals[var6]; // L:
																																// 2288
					var10 = null; // L: 2289
					break;
				}
			...
			if (var0 == ScriptOpcodes.ENUM_GETOUTPUTCOUNT) { // L: 2322
				...
				Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = var4.size(); // L:
																											// 2325
				return 1; // L: 2326
			} else {
				return 2; // L: 2328
			...
			if (var3 == var7.inputType && var9 == var7.outputType) { // L: 2303
				for (int var8 = 0; var8 < var7.outputCount; ++var8) { // L: 2308
					if (var6 == var7.keys[var8]) { // L: 2309
						if (var9 == 115) { // L: 2310
							...
							Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = var7.intVals[var8]; // L:
																															// 2311
						}
						var7 = null; // L: 2312
						break;
				...
				if (var7 != null) { // L: 2316
					if (var9 == 115) { // L: 2317
						...
						Interpreter.Interpreter_intStack[++class446.Interpreter_intStackSize - 1] = var7.defaultInt; // L:
						// 2318
					}
				}
				return 1; // L: 2320
