	...
	static final void method4527(byte[] var0, int var1, int var2, Scene var3, CollisionMap[] var4) {
		...
		while (true) {
			...
			while (true) {
				...
				if (var16 > 0 && var17 > 0 && var16 < 103 && var17 < 103) { // L:
																			// 247
					int var18 = var12; // L: 248
					if ((Tiles.Tiles_renderFlags[1][var16][var17] & 2) == 2) { // L:
																				// 249
						var18 = var12 - 1;
					}
					...
					class268.addObjects(var12, var16, var17, var6, var15, var14, var3, var19); // L:
																								// 252
				}
			}
		}
