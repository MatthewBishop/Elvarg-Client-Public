...
public class WorldMapData_1 extends AbstractWorldMapData {
	...
	void readGeography(Buffer var1) {
		...
		super.decorations = new WorldMapDecoration[super.planes][64][64][]; // L:
																			// 39
		...
		if (var2 != class238.field2836.value) { // L: 41
			...
			if (var3 == super.regionX && var4 == super.regionY && var5 == this.chunkX && var6 == this.chunkY) { // L:
																												// 48
				for (int var7 = 0; var7 < 8; ++var7) { // L: 51
					for (int var8 = 0; var8 < 8; ++var8) { // L: 52
						this.readTile(var7 + this.chunkX * 8, var8 + this.chunkY * 8, var1); // L:
																								// 53
					}
				}
			} else {
	...
	public boolean equals(Object var1) {
		if (!(var1 instanceof WorldMapData_1)) { // L: 60
			...
			if (var2.regionX == super.regionX && super.regionY == var2.regionY) { // L:
																					// 64
				return this.chunkX == var2.chunkX && var2.chunkY == this.chunkY; // L:
																					// 67
			} else {
				return false; // L: 65
			}
	...
	public int hashCode() {
		return super.regionX | super.regionY << 8 | this.chunkX << 16 | this.chunkY << 24; // L:
																							// 72
	}
	
	static class82[] method4867() {
		return new class82[]{class82.field1073, class82.field1067, class82.field1069, class82.field1066, class82.field1068}; // L:
																																// 16
	}
	...
	static final void method4874(Widget var0) {
		...
		if (var1 == 324) { // L: 11944
			...
			var0.modelAngleY = (int) (Math.sin((double) Client.cycle / 40.0D) * 256.0D) & 2047; // L:
																								// 11964
