...
public class ModelData extends Renderable {
	...
	public ModelData(ModelData[] var1, int var2) {
		...
		for (var10 = 0; var10 < var2; ++var10) { // L: 932
			...
			if (var11 != null) { // L: 934
				...
				this.textureTriangleCount += var11.textureTriangleCount; // L:
																			// 937
		...
		if (this.textureTriangleCount > 0) { // L: 969
			this.textureRenderTypes = new byte[this.textureTriangleCount]; // L:
																			// 970
				...
				for (var12 = 0; var12 < var11.faceCount; ++var12) { // L: 981
					...
					if (var4) { // L: 985
						if (var11.faceRenderPriorities != null) { // L: 986
							...
							this.faceRenderPriorities[this.faceCount] = var11.priority; // L:
																						// 987
						}
					}
					...
					if (var8) { // L: 999
						if (var11.textureCoords != null && var11.textureCoords[var12] != -1) { // L:
																								// 1000
					...
					this.faceColors[this.faceCount] = var11.faceColors[var12]; // L:
																				// 1003
					this.indices1[this.faceCount] = this.method3928(var11, var11.indices1[var12]); // L:
																									// 1004
					this.indices2[this.faceCount] = this.method3928(var11, var11.indices2[var12]); // L:
																									// 1005
					this.indices3[this.faceCount] = this.method3928(var11, var11.indices3[var12]); // L:
																									// 1006
					++this.faceCount; // L: 1007
				}
				for (var12 = 0; var12 < var11.textureTriangleCount; ++var12) { // L:
																				// 1009
					byte var13 = this.textureRenderTypes[this.textureTriangleCount] = var11.textureRenderTypes[var12]; // L:
					// 1010
					if (var13 == 0) { // L: 1011
						this.texTriangleX[this.textureTriangleCount] = (short) this.method3928(var11, var11.texTriangleX[var12]); // L:
																																	// 1012
						this.texTriangleY[this.textureTriangleCount] = (short) this.method3928(var11, var11.texTriangleY[var12]); // L:
																																	// 1013
						this.texTriangleZ[this.textureTriangleCount] = (short) this.method3928(var11, var11.texTriangleZ[var12]); // L:
																																	// 1014
					}
	...
	ModelData(byte[] var1) {
		...
		if (var1[var1.length - 1] == -3 && var1[var1.length - 2] == -1) { // L:
																			// 66
			this.method3924(var1);
		} else if (var1[var1.length - 1] == -2 && var1[var1.length - 2] == -1) { // L:
																					// 67
			this.method3925(var1);
		} else if (var1[var1.length - 1] == -1 && var1[var1.length - 2] == -1) { // L:
																					// 68
	...
	void method3924(byte[] var1) {
		...
		if (var11 > 0) { // L: 100
			...
			for (var28 = 0; var28 < var11; ++var28) { // L: 103
				byte var29 = this.textureRenderTypes[var28] = var2.readByte(); // L:
																				// 104
				if (var29 == 0) { // L: 105
					++var25;
				}
		...
		if (var18 == 1) { // L: 203
			for (var53 = 0; var53 < var9; ++var53) { // L: 204
				...
				for (var55 = 0; var55 < var54; ++var55) { // L: 208
					this.field2262[var53][var55] = var6.readUnsignedByte(); // L:
																			// 209
					this.field2263[var53][var55] = var6.readUnsignedByte(); // L:
																			// 210
				}
			}
		}
		...
		for (var53 = 0; var53 < var10; ++var53) { // L: 221
			...
			if (this.textureCoords != null && this.faceTextures[var53] != -1) { // L:
																				// 228
		...
		for (var57 = 0; var57 < var11; ++var57) { // L: 282
			...
			if (var58 == 0) { // L: 284
				this.texTriangleX[var57] = (short) var2.readUnsignedShort(); // L:
																				// 285
				this.texTriangleY[var57] = (short) var2.readUnsignedShort(); // L:
																				// 286
				this.texTriangleZ[var57] = (short) var2.readUnsignedShort(); // L:
																				// 287
			}
		}
	...
	void method3925(byte[] var1) {
		...
		if (var17 == 1) { // L: 405
			for (var40 = 0; var40 < var9; ++var40) { // L: 406
				...
				for (var42 = 0; var42 < var41; ++var42) { // L: 410
					this.field2262[var40][var42] = var8.readUnsignedByte(); // L:
																			// 411
					this.field2263[var40][var42] = var8.readUnsignedByte(); // L:
																			// 412
				}
			}
		}
		...
		for (var44 = 0; var44 < var11; ++var44) { // L: 492
			...
			this.texTriangleX[var44] = (short) var4.readUnsignedShort(); // L:
																			// 494
			this.texTriangleY[var44] = (short) var4.readUnsignedShort(); // L:
																			// 495
			this.texTriangleZ[var44] = (short) var4.readUnsignedShort(); // L:
																			// 496
		}
		if (this.textureCoords != null) { // L: 498
			...
			for (var45 = 0; var45 < var10; ++var45) { // L: 500
				...
				if (var46 != 255) { // L: 502
					if (this.indices1[var45] == (this.texTriangleX[var46] & '\uffff') && this.indices2[var45] == (this.texTriangleY[var46] & '\uffff') && this.indices3[var45] == (this.texTriangleZ[var46] & '\uffff')) { // L:
																																																							// 503
	...
	void method3926(byte[] var1) {
		...
		if (var11 > 0) { // L: 539
			...
			for (var26 = 0; var26 < var11; ++var26) { // L: 542
				byte var27 = this.textureRenderTypes[var26] = var2.readByte(); // L:
																				// 543
				if (var27 == 0) { // L: 544
					++var23;
				}
		...
		for (var51 = 0; var51 < var10; ++var51) { // L: 645
			...
			if (this.textureCoords != null && this.faceTextures[var51] != -1) { // L:
																				// 652
		...
		for (var55 = 0; var55 < var11; ++var55) { // L: 706
			...
			if (var56 == 0) { // L: 708
				this.texTriangleX[var55] = (short) var2.readUnsignedShort(); // L:
																				// 709
				this.texTriangleY[var55] = (short) var2.readUnsignedShort(); // L:
																				// 710
				this.texTriangleZ[var55] = (short) var2.readUnsignedShort(); // L:
																				// 711
			}
		}
	...
	void method3981(byte[] var1) {
		...
		for (var42 = 0; var42 < var11; ++var42) { // L: 899
			...
			this.texTriangleX[var42] = (short) var4.readUnsignedShort(); // L:
																			// 901
			this.texTriangleY[var42] = (short) var4.readUnsignedShort(); // L:
																			// 902
			this.texTriangleZ[var42] = (short) var4.readUnsignedShort(); // L:
																			// 903
		}
		if (this.textureCoords != null) { // L: 905
			...
			for (var43 = 0; var43 < var10; ++var43) { // L: 907
				...
				if (var44 != 255) { // L: 909
					if (this.indices1[var43] == (this.texTriangleX[var44] & '\uffff') && this.indices2[var43] == (this.texTriangleY[var44] & '\uffff') && this.indices3[var43] == (this.texTriangleZ[var44] & '\uffff')) { // L:
																																																							// 910
	...
	final int method3928(ModelData var1, int var2) {
		...
		for (int var7 = 0; var7 < this.verticesCount; ++var7) { // L: 1027
			if (var4 == this.verticesX[var7] && var5 == this.verticesY[var7] && var6 == this.verticesZ[var7]) { // L:
				// 1028
				var3 = var7; // L: 1029
				break;
			}
		...
		if (var3 == -1) { // L: 1033
			...
			if (var1.vertexSkins != null) {
				this.vertexSkins[this.verticesCount] = var1.vertexSkins[var2]; // L:
																				// 1037
			}
			if (var1.field2262 != null) { // L: 1038
				this.field2262[this.verticesCount] = var1.field2262[var2]; // L:
																			// 1039
				this.field2263[this.verticesCount] = var1.field2263[var2]; // L:
																			// 1040
			}
	...
	public ModelData method3921(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
		...
		if (var7 >= 0 && var8 + 128 >> 7 < var1.length && var9 >= 0 && var10 + 128 >> 7 < var1[0].length) { // L:
			...
			if (var3 == var1[var7][var9] && var3 == var1[var8][var9] && var3 == var1[var7][var10] && var3 == var1[var8][var10]) { // L:
				...
				var11.textureTriangleCount = this.textureTriangleCount; // L:
																		// 1164
	...
	void method3972() {
		...
		if (this.vertexSkins != null) { // L: 1228
			...
			for (var3 = 0; var3 < this.verticesCount; this.vertexLabels[var4][var1[var4]++] = var3++) { // L:
																										// 1241
																										// 1243
		...
		if (this.faceSkins != null) { // L: 1247
			...
			for (var3 = 0; var3 < this.faceCount; this.faceLabelsAlpha[var4][var1[var4]++] = var3++) { // L:
																										// 1260
																										// 1262
	...
	public void method3935(int var1) {
		...
		for (int var4 = 0; var4 < this.verticesCount; ++var4) { // L: 1297
			int var5 = var2 * this.verticesZ[var4] + var3 * this.verticesX[var4] >> 16; // L:
																						// 1298
			this.verticesZ[var4] = var3 * this.verticesZ[var4] - var2 * this.verticesX[var4] >> 16; // L:
																									// 1299
	...
	public void calculateVertexNormals() {
		if (this.vertexNormals == null) { // L: 1347
			this.vertexNormals = new VertexNormal[this.verticesCount]; // L:
																		// 1348
			int var1;
			...
			for (var1 = 0; var1 < this.faceCount; ++var1) { // L: 1350
				...
				int var5 = this.verticesX[var3] - this.verticesX[var2]; // L:
																		// 1354
				int var6 = this.verticesY[var3] - this.verticesY[var2]; // L:
																		// 1355
				int var7 = this.verticesZ[var3] - this.verticesZ[var2]; // L:
																		// 1356
				int var8 = this.verticesX[var4] - this.verticesX[var2]; // L:
																		// 1357
				int var9 = this.verticesY[var4] - this.verticesY[var2]; // L:
																		// 1358
				int var10 = this.verticesZ[var4] - this.verticesZ[var2]; // L:
																			// 1359
				int var11 = var6 * var10 - var9 * var7; // L: 1360
				int var12 = var7 * var8 - var10 * var5; // L: 1361
				int var13;
				for (var13 = var5 * var9 - var8 * var6; var11 > 8192 || var12 > 8192 || var13 > 8192 || var11 < -8192 || var12 < -8192 || var13 < -8192; var13 >>= 1) { // L:
																																										// 1362
																																										// 1363
																																										// 1366
					var11 >>= 1; // L: 1364
				...
				int var14 = (int) Math.sqrt((double) (var11 * var11 + var12 * var12 + var13 * var13)); // L:
																										// 1368
				if (var14 <= 0) { // L: 1369
					var14 = 1;
				}
				...
				if (var15 == 0) { // L: 1376
					...
					FaceNormal var17 = this.faceNormals[var1] = new FaceNormal(); // L:
																					// 1396
	...
	public final Model toModel(int var1, int var2, int var3, int var4, int var5) {
		...
		int var6 = (int) Math.sqrt((double) (var5 * var5 + var3 * var3 + var4 * var4)); // L:
																						// 1491
		...
		if (this.textureTriangleCount > 0 && this.textureCoords != null) { // L:
																			// 1497
			...
			for (var10 = 0; var10 < this.textureTriangleCount; ++var10) { // L:
																			// 1503
				if (var9[var10] > 0 && this.textureRenderTypes[var10] == 0) { // L:
																				// 1504
					++var8.field2528;
				}
			}
			...
			var10 = 0; // L: 1509
			int var11;
			for (var11 = 0; var11 < this.textureTriangleCount; ++var11) { // L:
																			// 1510
				if (var9[var11] > 0 && this.textureRenderTypes[var11] == 0) { // L:
																				// 1511
					var8.field2529[var10] = this.texTriangleX[var11] & '\uffff'; // L:
																					// 1512
					var8.field2522[var10] = this.texTriangleY[var11] & '\uffff'; // L:
																					// 1513
					var8.field2531[var10] = this.texTriangleZ[var11] & '\uffff'; // L:
																					// 1514
			...
			if (var12 == -1) { // L: 1537
				if (var17 != 0) { // L: 1538
					if (var17 == 1) { // L: 1555
						...
						var14 = (var4 * var19.y + var5 * var19.z + var3 * var19.x) / (var7 / 2 + var7) + var1; // L:
						// 1557
						var8.faceColors1[var16] = method3946(this.faceColors[var16] & '\uffff', var14); // L:
																										// 1558
					...
					if (this.vertexVertices != null && this.vertexVertices[this.indices1[var16]] != null) { // L:
																											// 1542
						var13 = this.vertexVertices[this.indices1[var16]];
					} else {
						var13 = this.vertexNormals[this.indices1[var16]]; // L:
																			// 1543
					}
					var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1; // L:
					// 1544
					var8.faceColors1[var16] = method3946(var15, var14); // L:
																		// 1545
					if (this.vertexVertices != null && this.vertexVertices[this.indices2[var16]] != null) { // L:
																											// 1546
						var13 = this.vertexVertices[this.indices2[var16]];
					} else {
						var13 = this.vertexNormals[this.indices2[var16]]; // L:
																			// 1547
					}
					var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1; // L:
					// 1548
					var8.faceColors2[var16] = method3946(var15, var14); // L:
																		// 1549
					if (this.vertexVertices != null && this.vertexVertices[this.indices3[var16]] != null) { // L:
																											// 1550
						var13 = this.vertexVertices[this.indices3[var16]];
					} else {
						var13 = this.vertexNormals[this.indices3[var16]]; // L:
																			// 1551
					}
					var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1; // L:
					// 1552
					var8.faceColors3[var16] = method3946(var15, var14); // L:
																		// 1553
				}
	...
	static void method3944(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
		...
		for (var9 = 0; var9 < var0.verticesCount; ++var9) { // L: 1442
			...
			if (var10.magnitude != 0) { // L: 1444
				...
				if (var11 <= var1.field2270) { // L: 1446
					...
					if (var12 >= var1.field2271 && var12 <= var1.field2276) { // L:
																				// 1448
						int var13 = var0.verticesZ[var9] - var4; // L: 1449
						if (var13 >= var1.field2274 && var13 <= var1.field2273) { // L:
																					// 1450
							for (int var14 = 0; var14 < var8; ++var14) { // L:
																			// 1451
								VertexNormal var15 = var1.vertexNormals[var14]; // L:
																				// 1452
								if (var12 == var7[var14] && var13 == var1.verticesZ[var14] && var11 == var1.verticesY[var14] && var15.magnitude != 0) { // L:
																																						// 1453
									if (var0.vertexVertices == null) { // L:
																		// 1454
										var0.vertexVertices = new VertexNormal[var0.verticesCount];
									}
									if (var1.vertexVertices == null) { // L:
																		// 1455
										var1.vertexVertices = new VertexNormal[var8];
									}
									VertexNormal var16 = var0.vertexVertices[var9]; // L:
																					// 1456
									if (var16 == null) { // L: 1457
										var16 = var0.vertexVertices[var9] = new VertexNormal(var10);
									}
									VertexNormal var17 = var1.vertexVertices[var14]; // L:
																						// 1458
									if (var17 == null) {
										var17 = var1.vertexVertices[var14] = new VertexNormal(var15); // L:
																										// 1459
									}
									var16.x += var15.x; // L: 1460
									var16.y += var15.y; // L: 1461
									var16.z += var15.z; // L: 1462
									var16.magnitude += var15.magnitude; // L:
																		// 1463
									var17.x += var10.x; // L: 1464
									var17.y += var10.y; // L: 1465
									var17.z += var10.z; // L: 1466
									var17.magnitude += var10.magnitude; // L:
																		// 1467
									++var6; // L: 1468
		...
		if (var6 >= 3 && var5) { // L: 1474
			for (var9 = 0; var9 < var0.faceCount; ++var9) { // L: 1475
				if (field2239[var0.indices1[var9]] == field2245 && field2239[var0.indices2[var9]] == field2245 && field2239[var0.indices3[var9]] == field2245) { // L:
																																									// 1476
			...
			for (var9 = 0; var9 < var1.faceCount; ++var9) { // L: 1481
				if (field2245 == field2240[var1.indices1[var9]] && field2245 == field2240[var1.indices2[var9]] && field2245 == field2240[var1.indices3[var9]]) { // L:
																																									// 1482
