...
public class class325 {
	...
	public class325() {
		...
		for (byte var3 = 12; var1 < 16; var2 -= var3) { // L: 25
			var4 = StructComposition.method3616((double) ((float) var2 / 360.0F), 0.9998999834060669D, (double) (0.075F + 0.425F * (float) var1 / 16.0F)); // L:
																																							// 27
			class344.field4152[var1] = var4; // L: 28
			++var1; // L: 26
		}
		var2 = 48; // L: 30
		for (int var6 = var2 / 6; var1 < class344.field4152.length; var2 -= var6) { // L:
																					// 31
																					// 32
																					// 38
			var4 = var1 * 2; // L: 33
			for (int var5 = StructComposition.method3616((double) ((float) var2 / 360.0F), 0.9998999834060669D, 0.5D); var1 < var4 && var1 < class344.field4152.length; ++var1) { // L:
																																													// 34
																																													// 35
	...
	void method6033(int var1) {
		...
		double[] var3 = WorldMapEvent.method5119(0.0D, (double) ((float) var1 / 3.0F), var1); // L:
																								// 45
		...
		for (int var8 = 0; var8 < var2; ++var8) { // L: 49
			for (int var9 = 0; var9 < var2; ++var9) { // L: 50
				int var10 = var6[var9 + var2 * var8] = (int) (256.0D * (var3[var9] * var3[var8] / var4)); // L:
																											// 51
	...
	public final void method6046(int var1, int var2, SpritePixels var3, float var4) {
		...
		for (var10 = 0; var10 < this.field4076; ++var10) { // L: 87
			...
			int var14 = (int) ((float) var3.subHeight - (float) (var12 - var2) * var4) - var5; // L:
																								// 91
