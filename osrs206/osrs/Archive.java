...
public class Archive extends AbstractArchive {
	...
	public int percentage() {
		if (this.field3981 != 1 && (!this.field3990 || this.field3981 != 2)) { // L:
																				// 41
			if (super.groups != null) { // L: 42
				...
				int var1;
				if (Buddy.NetCache_currentResponse != null && Buddy.NetCache_currentResponse.key == var3) { // L:
																											// 47
					var1 = _Junk.NetCache_responseArchiveBuffer.offset * 99 / (_Junk.NetCache_responseArchiveBuffer.array.length - Buddy.NetCache_currentResponse.padding) + 1; // L:
																																															// 51
				} else {
					var1 = 0; // L: 48
				}
	...
	void loadGroup(int var1) {
		if (this.archiveDisk != null && this.validGroups != null && this.validGroups[var1]) { // L:
																								// 63
			ClientPacket.method5191(var1, this.archiveDisk, this);
		} else {
			ClanChannel.requestNetFile(this, this.index, var1, super.groupCrcs[var1], (byte) 2, true); // L:
																										// 64
		}
	} // L: 65
	...
	void loadIndex(int var1, int var2) {
		...
		if (this.masterDisk != null) { // L: 81
			...
			ClanChannel.requestNetFile(this, 255, this.index, this.indexCrc, (byte) 0, true); // L:
																								// 82
		}
	} // L: 83
	...
	public void write(int var1, byte[] var2, boolean var3, boolean var4) {
		if (var3) { // L: 86
			...
			var2[var2.length - 2] = (byte) (super.groupVersions[var1] >> 8); // L:
																				// 95
			...
			if (var4) {
				super.groups[var1] = WorldMapArea.method4621(var2, false); // L:
																			// 101
			}
		}
	} // L: 103
	...
	public void load(ArchiveDisk var1, int var2, byte[] var3, boolean var4) {
		...
		if (var1 == this.masterDisk) { // L: 106
			...
			Buffer var9 = new Buffer(_Junk.decompressBytes(var3)); // L:
																			// 121
			...
			int var6 = ((var3[var3.length - 2] & 255) << 8) + (var3[var3.length - 1] & 255); // L:
																								// 145
			if (var5 != super.groupCrcs[var2] || var6 != super.groupVersions[var2]) { // L:
																						// 146
	...
	int groupLoadPercent(int var1) {
		if (super.groups[var1] != null) { // L: 174
			...
			int var2;
			if (Buddy.NetCache_currentResponse != null && Buddy.NetCache_currentResponse.key == var4) { // L:
																										// 180
				var2 = _Junk.NetCache_responseArchiveBuffer.offset * 99 / (_Junk.NetCache_responseArchiveBuffer.array.length - Buddy.NetCache_currentResponse.padding) + 1; // L:
																																														// 184
			} else {
				var2 = 0; // L: 181
			}
	...
	static int ItemContainer_getCount(int var0, int var1) {
		...
		if (var2 == null) { // L: 22
			...
			return var1 >= 0 && var1 < var2.quantities.length ? var2.quantities[var1] : 0; // L:
																							// 23
																							// 24
		}
	}
	...
	static final void drawModelComponents(Widget[] var0, int var1) {
		for (int var2 = 0; var2 < var0.length; ++var2) { // L: 11771
			...
			if (var3 != null && var3.parentId == var1 && (!var3.isIf3 || !Static.isComponentHidden(var3))) { // L:
																												// 11773
				// 11774
				// 11775
				int var5;
				if (var3.type == 0) { // L: 11776
					if (!var3.isIf3 && Static.isComponentHidden(var3) && var3 != Language.mousedOverWidgetIf1) { // L:
						// 11777
						continue;
					}
					...
					InterfaceParent var4 = (InterfaceParent) Client.interfaceParents.get((long) var3.id); // L:
																											// 11780
					if (var4 != null) { // L: 11781
						var5 = var4.group; // L: 11782
						if (WorldMapSection2.loadInterface(var5)) { // L: 11784
							drawModelComponents(_Junk.Widget_interfaceComponents[var5], -1); // L:
																									// 11785
						}
					}
				}
				if (var3.type == 6) { // L: 11789
					if (var3.sequenceId != -1 || var3.sequenceId2 != -1) { // L:
																			// 11790
						boolean var7 = _Junk.runCs1(var3); // L: 11791
						if (var7) { // L: 11793
						...
						if (var5 != -1) { // L: 11795
							Anim_SequenceDefinition var6 = Anim_SequenceDefinition.SequenceDefinition_get(var5); // L:
																								// 11796
							for (var3.modelFrameCycle += Client.field555; var3.modelFrameCycle > var6.frameLengths[var3.modelFrame]; ChatChannel.invalidateWidget(var3)) { // L:
																																											// 11797
																																											// 11798
																																											// 11805
								var3.modelFrameCycle -= var6.frameLengths[var3.modelFrame]; // L:
																							// 11799
								++var3.modelFrame; // L: 11800
								if (var3.modelFrame >= var6.frameIds.length) { // L:
																				// 11801
									var3.modelFrame -= var6.frameCount; // L:
																		// 11802
									if (var3.modelFrame < 0 || var3.modelFrame >= var6.frameIds.length) { // L:
																											// 11803
										var3.modelFrame = 0;
									}
								}
					...
					if (var3.field3373 != 0 && !var3.isIf3) { // L: 11809
						...
						var3.modelAngleX = var8 + var3.modelAngleX & 2047; // L:
																			// 11814
						var3.modelAngleY = var5 + var3.modelAngleY & 2047; // L:
																			// 11815
