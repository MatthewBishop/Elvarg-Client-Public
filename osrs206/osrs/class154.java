...
public class class154 extends class165 {
	...
	static final int method3169(int var0, int var1, int var2) {
		...
		int var7 = _Junk.method740(var3, var5); // L: 885
		int var8 = _Junk.method740(var3 + 1, var5); // L: 886
		int var9 = _Junk.method740(var3, var5 + 1); // L: 887
		int var10 = _Junk.method740(var3 + 1, var5 + 1); // L: 888
		int var11 = Static.method3827(var7, var8, var4, var2); // L:
																			// 889
		int var12 = Static.method3827(var9, var10, var4, var2); // L:
																			// 890
		int var14 = 65536 - Rasterizer3D.Rasterizer3D_cosine[var6 * 1024 / var2] >> 1; // L:
																						// 893
		int var13 = ((65536 - var14) * var11 >> 16) + (var12 * var14 >> 16); // L:
																				// 894
		return var13; // L: 896
	}
		...
		if (var0 != null && var0.isVisible()) { // L: 4957
			...
			if (var1 < var76 && var0.playerCycle == Client.cycle) { // L: 4966
				...
				if (Client.drawPlayerNames == 0) { // L: 4970
					...
					boolean var11 = (Client.drawPlayerNames & 4) != 0; // L:
																		// 4977
					boolean var12 = var11; // L: 4979
					if (!var11) { // L: 4980
						boolean var13 = (Client.drawPlayerNames & 1) != 0; // L:
																			// 4983
						var12 = var13 && var10.isFriend(); // L: 4985
					}
					var9 = var12 || Language.method6070() && var10.isFriendsChatMember(); // L:
																							// 4987
				} else {
				...
				if (var9) { // L: 4991
					...
					if (var1 < var76) { // L: 4993
						...
						class220.worldToScreen(var0.x, var0.y, var92); // L:
																		// 4996
						AbstractFont var78 = (AbstractFont) Client.fontsMap.get(FontName.FontName_plain12); // L:
																											// 4998
						byte var14 = 9; // L: 4999
						var78.drawCentered(var77.username.getName(), var2 + Client.viewportTempX, var3 + Client.viewportTempY - var14, 16777215, 0); // L:
																																						// 5000
						var8 = 18; // L: 5001
					}
				}
			...
			if (!var0.healthBars.method6147()) { // L: 5006
				...
				for (HealthBar var96 = (HealthBar) var0.healthBars.last(); var96 != null; var96 = (HealthBar) var0.healthBars.previous()) { // L:
																																			// 5011
					...
					if (var81 == null) { // L: 5013
						...
						if (var82 != null && var83 != null) { // L: 5019
							if (var97.widthPadding * 2 < var83.subWidth) { // L:
																			// 5020
						...
						int var87 = var84 * var81.health2 / var97.width; // L:
																			// 5027
						int var88;
						int var99;
						if (var81.cycleOffset > var86) { // L: 5028
							var88 = var97.field1881 == 0 ? 0 : var97.field1881 * (var86 / var97.field1881); // L:
																											// 5029
							var23 = var84 * var81.health / var97.width; // L:
																		// 5030
							var99 = var88 * (var87 - var23) / var81.cycleOffset + var23; // L:
																							// 5031
						} else {
							var99 = var87; // L: 5034
							var88 = var97.int5 + var81.cycleOffset - var86; // L:
																			// 5035
						...
						if (var82 != null && var83 != null) { // L: 5039
							...
							var89 += var88; // L: 5043
							var23 = var2 + Client.viewportTempX - (var84 >> 1); // L:
																				// 5044
							var24 = var3 + Client.viewportTempY - var89; // L:
																			// 5045
							var23 -= var17; // L: 5046
							if (var18 >= 0 && var18 < 255) { // L: 5047
								var82.drawTransAt(var23, var24, var18); // L:
																		// 5048
								Rasterizer2D.Rasterizer2D_expandClip(var23, var24, var99 + var23, var24 + var88); // L:
								// 5049
								var83.drawTransAt(var23, var24, var18); // L:
																		// 5050
							} else {
								var82.drawTransBgAt(var23, var24); // L: 5053
								Rasterizer2D.Rasterizer2D_expandClip(var23, var24, var99 + var23, var88 + var24); // L:
								// 5054
								var83.drawTransBgAt(var23, var24); // L: 5055
							}
							Rasterizer2D.Rasterizer2D_setClip(var2, var3, var2 + var4, var3 + var5); // L:
																										// 5057
							var89 += 2; // L: 5058
						} else {
							var89 += 5; // L: 5061
							if (Client.viewportTempX > -1) { // L: 5062
								var88 = var2 + Client.viewportTempX - (var84 >> 1); // L:
																					// 5063
								var23 = var3 + Client.viewportTempY - var89; // L:
																				// 5064
								Rasterizer2D.Rasterizer2D_fillRectangle(var88, var23, var99, 5, 65280); // L:
																										// 5065
								Rasterizer2D.Rasterizer2D_fillRectangle(var88 + var99, var23, var84 - var99, 5, 16711680); // L:
																															// 5066
							}
							var89 += 2; // L: 5068
						}
			...
			if (var1 < var76) { // L: 5076
				...
				if (var10.headIconPk != -1 || var10.headIconPrayer != -1) { // L:
																			// 5079
					...
					if (Client.viewportTempX > -1) { // L: 5084
						if (var10.headIconPk != -1) { // L: 5085
							var89 += 25; // L: 5086
							Message.headIconPkSprites[var10.headIconPk].drawTransBgAt(var2 + Client.viewportTempX - 12, var3 + Client.viewportTempY - var89); // L:
																																								// 5087
						}
						if (var10.headIconPrayer != -1) { // L: 5089
							var89 += 25; // L: 5090
							class28.headIconPrayerSprites[var10.headIconPrayer].drawTransBgAt(var2 + Client.viewportTempX - 12, var3 + Client.viewportTempY - var89); // L:
																																										// 5091
						}
					}
				}
				if (var1 >= 0 && Client.hintArrowType == 10 && var7[var1] == Client.hintArrowPlayerIndex) { // L:
																											// 5095
					var91 = var0.defaultHeight + 15; // L: 5096
					class220.worldToScreen(var0.x, var0.y, var91); // L: 5098
					if (Client.viewportTempX > -1) { // L: 5100
						var89 += UserComparator4.headIconHintSprites[1].subHeight; // L:
																					// 5101
						UserComparator4.headIconHintSprites[1].drawTransBgAt(var2 + Client.viewportTempX - 12, var3 + Client.viewportTempY - var89); // L:
																																						// 5102
					}
				}
			} else {
				...
				if (var90.headIconPrayer >= 0 && var90.headIconPrayer < class28.headIconPrayerSprites.length) { // L:
					// 5109
					var91 = var0.defaultHeight + 15; // L: 5110
					class220.worldToScreen(var0.x, var0.y, var91); // L: 5112
					if (Client.viewportTempX > -1) { // L: 5114
						class28.headIconPrayerSprites[var90.headIconPrayer].drawTransBgAt(var2 + Client.viewportTempX - 12, var3 + Client.viewportTempY - 30); // L:
						// 5115
					}
				}
				if (Client.hintArrowType == 1 && Client.npcIndices[var1 - var76] == Client.hintArrowNpcIndex && Client.cycle % 20 < 10) { // L:
																																			// 5118
			...
			if (var0.overheadText != null && (var1 >= var76 || !var0.field1152 && (Client.publicChatMode == 4 || !var0.isAutoChatting && (Client.publicChatMode == 0 || Client.publicChatMode == 3 || Client.publicChatMode == 1 && ((Player) var0).isFriend())))) { // L:
																																																																		// 5126
																																																																		// 5127
				var79 = var0.defaultHeight; // L: 5128
				class220.worldToScreen(var0.x, var0.y, var79); // L: 5130
				if (Client.viewportTempX > -1 && Client.overheadTextCount < Client.overheadTextLimit) { // L:
																										// 5132
					Client.overheadTextXOffsets[Client.overheadTextCount] = TileItem.fontBold12.stringWidth(var0.overheadText) / 2; // L:
																																	// 5133
					Client.overheadTextAscents[Client.overheadTextCount] = TileItem.fontBold12.ascent; // L:
																										// 5134
					Client.overheadTextXs[Client.overheadTextCount] = Client.viewportTempX; // L:
																							// 5135
					Client.overheadTextYs[Client.overheadTextCount] = Client.viewportTempY; // L:
																							// 5136
					Client.overheadTextColors[Client.overheadTextCount] = var0.overheadTextColor; // L:
																									// 5137
					Client.overheadTextEffects[Client.overheadTextCount] = var0.overheadTextEffect; // L:
																									// 5138
					Client.overheadTextCyclesRemaining[Client.overheadTextCount] = var0.overheadTextCyclesRemaining; // L:
					// 5139
					Client.overheadText[Client.overheadTextCount] = var0.overheadText; // L:
																						// 5140
			...
			for (var79 = 0; var79 < 4; ++var79) { // L: 5145
				...
				if (var92 >= 0) { // L: 5150
					...
					var98 = Static.method2800(var0.hitSplatTypes[var79]); // L:
																			// 5152
				...
				if (var15 >= 0) { // L: 5165
					var16 = Static.method2800(var15); // L: 5166
				...
				if (var91 - var93 <= Client.cycle) { // L: 5169
					if (var98 == null) { // L: 5170
						...
						class220.worldToScreen(var0.x, var0.y, var17); // L:
																		// 5176
						if (Client.viewportTempX > -1) { // L: 5178
							...
							int var49 = 0; // L: 5286
							var46 = var98.getString(var0.hitSplatValues[var79]); // L:
																					// 5287
							int var95 = var80.stringWidth(var46); // L: 5288
							if (var16 != null) { // L: 5289
								var47 = var16.getString(var0.hitSplatValues2[var79]); // L:
																						// 5290
							...
							var63 = var0.hitSplatCycles[var79] - Client.cycle; // L:
																				// 5348
							int var64 = var98.field2031 - var63 * var98.field2031 / var98.field2026; // L:
																										// 5349
							int var65 = var63 * var98.field2032 / var98.field2026 + -var98.field2032; // L:
																										// 5350
							int var66 = var64 + (var2 + Client.viewportTempX - (var52 >> 1)); // L:
																								// 5351
							...
							if (var74 >= 0 && var74 < 255) { // L: 5370
								...
								if (var20 != null) { // L: 5373
									for (var75 = 0; var75 < var50; ++var75) { // L:
																				// 5374
										var20.drawTransAt(var24 * var75 + (var55 + var66 - var28), var67, var74); // L:
										// 5375
									}
								}
								...
								var80.drawAlpha(var46, var66 + var56, var70, var98.textColor, 0, var74); // L:
																											// 5379
								if (var16 != null) { // L: 5380
									...
									if (var32 != null) { // L: 5383
										for (var75 = 0; var75 < var51; ++var75) { // L:
																					// 5384
											var32.drawTransAt(var75 * var36 + (var66 + var60 - var40), var67, var74); // L:
											// 5385
										}
									}
									...
									var45.drawAlpha(var47, var62 + var66, var73, var16.textColor, 0, var74); // L:
																												// 5389
								}
							} else {
								...
								if (var20 != null) { // L: 5395
									for (var75 = 0; var75 < var50; ++var75) { // L:
																				// 5396
										var20.drawTransBgAt(var24 * var75 + (var55 + var66 - var28), var67); // L:
																												// 5397
									}
								}
								...
								var80.draw(var46, var56 + var66, var70, var98.textColor | -16777216, 0); // L:
																											// 5401
								if (var16 != null) { // L: 5402
									...
									if (var32 != null) { // L: 5405
										for (var75 = 0; var75 < var51; ++var75) { // L:
																					// 5406
											var32.drawTransBgAt(var36 * var75 + (var60 + var66 - var40), var67); // L:
											// 5407
										}
									}
									...
									var45.draw(var47, var62 + var66, var73, var16.textColor | -16777216, 0); // L:
																												// 5411
								}
							}
						}
