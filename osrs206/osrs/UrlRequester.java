...
public abstract class UrlRequester implements Runnable {
	...
	void method2520(URLConnection var1) {
		...
		var1.setRequestProperty("User-Agent", "OldSchoolRuneScape/" + this.field1360); // L:
																						// 56
	} // L: 57
	...
	void method2522(URLConnection var1, UrlRequest var2) {
		...
		try {
			...
			if (var5 >= 0) { // L: 65
				...
				byte[] var8;
				for (int var7 = var3.read(var6, 0, var6.length); var7 > -1; var4 = var8) { // L:
																							// 72
																							// 73
																							// 77
	...
	public void run() {
		while (!this.isClosed) { // L: 28
			try {
				...
				class249.RunException_sendStackTrace((String) null, var7); // L:
																			// 44
			}
		}
	} // L: 47
	...
	static final void method2536() {
		...
		for (var1 = 0; var1 < Players.Players_count; ++var1) { // L: 3897
			...
			if (var4 != null && var4.overheadTextCyclesRemaining > 0) { // L:
																		// 3899
		...
		for (var1 = 0; var1 < Client.npcCount; ++var1) { // L: 3904
			...
			if (var3 != null && var3.overheadTextCyclesRemaining > 0) { // L:
																		// 3907
