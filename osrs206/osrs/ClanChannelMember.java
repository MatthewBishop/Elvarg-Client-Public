...
public class ClanChannelMember {
	...
	public static IndexedSprite[] method2867(AbstractArchive var0, int var1, int var2) {
		if (!Ignored.method6774(var0, var1, var2)) { // L: 23
			...
			IndexedSprite[] var4 = new IndexedSprite[class456.SpriteBuffer_spriteCount]; // L:
																							// 26
			for (int var5 = 0; var5 < class456.SpriteBuffer_spriteCount; ++var5) { // L:
																					// 27
				...
				var6.subWidth = class359.SpriteBuffer_spriteWidths[var5]; // L:
																			// 33
				var6.subHeight = class456.SpriteBuffer_spriteHeights[var5]; // L:
																			// 34
	...
	static int Messages_getHistorySize(int var0) {
		ChatChannel var1 = (ChatChannel) Messages.Messages_channels.get(var0); // L:
																				// 44
