...
public class class133 extends class128 {
	...
	void vmethod3149(ClanSettings var1) {
		var1.method3004(this.field1594, this.field1596, this.field1592, this.field1593); // L:
																							// 299
	} // L: 300
	...
	static final void updateItemPile(int var0, int var1) {
		NodeDeque var2 = Client.groundItems[PacketWriter.Client_plane][var0][var1]; // L:
																					// 7857
		if (var2 == null) { // L: 7858
			class356.scene.removeGroundItemPile(PacketWriter.Client_plane, var0, var1); // L:
																						// 7859
		} else {
			long var3 = -99999999L; // L: 7862
			TileItem var5 = null; // L: 7863
			TileItem var6;
			for (var6 = (TileItem) var2.last(); var6 != null; var6 = (TileItem) var2.previous()) { // L:
																									// 7864
																									// 7865
																									// 7873
				ItemComposition var7 = EnumComposition.ItemDefinition_get(var6.id); // L:
																					// 7866
			...
			if (var5 == null) { // L: 7875
				...
				long var9 = TaskHandler.calculateTag(var0, var1, 3, false, 0); // L:
																				// 7890
				class356.scene.newGroundItemPile(PacketWriter.Client_plane, var0, var1, SceneTilePaint.getTileHeight(var0 * 128 + 64, var1 * 128 + 64, PacketWriter.Client_plane), var5, var9, var13, var8); // L:
																																																				// 7891
			}
		}
	} // L: 7860 7877 7892
