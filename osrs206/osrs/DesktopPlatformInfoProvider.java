...
public class DesktopPlatformInfoProvider implements PlatformInfoProvider {
	...
	public PlatformInfo get() {
		...
		if (NetFileRequest.formattedOperatingSystemName.startsWith("win")) { // L:
																				// 16
			var1 = 1;
		} else if (NetFileRequest.formattedOperatingSystemName.startsWith("mac")) { // L:
																					// 17
			var1 = 2;
		} else if (NetFileRequest.formattedOperatingSystemName.startsWith("linux")) { // L:
																						// 18
			var1 = 3;
		} else {
			var1 = 4; // L: 19
		...
		int var10 = (int) (Runtime.getRuntime().maxMemory() / 1048576L) + 1; // L:
																				// 78
		int var11;
		...
		return new PlatformInfo(var1, var27, var7, var8, this.field4467, this.field4468, this.field4469, false, var10, var11, var12, 0, var13, var14, var15, var16, 0, 0, 0, 0, var17, var18, var23, 0, ""); // L:
																																																				// 98
	}
