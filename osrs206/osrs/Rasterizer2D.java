...
public class Rasterizer2D extends DualNode {
	...
	public static void Rasterizer2D_clear() {
		int var0 = 0; // L: 65
		int var1;
		for (var1 = Rasterizer2D_width * Rasterizer2D_height - 7; var0 < var1; Rasterizer2D_pixels[var0++] = 0) { // L:
			// 66
			// 67
			// 75
		...
		for (var1 += 7; var0 < var1; Rasterizer2D_pixels[var0++] = 0) { // L: 77
																		// 78
		}
	} // L: 79
	static void drawCircle(int var0, int var1, int var2, int var3) {
		if (var2 == 0) { // L: 82
			...
			for (var11 -= var9; var6 < var5; var10 += var9++ + var9) { // L: 117
																		// 118
																		// 131
			...
			if (var4 == 256) { // L: 137
				...
				while (var14 < var1) { // L: 160
					...
					for (var23 = var20; var23 < var21; ++var23) { // L: 170
						var9 = var5 * (Rasterizer2D_pixels[var22] >> 16 & 255); // L:
																				// 171
						var10 = (Rasterizer2D_pixels[var22] >> 8 & 255) * var5; // L:
																				// 172
						var11 = var5 * (Rasterizer2D_pixels[var22] & 255); // L:
																			// 173
						var24 = (var8 + var11 >> 8) + (var6 + var9 >> 8 << 16) + (var7 + var10 >> 8 << 8); // L:
																											// 174
				...
				for (var19 -= var17; var14 < var13; var18 += var17++ + var17) { // L:
																				// 185
																				// 186
																				// 205
	...
	public static void Rasterizer2D_fillRectangleAlpha(int var0, int var1, int var2, int var3, int var4, int var5) {
		...
		var4 = (var5 * (var4 & 16711935) >> 8 & 16711935) + (var5 * (var4 & 65280) >> 8 & 65280); // L:
																									// 220
		...
		for (int var9 = 0; var9 < var3; ++var9) { // L: 224
			for (int var10 = -var2; var10 < 0; ++var10) { // L: 225
				...
				var11 = ((var11 & 16711935) * var6 >> 8 & 16711935) + (var6 * (var11 & 65280) >> 8 & 65280); // L:
																												// 227
	...
	public static void Rasterizer2D_fillRectangleGradient(int var0, int var1, int var2, int var3, int var4, int var5) {
		if (var2 > 0 && var3 > 0) { // L: 256
			...
			for (int var10 = -var3; var10 < 0; ++var10) { // L: 272
				...
				int var13 = (var12 * (var5 & 16711935) + var11 * (var4 & 16711935) & -16711936) + (var12 * (var5 & 65280) + var11 * (var4 & 65280) & 16711680) >>> 8; // L:
																																										// 275
	...
	public static void Rasterizer2D_fillRectangleGradientAlpha(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		if (var2 > 0 && var3 > 0) { // L: 285
			...
			for (int var12 = -var3; var12 < 0; ++var12) { // L: 301
				...
				int var15 = (var13 * var6 + var14 * var7 & 65280) >>> 8; // L:
																			// 304
				if (var15 == 0) { // L: 305
					var11 += Rasterizer2D_width; // L: 306
					var8 += var9; // L: 307
				} else {
					int var16 = (var14 * (var5 & 16711935) + var13 * (var4 & 16711935) & -16711936) + (var14 * (var5 & 65280) + var13 * (var4 & 65280) & 16711680) >>> 8; // L:
																																											// 310
					int var17 = 255 - var15; // L: 311
					int var18 = ((var16 & 16711935) * var15 >> 8 & 16711935) + (var15 * (var16 & 65280) >> 8 & 65280); // L:
					// 312
					for (int var19 = -var2; var19 < 0; ++var19) { // L: 313
						...
						if (var20 == 0) { // L: 315
							...
							var20 = ((var20 & 16711935) * var17 >> 8 & 16711935) + (var17 * (var20 & 65280) >> 8 & 65280); // L:
																															// 319
							Rasterizer2D_pixels[var11++] = var18 + var20; // L:
																			// 320
						}
					}
					var11 += var10; // L: 323
	...
	public static void Rasterizer2D_drawGradientPixels(int var0, int var1, int var2, int var3, int var4, int var5, byte[] var6, int var7) {
		if (var0 + var2 >= 0 && var3 + var1 >= 0) { // L: 329
			if (var0 < Rasterizer2D_width && var1 < Rasterizer2D_height) { // L:
																			// 330
				int var8 = 0; // L: 331
				int var9 = 0; // L: 332
				if (var0 < 0) { // L: 333
				...
				if (var12 == 255 && var13 == 255) { // L: 351
					var14 = var0 + var8 + (var9 + var1) * Rasterizer2D_width; // L:
																				// 352
					for (var15 = var9 + var1; var15 < var3 + var9 + var1; ++var15) { // L:
																						// 353
						for (var16 = var0 + var8; var16 < var0 + var8 + var2; ++var16) { // L:
																							// 354
					...
					for (var15 = var9 + var1; var15 < var3 + var9 + var1; ++var15) { // L:
						...
						for (var16 = var0 + var8; var16 < var0 + var8 + var2; ++var16) { // L:
							...
							int var23 = ((var19 & 16711935) * var20 + (var22 & 16711935) * var21 & -16711936) + (var20 * (var19 & 65280) + var21 * (var22 & 65280) & 16711680) >> 8; // L:
																																														// 374
	...
	public static void Rasterizer2D_drawRectangle(int var0, int var1, int var2, int var3, int var4) {
		...
		Rasterizer2D_drawHorizontalLine(var0, var3 + var1 - 1, var2, var4); // L:
																			// 384
		Rasterizer2D_drawVerticalLine(var0, var1, var3, var4); // L: 385
		Rasterizer2D_drawVerticalLine(var0 + var2 - 1, var1, var3, var4); // L:
																			// 386
	} // L: 387
	public static void Rasterizer2D_drawRectangleAlpha(int var0, int var1, int var2, int var3, int var4, int var5) {
		Rasterizer2D_drawHorizontalLineAlpha(var0, var1, var2, var4, var5); // L:
																			// 390
		Rasterizer2D_drawHorizontalLineAlpha(var0, var3 + var1 - 1, var2, var4, var5); // L:
																						// 391
		if (var3 >= 3) { // L: 392
			Rasterizer2D_drawVerticalLineAlpha(var0, var1 + 1, var3 - 2, var4, var5); // L:
																						// 393
			Rasterizer2D_drawVerticalLineAlpha(var0 + var2 - 1, var1 + 1, var3 - 2, var4, var5); // L:
																									// 394
		}
	} // L: 396
	public static void Rasterizer2D_drawHorizontalLine(int var0, int var1, int var2, int var3) {
		if (var1 >= Rasterizer2D_yClipStart && var1 < Rasterizer2D_yClipEnd) { // L:
																				// 399
	...
	static void Rasterizer2D_drawHorizontalLineAlpha(int var0, int var1, int var2, int var3, int var4) {
		if (var1 >= Rasterizer2D_yClipStart && var1 < Rasterizer2D_yClipEnd) { // L:
			...
			for (int var13 = 0; var13 < var2; ++var13) { // L: 424
				int var9 = var5 * (Rasterizer2D_pixels[var12] >> 16 & 255); // L:
																			// 425
				int var10 = (Rasterizer2D_pixels[var12] >> 8 & 255) * var5; // L:
																			// 426
				int var11 = var5 * (Rasterizer2D_pixels[var12] & 255); // L: 427
				int var14 = (var8 + var11 >> 8) + (var6 + var9 >> 8 << 16) + (var7 + var10 >> 8 << 8); // L:
																										// 428
	...
	public static void Rasterizer2D_drawVerticalLine(int var0, int var1, int var2, int var3) {
		if (var0 >= Rasterizer2D_xClipStart && var0 < Rasterizer2D_xClipEnd) { // L:
																				// 434
	...
	public static void Rasterizer2D_drawLine(int var0, int var1, int var2, int var3, int var4) {
		...
		if (var3 == 0) { // L: 472
			if (var2 >= 0) { // L: 473
				...
				Rasterizer2D_drawHorizontalLine(var0 + var2, var1, -var2 + 1, var4); // L:
																						// 474
			}
			...
			if (var3 >= 0) { // L: 478
				...
				Rasterizer2D_drawVerticalLine(var0, var3 + var1, -var3 + 1, var4); // L:
																					// 479
			}
		} else {
			...
			if (var2 > var3) { // L: 488
				...
				var1 += 32768; // L: 490
				var3 <<= 16; // L: 491
				var5 = (int) Math.floor((double) var3 / (double) var2 + 0.5D); // L:
																				// 492
				var2 += var0; // L: 493
				...
				while (var0 <= var2) { // L: 499
					var6 = var1 >> 16; // L: 500
					if (var6 >= Rasterizer2D_yClipStart && var6 < Rasterizer2D_yClipEnd) { // L:
																							// 501
				...
				var0 += 32768; // L: 508
				var2 <<= 16; // L: 509
				var5 = (int) Math.floor((double) var2 / (double) var3 + 0.5D); // L:
																				// 510
				var3 += var1; // L: 511
				...
				while (var1 <= var3) { // L: 517
					var6 = var0 >> 16; // L: 518
					if (var6 >= Rasterizer2D_xClipStart && var6 < Rasterizer2D_xClipEnd) { // L:
																							// 519
	...
	static void Rasterizer2D_setPixel(int var0, int var1, int var2) {
		if (var0 >= Rasterizer2D_xClipStart && var1 >= Rasterizer2D_yClipStart && var0 < Rasterizer2D_xClipEnd && var1 < Rasterizer2D_yClipEnd) { // L:
																																					// 527
			Rasterizer2D_pixels[var0 + Rasterizer2D_width * var1] = var2; // L:
																			// 528
		}
	} // L: 529
