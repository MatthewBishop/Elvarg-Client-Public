...
public class ViewportMouse {
	...
	static int method4514(int var0, Script var1, boolean var2) {
		...
		if (var0 >= 2000) { // L: 1041
			var0 -= 1000; // L: 1042
			var3 = class140.getWidget(Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]); // L:
																												// 1043
		} else {
			var3 = var2 ? class124.scriptDotWidget : GrandExchangeOfferOwnWorldComparator.scriptActiveWidget; // L:
																												// 1045
		}
		String var4 = Interpreter.Interpreter_stringStack[--Interpreter.Interpreter_stringStackSize]; // L:
																										// 1046
		int[] var5 = null; // L: 1047
		if (var4.length() > 0 && var4.charAt(var4.length() - 1) == 'Y') { // L:
																			// 1048
			int var6 = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]; // L:
																								// 1049
			if (var6 > 0) { // L: 1050
				for (var5 = new int[var6]; var6-- > 0; var5[var6] = Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]) { // L:
					// 1051
					// 1052
				}
			}
		...
		for (var7 = var8.length - 1; var7 >= 1; --var7) { // L: 1057
			if (var4.charAt(var7 - 1) == 's') { // L: 1058
				...
				var8[var7] = new Integer(Interpreter.Interpreter_intStack[--class446.Interpreter_intStackSize]); // L:
				// 1059
			}
		}
		...
		if (var0 == ScriptOpcodes.CC_SETONCLICK) {
			...
			var3.onResize = var8;
		} else if (var0 == ScriptOpcodes.CC_SETONCLANSETTINGSTRANSMIT) { // L:
																			// 1100
			var3.field3365 = var8;
		} else if (var0 == ScriptOpcodes.CC_SETONCLANCHANNELTRANSMIT) { // L:
																		// 1101
			var3.field3353 = var8;
		} else if (var0 == 1430) {
	...
	static void load() {
		...
		if (Client.titleLoadingStage == 0) { // L: 1657
			class356.scene = new Scene(4, 104, 104, Tiles.Tiles_heights); // L:
																			// 1658
			for (var26 = 0; var26 < 4; ++var26) { // L: 1659
				Client.collisionMaps[var26] = new CollisionMap(104, 104);
			}
			FloorUnderlayDefinition.sceneMinimapSprite = new SpritePixels(512, 512); // L:
																						// 1660
			...
			Varcs.archive5 = ModeWhere.newArchive(0, false, true, true, false); // L:
																				// 1673
			WorldMapEvent.field2882 = ModeWhere.newArchive(1, false, true, true, false); // L:
																							// 1674
			class140.archive2 = ModeWhere.newArchive(2, true, false, true, false); // L:
																					// 1675
			class341.archive7 = ModeWhere.newArchive(3, false, true, true, false); // L:
																					// 1676
			Archives.archive4 = ModeWhere.newArchive(4, false, true, true, false); // L:
																					// 1677
			WorldMapSectionType.archive9 = ModeWhere.newArchive(5, true, true, true, false); // L:
																								// 1678
			Archives.archive6 = ModeWhere.newArchive(6, true, true, true, false); // L:
																					// 1679
			class10.archive7 = ModeWhere.newArchive(7, false, true, true, false); // L:
																					// 1680
			class304.archive8 = ModeWhere.newArchive(8, false, true, true, false); // L:
																					// 1681
			Language.field4098 = ModeWhere.newArchive(9, false, true, true, false); // L:
																					// 1682
			ApproximateRouteStrategy.archive10 = ModeWhere.newArchive(10, false, true, true, false); // L:
																										// 1683
			Archives.archive11 = ModeWhere.newArchive(11, false, true, true, false); // L:
																							// 1684
			class267.archive12 = ModeWhere.newArchive(12, false, true, true, false); // L:
																						// 1685
			AbstractByteArrayCopier.archive13 = ModeWhere.newArchive(13, true, false, true, false); // L:
																									// 1686
			Archives.archive14 = ModeWhere.newArchive(14, false, true, true, false); // L:
																							// 1687
			Archives.archive15 = ModeWhere.newArchive(15, false, true, true, false); // L:
																					// 1688
			class6.archive17 = ModeWhere.newArchive(17, true, true, true, false); // L:
																					// 1689
			AbstractUserComparator.archive18 = ModeWhere.newArchive(18, false, true, true, false); // L:
																									// 1690
			MouseHandler.archive19 = ModeWhere.newArchive(19, false, true, true, false); // L:
																							// 1691
			class4.archive20 = ModeWhere.newArchive(20, false, true, true, false); // L:
																					// 1692
			class132.field1588 = ModeWhere.newArchive(21, false, true, true, true); // L:
																					// 1693
			...
			if (Client.titleLoadingStage == 45) { // L: 1747
				StaticSound.setup(!Client.isLowDetail, Archives.archive4, Archives.archive6, Archives.archive11, Archives.archive14, Archives.archive15);
				...
				_Junk.WorldMapElement_fonts = new Fonts(class304.archive8, AbstractByteArrayCopier.archive13); // L:
				// 1769
			} else if (Client.titleLoadingStage == 50) { // L: 1772
				var26 = FontName.method7382().length; // L: 1773
				Client.fontsMap = _Junk.WorldMapElement_fonts.createMap(FontName.method7382()); // L:
																									// 1774
				if (Client.fontsMap.size() < var26) { // L: 1775
					Login.Login_loadingText = "Loading fonts - " + Client.fontsMap.size() * 100 / var26 + "%"; // L:
					// 1776
					Login.Login_loadingPercent = 40; // L: 1777
				} else {
					MouseHandler.fontPlain11 = (Font) Client.fontsMap.get(FontName.FontName_plain11); // L:
																										// 1780
					_Junk.fontPlain12 = (Font) Client.fontsMap.get(FontName.FontName_plain12); // L:
					// 1781
					TileItem.fontBold12 = (Font) Client.fontsMap.get(FontName.FontName_bold12); // L:
																								// 1782
					Occluder.platformInfo = Client.platformInfoProvider.get(); // L:
																				// 1783
				...
				if (Client.titleLoadingStage == 60) { // L: 1789
					var26 = HealthBarUpdate.method2203(ApproximateRouteStrategy.archive10, class304.archive8); // L:
					// 1790
					var1 = Login.field924.length + Login.field916.length; // L:
																			// 1793
					if (var26 < var1) { // L: 1796
						Login.Login_loadingText = "Loading title screen - " + var26 * 100 / var1 + "%"; // L:
																										// 1797
						Login.Login_loadingPercent = 50; // L: 1798
					} else {
						Login.Login_loadingText = "Loaded title screen"; // L:
																			// 1801
					...
					if (!class140.archive2.isFullyLoaded()) { // L: 1808
						Login.Login_loadingText = "Loading config - " + class140.archive2.loadPercent() + "%"; // L:
						// 1809
						Login.Login_loadingPercent = 60; // L: 1810
					} else if (!class132.field1588.isFullyLoaded()) { // L: 1813
						Login.Login_loadingText = "Loading config - " + (80 + class267.archive12.loadPercent() / 6) + "%"; // L:
																															// 1814
						Login.Login_loadingPercent = 60; // L: 1815
					} else {
						class146.method3082(class140.archive2); // L: 1818
						Archive var24 = class140.archive2; // L: 1819
						FloorUnderlayDefinition.FloorUnderlayDefinition_archive = var24; // L:
																							// 1821
						var20 = class140.archive2; // L: 1823
						var21 = class10.archive7; // L: 1824
						KitDefinition.KitDefinition_archive = var20; // L: 1826
						KitDefinition.KitDefinition_modelsArchive = var21; // L:
																			// 1827
						KitDefinition.KitDefinition_fileCount = KitDefinition.KitDefinition_archive.getGroupFileCount(3); // L:
																															// 1828
						PacketWriter.method2517(class140.archive2, class10.archive7, Client.isLowDetail); // L:
																											// 1830
						var22 = class140.archive2; // L: 1831
						Archive var23 = class10.archive7; // L: 1832
						NPCComposition.NpcDefinition_archive = var22; // L: 1834
						NPCComposition.NpcDefinition_modelArchive = var23; // L:
																			// 1835
						GrandExchangeOfferNameComparator.method5979(class140.archive2); // L:
																						// 1837
						class114.method2636(class140.archive2, class10.archive7, Client.isMembersWorld, MouseHandler.fontPlain11); // L:
																																	// 1838
						Anim_SequenceDefinition.method762(class140.archive2, Varcs.archive5, WorldMapEvent.field2882); // L:
																											// 1839
						Archive var5 = class140.archive2; // L: 1840
						Archive var6 = class10.archive7; // L: 1841
						SpotAnimationDefinition.SpotAnimationDefinition_archive = var5; // L:
																						// 1843
						class147.SpotAnimationDefinition_modelArchive = var6; // L:
																				// 1844
						Archive var7 = class140.archive2; // L: 1846
						VarbitComposition.VarbitDefinition_archive = var7; // L:
																			// 1848
						Archive var8 = class140.archive2; // L: 1850
						VarpDefinition.VarpDefinition_archive = var8; // L: 1852
						VarpDefinition.field1822 = VarpDefinition.VarpDefinition_archive.getGroupFileCount(16); // L:
						// 1853
						Archive var9 = class341.archive7; // L: 1855
						Archive var10 = class10.archive7; // L: 1856
						Archive var11 = class304.archive8; // L: 1857
						Archive var12 = AbstractByteArrayCopier.archive13; // L:
																			// 1858
						_Junk.Widget_archive = var9; // L: 1860
						class126.Widget_modelsArchive = var10; // L: 1861
						StructComposition.Widget_spritesArchive = var11; // L:
																			// 1862
						MilliClock.Widget_fontsArchive = var12; // L: 1863
						_Junk.Widget_interfaceComponents = new Widget[_Junk.Widget_archive.getGroupCount()][]; // L:
																																	// 1864
						class228.Widget_loadedInterfaces = new boolean[_Junk.Widget_archive.getGroupCount()]; // L:
																															// 1865
						LoginScreenAnimation.method2233(class140.archive2); // L:
																			// 1867
						WorldMapSection0.method4936(class140.archive2); // L:
																		// 1868
						...
						ParamComposition.ParamDefinition_archive = var13; // L:
																			// 1873
						class138.method2948(class140.archive2); // L: 1875
						Static.method2700(class140.archive2); // L: 1876
						AbstractWorldMapData.HitSplatDefinition_cachedSprites = new class427(class285.field3313, 54, class134.clientLanguage, class140.archive2); // L:
																																									// 1877
						ModeWhere.HitSplatDefinition_cached = new class427(class285.field3313, 47, class134.clientLanguage, class140.archive2); // L:
																																				// 1878
						class308.varcs = new Varcs(); // L: 1879
						Archive var14 = class140.archive2; // L: 1880
						Archive var15 = class304.archive8; // L: 1881
						Archive var16 = AbstractByteArrayCopier.archive13; // L:
																			// 1882
						HitSplatDefinition.HitSplatDefinition_archive = var14; // L:
																				// 1884
						HitSplatDefinition.field2017 = var15; // L: 1885
						class4.HitSplatDefinition_fontsArchive = var16; // L:
																		// 1886
						Archive var17 = class140.archive2; // L: 1888
						Archive var18 = class304.archive8; // L: 1889
						HealthBarDefinition.HealthBarDefinition_archive = var17; // L:
																					// 1891
						HealthBarDefinition.field1877 = var18; // L: 1892
						Static.method2691(class140.archive2, class304.archive8); // L:
																					// 1894
					...
					if (UserComparator4.headIconHintSprites == null) { // L:
																		// 1912
					...
					if (var26 < 11) { // L: 1924
						Login.Login_loadingText = "Loading sprites - " + var26 * 100 / 12 + "%"; // L:
																									// 1925
						Login.Login_loadingPercent = 70; // L: 1926
					} else {
						AbstractFont.AbstractFont_modIconSprites = ClientPreferences.modIconSprites; // L:
																										// 1929
						class344.redHintArrowSprite.normalize(); // L: 1930
						var1 = (int) (Math.random() * 21.0D) - 10; // L: 1931
						int var2 = (int) (Math.random() * 21.0D) - 10; // L:
																		// 1932
						int var3 = (int) (Math.random() * 21.0D) - 10; // L:
																		// 1933
						int var4 = (int) (Math.random() * 41.0D) - 20; // L:
																		// 1934
						class13.mapSceneSprites[0].shiftColors(var4 + var1, var4 + var2, var3 + var4); // L:
																										// 1935
					...
					if (!Language.field4098.isFullyLoaded()) { // L: 1942
						Login.Login_loadingText = "Loading textures - " + "0%"; // L:
																				// 1943
						Login.Login_loadingPercent = 90; // L: 1944
					} else {
						class12.textureProvider = new TextureProvider(Language.field4098, class304.archive8, 20, class19.clientPreferences.method2254(), Client.isLowDetail ? 64 : 128); // L:
																																															// 1947
						Rasterizer3D.Rasterizer3D_setTextureLoader(class12.textureProvider); // L:
																								// 1948
						Rasterizer3D.Rasterizer3D_setBrightness(class19.clientPreferences.method2254()); // L:
																											// 1949
						Client.titleLoadingStage = 100; // L: 1950
					}
				} else if (Client.titleLoadingStage == 100) { // L: 1953
					var26 = class12.textureProvider.getLoadedPercentage(); // L:
																			// 1954
					if (var26 < 100) { // L: 1955
						Login.Login_loadingText = "Loading textures - " + var26 + "%"; // L:
																						// 1956
					...
					GameEngine.taskHandler.newThreadTask(ItemLayer.mouseRecorder, 10); // L:
																						// 1967
					...
					if (!ApproximateRouteStrategy.archive10.tryLoadFileByNames("huffman", "")) { // L:
																									// 1974
						Login.Login_loadingText = "Loading wordpack - " + 0 + "%"; // L:
																					// 1975
						Login.Login_loadingPercent = 94; // L: 1976
					} else {
						Huffman var0 = new Huffman(ApproximateRouteStrategy.archive10.takeFileByNames("huffman", "")); // L:
						// 1979
					...
					if (!class341.archive7.isFullyLoaded()) { // L: 1989
						Login.Login_loadingText = "Loading interfaces - " + class341.archive7.loadPercent() * 4 / 5 + "%"; // L:
																															// 1990
						Login.Login_loadingPercent = 96; // L: 1991
					} else if (!class267.archive12.isFullyLoaded()) { // L: 1994
						Login.Login_loadingText = "Loading interfaces - " + (80 + class267.archive12.loadPercent() / 6) + "%"; // L:
																																// 1995
						Login.Login_loadingPercent = 96; // L: 1996
					} else if (!AbstractByteArrayCopier.archive13.isFullyLoaded()) { // L:
																						// 1999
						Login.Login_loadingText = "Loading interfaces - " + (96 + AbstractByteArrayCopier.archive13.loadPercent() / 50) + "%"; // L:
																																				// 2000
						Login.Login_loadingPercent = 96; // L: 2001
					} else {
						Login.Login_loadingText = "Loaded interfaces"; // L:
																		// 2004
					...
					if (!MouseHandler.archive19.tryLoadGroupByName(WorldMapCacheName.field2867.name)) { // L:
																										// 2011
						Login.Login_loadingText = "Loading world map - " + MouseHandler.archive19.groupLoadPercentByName(WorldMapCacheName.field2867.name) / 10 + "%"; // L:
																																										// 2012
					} else {
						if (class121.worldMap == null) { // L: 2015
							class121.worldMap = new WorldMap(); // L: 2016
							class121.worldMap.init(MouseHandler.archive19, AbstractUserComparator.archive18, class4.archive20, TileItem.fontBold12, Client.fontsMap, class13.mapSceneSprites); // L:
							// 2017
						}
			...
			var26 += Archives.archive4.percentage() * 6 / 100; // L: 1705
			var26 += WorldMapSectionType.archive9.percentage() * 4 / 100; // L:
																			// 1706
			var26 += Archives.archive6.percentage() * 2 / 100; // L: 1707
			var26 += class10.archive7.percentage() * 55 / 100; // L: 1708
			var26 += class304.archive8.percentage() * 2 / 100; // L: 1709
			var26 += Language.field4098.percentage() * 2 / 100; // L: 1710
			var26 += ApproximateRouteStrategy.archive10.percentage() * 2 / 100; // L:
																				// 1711
			var26 += Archives.archive11.percentage() * 2 / 100; // L:
																		// 1712
			var26 += class267.archive12.percentage() * 2 / 100; // L: 1713
			var26 += AbstractByteArrayCopier.archive13.percentage() * 2 / 100; // L:
																				// 1714
			var26 += Archives.archive14.percentage() * 2 / 100; // L: 1715
			var26 += Archives.archive15.percentage() * 2 / 100; // L: 1716
			var26 += MouseHandler.archive19.percentage() / 100; // L: 1717
			var26 += AbstractUserComparator.archive18.percentage() / 100; // L:
																			// 1718
			var26 += class4.archive20.percentage() / 100; // L: 1719
			var26 += class132.field1588.percentage() / 100; // L: 1720
			var26 += class6.archive17.method5795() && class6.archive17.isFullyLoaded() ? 1 : 0; // L:
																								// 1721
			if (var26 != 100) { // L: 1722
				if (var26 != 0) { // L: 1723
				...
				HealthBarUpdate.method2202(Varcs.archive5, "Animations"); // L:
																			// 1727
				HealthBarUpdate.method2202(WorldMapEvent.field2882, "Skeletons"); // L:
																					// 1728
				HealthBarUpdate.method2202(Archives.archive4, "Sound FX"); // L:
																			// 1729
				HealthBarUpdate.method2202(WorldMapSectionType.archive9, "Maps"); // L:
																					// 1730
				HealthBarUpdate.method2202(Archives.archive6, "Music Tracks"); // L:
																				// 1731
				HealthBarUpdate.method2202(class10.archive7, "Models"); // L:
																			// 1732
				HealthBarUpdate.method2202(class304.archive8, "Sprites"); // L:
																			// 1733
				HealthBarUpdate.method2202(Archives.archive11, "Music Jingles"); // L:
																						// 1734
				HealthBarUpdate.method2202(Archives.archive14, "Music Samples"); // L:
																						// 1735
				HealthBarUpdate.method2202(Archives.archive15, "Music Patches"); // L:
																				// 1736
				HealthBarUpdate.method2202(MouseHandler.archive19, "World Map"); // L:
																					// 1737
				HealthBarUpdate.method2202(AbstractUserComparator.archive18, "World Map Geography"); // L:
																										// 1738
				HealthBarUpdate.method2202(class4.archive20, "World Map Ground"); // L:
																					// 1739
				LoginScreenAnimation.spriteIds = new GraphicsDefaults(); // L:
																			// 1740
				LoginScreenAnimation.spriteIds.decode(class6.archive17); // L:
																			// 1741
	...
	} // L: 1664 1670 1697 1725 1745 1770 1778 1787 1799 1805 1811 1816 1898
		// 1927 1939
		// 1945 1951 1958 1963 1971 1977 1986 1992 1997 2002 2007 2013 2021 2025
		// 2027
}
