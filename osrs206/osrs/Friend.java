...
public class Friend extends Buddy {
	...
	int compareToFriend(Friend var1) {
		if (super.world == Client.worldId && Client.worldId != var1.world) { // L:
																				// 12
			return -1;
		} else if (Client.worldId == var1.world && super.world != Client.worldId) { // L:
																					// 13
			return 1;
			...
			return super.world != 0 ? super.int2 - var1.int2 : var1.int2 - super.int2; // L:
																						// 20
																						// 21
																						// 24
		}
	...
	static File method6630(String var0, String var1, int var2) {
		...
		class267.JagexCache_locationFile = new File(Static.userHomeDirectory, "jagex_cl_" + var0 + "_" + var1 + var3 + ".dat"); // L:
																																	// 124
		...
		if (class267.JagexCache_locationFile.exists()) { // L: 128
			try {
				AccessFile var7 = new AccessFile(class267.JagexCache_locationFile, "rw", 10000L); // L:
																									// 131
				int var9;
				for (var8 = new Buffer((int) var7.length()); var8.offset < var8.array.length; var8.offset += var9) { // L:
					// 132
					// 133
					// 136
					var9 = var7.read(var8.array, var8.offset, var8.array.length - var8.offset); // L:
																								// 134
					if (var9 == -1) { // L: 135
		...
		if (var4 == null && var2 == 0) { // L: 169
			label140 : for (int var15 = 0; var15 < JagexCache.cacheSubPaths.length; ++var15) { // L:
																								// 170
				for (int var16 = 0; var16 < Fonts.cacheParentPaths.length; ++var16) { // L:
																						// 171
					File var17 = new File(Fonts.cacheParentPaths[var16] + JagexCache.cacheSubPaths[var15] + File.separatorChar + var0 + File.separatorChar); // L:
																																								// 172
					if (var17.exists() && Varcs.method2474(new File(var17, "test.dat"), true)) { // L:
																									// 173
																									// 174
		...
		if (var4 == null) { // L: 183
			var4 = Static.userHomeDirectory + File.separatorChar + "jagexcache" + var3 + File.separatorChar + var0 + File.separatorChar + var1 + File.separatorChar; // L:
																																										// 184
			var6 = true; // L: 185
		}
		File var22;
		...
		if (var6) { // L: 209
			...
			var8 = null; // L: 211
			try {
				AccessFile var25 = new AccessFile(class267.JagexCache_locationFile, "rw", 10000L); // L:
																									// 215
	...
	static int method6619(int var0, Script var1, boolean var2) {
		if (var0 < 1000) { // L: 435
			...
			return Static.method2682(var0, var1, var2);
		} else if (var0 < 3300) { // L: 457
			return _Junk.method1019(var0, var1, var2);
			...
			return var0 < 7700 ? UserComparator3.method2590(var0, var1, var2) : 2; // L:
																					// 483
																					// 484
		}
	}
