...
public class NPCComposition extends DualNode {
	...
	public final Model getModel(Anim_SequenceDefinition var1, int var2, Anim_SequenceDefinition var3, int var4) {
		if (this.transforms != null) { // L: 183
			NPCComposition var12 = this.transform(); // L: 184
			return var12 == null ? null : var12.getModel(var1, var2, var3, var4); // L:
																					// 185
																					// 186
		} else {
			Model var5 = (Model) NpcDefinition_cachedModels.get((long) this.id); // L:
																					// 188
			if (var5 == null) { // L: 189
				boolean var6 = false; // L: 190
				for (int var7 = 0; var7 < this.models.length; ++var7) { // L:
																		// 191
				...
				if (this.recolorFrom != null) { // L: 198
					for (var9 = 0; var9 < this.recolorFrom.length; ++var9) { // L:
																				// 199
						var10.recolor(this.recolorFrom[var9], this.recolorTo[var9]); // L:
																						// 200
					}
				}
				if (this.retextureFrom != null) { // L: 203
					for (var9 = 0; var9 < this.retextureFrom.length; ++var9) { // L:
																				// 204
						var10.retexture(this.retextureFrom[var9], this.retextureTo[var9]); // L:
																							// 205
					}
				}
				var5 = var10.toModel(this.ambient + 64, this.contrast + 850, -30, -50, -30); // L:
																								// 208
	...
	public final ModelData getModelData() {
		if (this.transforms != null) { // L: 221
			...
			if (var1) { // L: 229
				...
				ModelData[] var5 = new ModelData[this.field1957.length]; // L:
																			// 230
				for (int var3 = 0; var3 < this.field1957.length; ++var3) { // L:
																			// 231
	...
	public final NPCComposition transform() {
		...
		return var2 != -1 ? BuddyRankComparator.getNpcDefinition(var2) : null; // L:
																				// 255
																				// 256
	}
