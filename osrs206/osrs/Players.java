...
public class Players {
	...
	static final void loadTerrain(Buffer var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		...
		if (var2 >= 0 && var2 < 104 && var3 >= 0 && var3 < 104) { // L: 145
			...
			while (true) {
				...
				if (var7 == 0) { // L: 149
					if (var1 == 0) {
						Tiles.Tiles_heights[0][var2][var3] = -class14.method156(var2 + 932731 + var4, 556238 + var3 + var5) * 8; // L:
																																	// 150
					} else {
						Tiles.Tiles_heights[var1][var2][var3] = Tiles.Tiles_heights[var1 - 1][var2][var3] - 240; // L:
						// 151
					}
					break;
				}
				if (var7 == 1) { // L: 154
					...
					if (var1 == 0) { // L: 157
						...
						Tiles.Tiles_heights[var1][var2][var3] = Tiles.Tiles_heights[var1 - 1][var2][var3] - var8 * 8; // L:
						// 158
					}
					break;
				}
				if (var7 <= 49) { // L: 161
					Tiles.Tiles_overlays[var1][var2][var3] = var0.readByte(); // L:
																				// 162
					Tiles.Tiles_shapes[var1][var2][var3] = (byte) ((var7 - 2) / 4); // L:
																					// 163
					Tiles.field996[var1][var2][var3] = (byte) (var7 - 2 + var6 & 3); // L:
																						// 164
				} else if (var7 <= 81) { // L: 167
					Tiles.Tiles_renderFlags[var1][var2][var3] = (byte) (var7 - 49); // L:
																					// 168
				} else {
					Tiles.Tiles_underlays[var1][var2][var3] = (byte) (var7 - 81); // L:
																					// 171
				}
			}
		} else {
	...
	static final void Clan_joinChat(String var0) {
		if (!var0.equals("")) { // L: 12233
			PacketBufferNode var1 = EnumComposition.getPacketBufferNode(ClientPacket.field2942, Client.packetWriter.isaacCipher); // L:
																																	// 12235
