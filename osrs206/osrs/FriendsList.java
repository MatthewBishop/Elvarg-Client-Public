...
public class FriendsList extends UserList {
	...
	public void read(Buffer var1, int var2) {
		while (true) {
			if (var1.offset < var2) { // L: 40
				...
				Username var4 = new Username(var1.readStringCp1252NullTerminated(), this.loginType); // L:
																										// 42
				...
				if (var4 != null && var4.hasCleanName()) { // L: 55
					Friend var11 = (Friend) this.getByCurrentUsername(var4); // L:
																				// 56
					if (var3) { // L: 57
						Friend var12 = (Friend) this.getByCurrentUsername(var5); // L:
																					// 58
					...
					if (var11 != null) { // L: 68
						...
						if (var6 != var11.world) { // L: 70
							...
							for (FriendLoginUpdate var13 = (FriendLoginUpdate) this.friendLoginUpdates.last(); var13 != null; var13 = (FriendLoginUpdate) this.friendLoginUpdates.previous()) { // L:
																																																// 72
								if (var13.username.equals(var4)) { // L: 73
									if (var6 != 0 && var13.world == 0) { // L:
																			// 74
										var13.remove(); // L: 75
										var14 = false; // L: 76
									} else if (var6 == 0 && var13.world != 0) { // L:
																				// 78
										var13.remove(); // L: 79
										var14 = false; // L: 80
									}
	...
	static final void menuAction(int var0, int var1, int var2, int var3, String var4, String var5, int var6, int var7) {
		...
		if (var2 == 1) { // L: 8711
			...
			var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2979, Client.packetWriter.isaacCipher); // L:
			// 8844
			var8.packetBuffer.method7863(EnumComposition.selectedItemSlot); // L:
																			// 8845
			var8.packetBuffer.writeShort(WorldMapLabelSize.baseY + var1); // L:
																			// 8846
			var8.packetBuffer.method7763(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
																							// 8847
			var8.packetBuffer.writeIntME(var3); // L: 8848
			var8.packetBuffer.writeShort(WorldMapIcon_0.selectedItemId); // L:
																			// 8849
			var8.packetBuffer.method7784(ModeWhere.selectedItemWidget); // L:
																		// 8850
			...
			var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2992, Client.packetWriter.isaacCipher); // L:
			// 8936
			var8.packetBuffer.writeIntME(WorldMapLabelSize.baseY + var1); // L:
																			// 8937
			var8.packetBuffer.writeShort(var3); // L: 8938
			var8.packetBuffer.method7929(var0 + class28.baseX); // L: 8939
			var8.packetBuffer.writeIntME(Client.selectedSpellChildIndex); // L:
																			// 8940
			var8.packetBuffer.method7763(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
																							// 8941
			var8.packetBuffer.method7784(NetCache.selectedSpellWidget); // L:
																		// 8942
			...
			var8 = EnumComposition.getPacketBufferNode(ClientPacket.field3005, Client.packetWriter.isaacCipher); // L:
			// 8978
			var8.packetBuffer.method7929(WorldMapLabelSize.baseY + var1); // L:
																			// 8979
			...
			var8 = EnumComposition.getPacketBufferNode(ClientPacket.field3003, Client.packetWriter.isaacCipher); // L:
			// 9083
			var8.packetBuffer.method7762(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
																							// 9084
			var8.packetBuffer.writeShort(WorldMapLabelSize.baseY + var1); // L:
																			// 9085
			...
			var8 = EnumComposition.getPacketBufferNode(ClientPacket.field3009, Client.packetWriter.isaacCipher); // L:
			// 8877
			var8.packetBuffer.method7763(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
																							// 8878
			var8.packetBuffer.method7863(var0 + class28.baseX); // L: 8879
			var8.packetBuffer.method7863(WorldMapLabelSize.baseY + var1); // L:
																			// 8880
			...
			var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2936, Client.packetWriter.isaacCipher); // L:
			// 9330
			var8.packetBuffer.method7929(WorldMapLabelSize.baseY + var1); // L:
																			// 9331
			...
			if (var2 == 7) {
				...
				if (var13 != null) { // L: 9445
					...
					var9 = EnumComposition.getPacketBufferNode(ClientPacket.field2910, Client.packetWriter.isaacCipher); // L:
					// 9453
					var9.packetBuffer.writeInt(ModeWhere.selectedItemWidget); // L:
																				// 9454
					var9.packetBuffer.writeIntME(EnumComposition.selectedItemSlot); // L:
																					// 9455
					var9.packetBuffer.method7929(var3); // L: 9456
					var9.packetBuffer.writeIntME(WorldMapIcon_0.selectedItemId); // L:
																					// 9457
					var9.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
																								// 9458
				...
				if (var13 != null) { // L: 9006
					...
					var9 = EnumComposition.getPacketBufferNode(ClientPacket.field2911, Client.packetWriter.isaacCipher); // L:
					// 9013
					var9.packetBuffer.method7760(NetCache.selectedSpellWidget); // L:
																				// 9014
					var9.packetBuffer.writeShort(Client.selectedSpellChildIndex); // L:
																					// 9015
					var9.packetBuffer.writeShort(Client.selectedSpellItemId); // L:
																				// 9016
				...
				if (var13 != null) { // L: 9276
					...
					var9 = EnumComposition.getPacketBufferNode(ClientPacket.field2939, Client.packetWriter.isaacCipher); // L:
					// 9284
					var9.packetBuffer.method7863(var3); // L: 9285
					var9.packetBuffer.method7764(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
																									// 9286
				...
				if (var13 != null) { // L: 8713
					...
					var9 = EnumComposition.getPacketBufferNode(ClientPacket.field2948, Client.packetWriter.isaacCipher); // L:
					// 8721
					var9.packetBuffer.method7763(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
																									// 8722
				...
				if (var13 != null) { // L: 9464
					...
					var9 = EnumComposition.getPacketBufferNode(ClientPacket.field2984, Client.packetWriter.isaacCipher); // L:
					// 9472
					var9.packetBuffer.method7863(var3); // L: 9473
					var9.packetBuffer.method7762(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
																									// 9474
				...
				if (var13 != null) { // L: 9046
					...
					var9 = EnumComposition.getPacketBufferNode(ClientPacket.field2940, Client.packetWriter.isaacCipher); // L:
					// 9054
				...
				if (var13 != null) { // L: 8753
					...
					var9 = EnumComposition.getPacketBufferNode(ClientPacket.field2907, Client.packetWriter.isaacCipher); // L:
					// 8761
				...
				if (var2 == 14) {
					...
					if (var15 != null) { // L: 8769
						...
						var9 = EnumComposition.getPacketBufferNode(ClientPacket.field2908, Client.packetWriter.isaacCipher); // L:
																																// 8777
						var9.packetBuffer.method7863(var3); // L: 8778
						var9.packetBuffer.method7863(WorldMapIcon_0.selectedItemId); // L:
																						// 8779
						var9.packetBuffer.method7764(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
																										// 8780
						var9.packetBuffer.method7863(EnumComposition.selectedItemSlot); // L:
																						// 8781
						var9.packetBuffer.writeInt(ModeWhere.selectedItemWidget); // L:
																					// 8782
					...
					if (var15 != null) { // L: 9185
						...
						var9 = EnumComposition.getPacketBufferNode(ClientPacket.field2924, Client.packetWriter.isaacCipher); // L:
																																// 9192
						var9.packetBuffer.writeShort(Client.selectedSpellChildIndex); // L:
																						// 9193
						...
						var9.packetBuffer.method7763(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
																										// 9195
						var9.packetBuffer.writeInt(NetCache.selectedSpellWidget); // L:
																					// 9196
						var9.packetBuffer.writeIntME(Client.selectedSpellItemId); // L:
																					// 9197
					...
					var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2997, Client.packetWriter.isaacCipher); // L:
					// 8907
					var8.packetBuffer.writeShort(WorldMapLabelSize.baseY + var1); // L:
																					// 8908
					var8.packetBuffer.writeInt(ModeWhere.selectedItemWidget); // L:
																				// 8909
					var8.packetBuffer.method7929(EnumComposition.selectedItemSlot); // L:
																					// 8910
					var8.packetBuffer.method7863(WorldMapIcon_0.selectedItemId); // L:
																					// 8911
					var8.packetBuffer.method7763(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
																									// 8912
					var8.packetBuffer.method7863(var3); // L: 8913
					var8.packetBuffer.writeShort(var0 + class28.baseX); // L:
																		// 8914
					...
					var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2980, Client.packetWriter.isaacCipher); // L:
					// 9485
					var8.packetBuffer.writeIntME(var3); // L: 9486
					var8.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
																								// 9487
					var8.packetBuffer.method7863(var0 + class28.baseX); // L:
																		// 9488
					var8.packetBuffer.method7929(Client.selectedSpellChildIndex); // L:
																					// 9489
					var8.packetBuffer.writeIntME(Client.selectedSpellItemId); // L:
																				// 9490
					var8.packetBuffer.method7863(WorldMapLabelSize.baseY + var1); // L:
																					// 9491
					var8.packetBuffer.method7760(NetCache.selectedSpellWidget); // L:
																				// 9492
					...
					var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2909, Client.packetWriter.isaacCipher); // L:
					// 9068
					var8.packetBuffer.method7929(var0 + class28.baseX); // L:
																		// 9069
					...
					var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2919, Client.packetWriter.isaacCipher); // L:
					// 8892
					var8.packetBuffer.method7929(WorldMapLabelSize.baseY + var1); // L:
																					// 8893
					...
					var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2920, Client.packetWriter.isaacCipher); // L:
					// 9254
					var8.packetBuffer.writeShort(WorldMapLabelSize.baseY + var1); // L:
																					// 9255
					var8.packetBuffer.method7764(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
																									// 9256
					var8.packetBuffer.method7863(var3); // L: 9257
					var8.packetBuffer.writeIntME(var0 + class28.baseX); // L:
																		// 9258
					...
					var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2955, Client.packetWriter.isaacCipher); // L:
					// 8862
					var8.packetBuffer.method7863(var0 + class28.baseX); // L:
																		// 8863
					...
					var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2961, Client.packetWriter.isaacCipher); // L:
					// 9176
					var8.packetBuffer.method7863(var0 + class28.baseX); // L:
																		// 9177
					var8.packetBuffer.method7764(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
					...
					if (Client.isMenuOpen) { // L: 8744
						...
						class356.scene.menuOpen(PacketWriter.Client_plane, var0, var1, true); // L:
																								// 8748
					}
				} else {
					...
					if (var2 == 24) {
						...
						if (var16 != null) { // L: 8948
							...
							if (var11) { // L: 8951
								var12 = EnumComposition.getPacketBufferNode(ClientPacket.field2999, Client.packetWriter.isaacCipher); // L:
																																		// 8953
						...
						if (var2 == 25) {
							var16 = ScriptFrame.getWidgetChild(var1, var0); // L:
																			// 9262
							if (var16 != null) { // L: 9263
								WorldMapDecoration.Widget_runOnTargetLeave(); // L:
																				// 9264
								GrandExchangeOfferAgeComparator.selectSpell(var1, var0, WorldMapID.Widget_unpackTargetMask(class124.getWidgetFlags(var16)), var16.itemId); // L:
																																											// 9265
								Client.isItemSelected = 0; // L: 9266
								Client.selectedSpellActionName = WorldMapIcon_0.Widget_getSpellActionName(var16); // L:
								// 9267
								if (Client.selectedSpellActionName == null) { // L:
																				// 9268
									Client.selectedSpellActionName = "null";
								}
								if (var16.isIf3) { // L: 9269
									Client.selectedSpellName = var16.dataText + Static.colorStartTag(16777215);
								} else {
									Client.selectedSpellName = Static.colorStartTag(65280) + var16.spellName + Static.colorStartTag(16777215); // L:
																																					// 9270
								}
							}
							return; // L: 9272
						...
						if (var2 == 26) {
							...
							Widget var14;
							if (var2 == 28) {
								var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2999, Client.packetWriter.isaacCipher); // L:
																																		// 8919
								var8.packetBuffer.writeInt(var1); // L: 8920
								Client.packetWriter.addNode(var8); // L: 8921
								var14 = class140.getWidget(var1); // L: 8922
								if (var14 != null && var14.cs1Instructions != null && var14.cs1Instructions[0][0] == 5) { // L:
																															// 8923
									var10 = var14.cs1Instructions[0][1]; // L:
																			// 8924
									Varps.Varps_main[var10] = 1 - Varps.Varps_main[var10]; // L:
																							// 8925
									class306.changeGameOptions(var10); // L:
																		// 8926
								}
							} else if (var2 == 29) {
								var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2999, Client.packetWriter.isaacCipher); // L:
								...
								if (var14 != null && var14.cs1Instructions != null && var14.cs1Instructions[0][0] == 5) { // L:
									...
									var10 = var14.cs1Instructions[0][1]; // L:
																			// 9422
									if (Varps.Varps_main[var10] != var14.cs1ComparisonValues[0]) { // L:
																									// 9423
										Varps.Varps_main[var10] = var14.cs1ComparisonValues[0]; // L:
																								// 9424
										class306.changeGameOptions(var10); // L:
																			// 9425
									}
								...
								if (Client.meslayerContinueWidget == null) { // L:
																				// 9213
									class362.resumePauseWidget(var1, var0); // L:
																			// 9214
									Client.meslayerContinueWidget = ScriptFrame.getWidgetChild(var1, var0); // L:
																											// 9215
									ChatChannel.invalidateWidget(Client.meslayerContinueWidget); // L:
																									// 9216
								}
							} else if (var2 == 31) {
								var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2993, Client.packetWriter.isaacCipher); // L:
																																		// 9431
								var8.packetBuffer.method7929(EnumComposition.selectedItemSlot); // L:
																								// 9432
								var8.packetBuffer.method7784(var1); // L: 9433
								var8.packetBuffer.method7783(ModeWhere.selectedItemWidget); // L:
																							// 9434
								...
								class1.field4 = class140.getWidget(var1); // L:
																			// 9440
								Client.field600 = var0; // L: 9441
							} else if (var2 == 32) {
								var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2933, Client.packetWriter.isaacCipher); // L:
																																		// 9298
								...
								var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2988, Client.packetWriter.isaacCipher); // L:
																																		// 9203
								...
								var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2943, Client.packetWriter.isaacCipher); // L:
																																		// 9221
								...
								var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2998, Client.packetWriter.isaacCipher); // L:
																																		// 9108
								...
								var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2975, Client.packetWriter.isaacCipher); // L:
																																		// 8816
								...
								var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2968, Client.packetWriter.isaacCipher); // L:
																																		// 9024
								...
								if (var2 == 38) {
									...
									EnumComposition.selectedItemSlot = var0; // L:
																				// 8790
									ModeWhere.selectedItemWidget = var1; // L:
																			// 8791
									WorldMapIcon_0.selectedItemId = var3; // L:
																			// 8792
									ChatChannel.invalidateWidget(var16); // L:
																			// 8793
									Client.selectedItemName = Static.colorStartTag(16748608) + EnumComposition.ItemDefinition_get(var3).name + Static.colorStartTag(16777215); // L:
																																													// 8794
									if (Client.selectedItemName == null) { // L:
																			// 8795
								...
								if (var2 == 39) {
									var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2938, Client.packetWriter.isaacCipher); // L:
																																			// 9035
									var8.packetBuffer.method7760(var1); // L:
																		// 9036
									var8.packetBuffer.method7929(var0); // L:
																		// 9037
									var8.packetBuffer.writeShort(var3); // L:
																		// 9038
									...
									var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2978, Client.packetWriter.isaacCipher); // L:
																																			// 9129
									var8.packetBuffer.method7783(var1); // L:
																		// 9130
									var8.packetBuffer.method7863(var0); // L:
																		// 9131
									var8.packetBuffer.writeIntME(var3); // L:
																		// 9132
									Client.packetWriter.addNode(var8); // L:
																		// 9133
									...
									var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2967, Client.packetWriter.isaacCipher); // L:
																																			// 9355
									var8.packetBuffer.method7863(var3); // L:
																		// 9356
									var8.packetBuffer.method7784(var1); // L:
																		// 9357
									var8.packetBuffer.writeShort(var0); // L:
																		// 9358
									Client.packetWriter.addNode(var8); // L:
																		// 9359
									...
									var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2977, Client.packetWriter.isaacCipher); // L:
																																			// 8827
									var8.packetBuffer.method7863(var0); // L:
																		// 8828
									var8.packetBuffer.writeShort(var3); // L:
									...
									var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2935, Client.packetWriter.isaacCipher); // L:
																																			// 8961
									var8.packetBuffer.method7929(var0); // L:
																		// 8962
									var8.packetBuffer.method7783(var1); // L:
																		// 8963
									var8.packetBuffer.method7929(var3); // L:
																		// 8964
									Client.packetWriter.addNode(var8); // L:
																		// 8965
									...
									if (var15 != null) { // L: 9092
										...
										var9 = EnumComposition.getPacketBufferNode(ClientPacket.field2970, Client.packetWriter.isaacCipher); // L:
																																				// 9100
										var9.packetBuffer.writeShort(var3); // L:
																			// 9101
										var9.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
										// 9102
										Client.packetWriter.addNode(var9); // L:
																			// 9103
									}
								} else if (var2 == 45) {
									...
									if (var15 != null) { // L: 8987
										...
										var9 = EnumComposition.getPacketBufferNode(ClientPacket.field2994, Client.packetWriter.isaacCipher); // L:
																																				// 8995
										var9.packetBuffer.method7863(var3); // L:
																			// 8996
										var9.packetBuffer.method7762(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
										// 8997
										Client.packetWriter.addNode(var9); // L:
									...
									if (var15 != null) { // L: 8729
										...
										var9 = EnumComposition.getPacketBufferNode(ClientPacket.field2986, Client.packetWriter.isaacCipher); // L:
																																				// 8737
										var9.packetBuffer.method7929(var3); // L:
																			// 8738
										var9.packetBuffer.method7763(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
										// 8739
										Client.packetWriter.addNode(var9); // L:
									...
									if (var15 != null) { // L: 8800
										...
										var9 = EnumComposition.getPacketBufferNode(ClientPacket.field2991, Client.packetWriter.isaacCipher); // L:
																																				// 8808
										var9.packetBuffer.method7762(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
										// 8809
										var9.packetBuffer.method7863(var3); // L:
									...
									if (var15 != null) { // L: 9140
										...
										var9 = EnumComposition.getPacketBufferNode(ClientPacket.field2953, Client.packetWriter.isaacCipher); // L:
																																				// 9148
										var9.packetBuffer.writeIntME(var3); // L:
																			// 9149
										var9.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
										// 9150
										Client.packetWriter.addNode(var9); // L:
									...
									if (var15 != null) { // L: 9339
										...
										var9 = EnumComposition.getPacketBufferNode(ClientPacket.field2965, Client.packetWriter.isaacCipher); // L:
																																				// 9347
										var9.packetBuffer.writeIntME(var3); // L:
																			// 9348
										var9.packetBuffer.method7762(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
									...
									if (var15 != null) { // L: 9232
										...
										var9 = EnumComposition.getPacketBufferNode(ClientPacket.field2947, Client.packetWriter.isaacCipher); // L:
																																				// 9240
										var9.packetBuffer.writeShort(var3); // L:
																			// 9241
										var9.packetBuffer.writeByte(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
									...
									if (var15 != null) { // L: 9381
										...
										var9 = EnumComposition.getPacketBufferNode(ClientPacket.field2959, Client.packetWriter.isaacCipher); // L:
																																				// 9389
										var9.packetBuffer.method7763(KeyHandler.KeyHandler_pressedKeys[82] ? 1 : 0); // L:
										// 9390
										var9.packetBuffer.writeShort(var3); // L:
									...
									label654 : {
										if (var2 != 57) {
											if (var2 == 58) {
												...
												if (var16 != null) { // L: 9156
													var9 = EnumComposition.getPacketBufferNode(ClientPacket.field2925, Client.packetWriter.isaacCipher); // L:
																																							// 9158
													var9.packetBuffer.method7929(Client.selectedSpellItemId); // L:
																												// 9159
													var9.packetBuffer.method7863(Client.selectedSpellChildIndex); // L:
													// 9160
													var9.packetBuffer.method7760(NetCache.selectedSpellWidget); // L:
													// 9161
													var9.packetBuffer.method7929(var16.itemId); // L:
																								// 9162
													var9.packetBuffer.writeShort(var0); // L:
																						// 9163
													var9.packetBuffer.method7783(var1); // L:
																						// 9164
													Client.packetWriter.addNode(var9); // L:
																						// 9165
												}
											...
											if (var2 == 1001) {
												Client.mouseCrossX = var6; // L:
																			// 9365
												Client.mouseCrossY = var7; // L:
																			// 9366
												Client.mouseCrossColor = 2; // L:
																			// 9367
												Client.mouseCrossState = 0; // L:
																			// 9368
												Client.destinationX = var0; // L:
																			// 9369
												Client.destinationY = var1; // L:
																			// 9370
												var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2937, Client.packetWriter.isaacCipher); // L:
																																						// 9372
												var8.packetBuffer.method7929(var0 + class28.baseX); // L:
																									// 9373
												var8.packetBuffer.method7863(var3); // L:
											...
											if (var2 == 1002) {
												...
												Client.mouseCrossState = 0; // L:
																			// 9121
												var8 = EnumComposition.getPacketBufferNode(ClientPacket.field2976, Client.packetWriter.isaacCipher); // L:
																																						// 9123
												var8.packetBuffer.method7863(var3); // L:
																					// 9124
												Client.packetWriter.addNode(var8); // L:
											...
											if (var2 == 1003) {
												...
												Client.mouseCrossState = 0; // L:
																			// 9399
												var13 = Client.npcs[var3]; // L:
																			// 9400
												if (var13 != null) { // L: 9401
													NPCComposition var17 = var13.definition; // L:
																								// 9402
													if (var17.transforms != null) { // L:
																					// 9403
														var17 = var17.transform();
													}
													if (var17 != null) { // L:
																			// 9404
														var12 = EnumComposition.getPacketBufferNode(ClientPacket.field2941, Client.packetWriter.isaacCipher); // L:
																																								// 9406
														var12.packetBuffer.writeIntME(var17.id); // L:
																									// 9407
														Client.packetWriter.addNode(var12); // L:
																							// 9408
													}
												}
												break label654;
											...
											if (var2 == 1004) {
												...
												Client.mouseCrossState = 0; // L:
																			// 9499
												var8 = EnumComposition.getPacketBufferNode(ClientPacket.field3004, Client.packetWriter.isaacCipher); // L:
																																						// 9501
												var8.packetBuffer.method7929(var3); // L:
																					// 9502
												Client.packetWriter.addNode(var8); // L:
											...
											if (var2 == 1005) {
												var16 = class140.getWidget(var1); // L:
																					// 9310
												if (var16 != null && var16.itemQuantities[var0] >= 100000) { // L:
																												// 9311
													class290.addGameMessage(27, "", var16.itemQuantities[var0] + " x " + EnumComposition.ItemDefinition_get(var3).name);
												} else {
													var9 = EnumComposition.getPacketBufferNode(ClientPacket.field3004, Client.packetWriter.isaacCipher); // L:
																																							// 9314
													var9.packetBuffer.method7929(var3); // L:
																						// 9315
													Client.packetWriter.addNode(var9); // L:
												...
												class1.field4 = class140.getWidget(var1); // L:
																							// 9319
												Client.field600 = var0; // L:
																		// 9320
												break label654;
											}
											if (var2 != 1007) {
												if (var2 == 1009 || var2 == 1008 || var2 == 1010 || var2 == 1011 || var2 == 1012) {
													class121.worldMap.worldMapMenuAction(var2, var3, new Coord(var0), new Coord(var1)); // L:
																																		// 9413
												}
												break label654;
											}
										...
										if (var16 != null) { // L: 9292
											TextureProvider.widgetDefaultMenuAction(var3, var1, var0, var16.itemId, var5); // L:
																															// 9293
										}
									}
								}
		...
		if (Client.isItemSelected != 0) { // L: 9505
			...
			ChatChannel.invalidateWidget(class140.getWidget(ModeWhere.selectedItemWidget)); // L:
																							// 9507
		}
